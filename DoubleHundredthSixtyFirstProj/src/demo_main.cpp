...
{
    kn::window::init({640, 360}, "Night Terror", true);
    kn::Clock clock;
    kn::camera = {-32, -26};

    constexpr kn::Color bgColor = {21, 18, 37, 255};

    kn::Texture pidle("./assets/player_idle.png");
    ...
    kn::TileMap tileMap("./assets/room.tmx");
    ...
    kn::Surface surf("./assets/player_idle.png");
