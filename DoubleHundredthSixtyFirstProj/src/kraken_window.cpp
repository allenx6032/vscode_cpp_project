...
#include "Kraken_ErrorLogger.hpp"
#include "Kraken_Math.hpp"
#include "Kraken_Music.hpp"
#include "Kraken_Texture.hpp"
#include "Kraken_Window.hpp"
#include "Kraken_globals.hpp"

#include "kraken_icon.h"
...
bool init(const math::Vec2& resolution, const std::string& title, const bool scaled)
{
    ...
    // }
    int winW = resolutionWidth;
    int winH = resolutionHeight;
