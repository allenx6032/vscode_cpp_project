...
#include "bgi_winbgim.h"         // API routines
#include "bgi_winbgitypes.h"    // Internal structure data
...
void setfillstyle( int pattern, int color )
{
    ...
    short Slash[8]      = { ~0xE0, ~0xC1, ~0x83, ~0x07, ~0x0E, ~0x1C, ~0x38, ~0x70 };   // Changed type from unsigned short to short
    short BkSlash[8]    = { ~0x07, ~0x83, ~0xC1, ~0xE0, ~0x70, ~0x38, ~0x1C, ~0x0E };   // Changed type from unsigned short to short
    short Interleave[8] = { ~0xCC, ~0x33, ~0xCC, ~0x33, ~0xCC, ~0x33, ~0xCC, ~0x33 };   // Changed type from unsigned short to short
    short WideDot[8]    = { ~0x80, ~0x00, ~0x08, ~0x00, ~0x80, ~0x00, ~0x08, ~0x00 };   // Changed type from unsigned short to short
    short CloseDot[8]   = { ~0x88, ~0x00, ~0x22, ~0x00, ~0x88, ~0x00, ~0x22, ~0x00 };   // Changed type from unsigned short to short
    HBITMAP hBitmap;
