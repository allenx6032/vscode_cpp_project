...
#include "raylib_utils.h"          // Required for: TRACELOG(), LoadFileData(), LoadFileText(), SaveFileText()
#include "raylib_gl.h"           // OpenGL abstraction layer to OpenGL 1.1, 2.1, 3.3+ or ES2
#include "raylib_math.h"        // Required for: Vector3, Quaternion and Matrix functionality
...
#include <math.h>           // Required for: sinf(), cosf(), sqrtf(), fabsf()
    ...
    #include "raylib_tinyobj_loader_c.h"      // OBJ/MTL file formats loading
#endif
    ...
    #include "raylib_cgltf.h"         // glTF file format loading
#endif
    ...
    #include "raylib_vox_loader.h"    // VOX file format loading (MagikaVoxel)
#endif
    ...
    #include "raylib_par_shapes.h"    // Shapes 3d parametric generation
#endif
    ...
    #define CHDIR _chdir
#else
    #include <unistd.h>     // Required for: chdir() (POSIX) [Used in LoadOBJ()]1
    #define CHDIR chdir
#endif
