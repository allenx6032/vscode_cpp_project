...
static void foobar2(struct vars *input, struct vars *output) {
...
// lbind_register(L, "foobar2", foobar2);
...
printf("Result from Lua Fact %ld\n", (long) result);

// struct vars * largs = lbind_args(L);
// lbind_pushstring(largs, "foobar");
// struct vars * lresult = lbind_call(L, "hello", largs);
// assert(lbind_type(lresult, 0) == LT_INTEGER);
// printf("sizeof 'foobar' = %d\n", lbind_tointeger(lresult, 0));
