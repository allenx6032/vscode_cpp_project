...
#include "curl_ver.h"         /* libcurl version defines   */
#include "curl_system.h"          /* determine things run-time */
...
#include "curl_easy.h" /* nothing in curl is fun without the easy stuff */
#include "curl_multi.h"
#include "curl_urlapi.h"
