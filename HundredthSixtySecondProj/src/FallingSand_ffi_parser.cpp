#include "FallingSand_ffi_parser.h"
...
#include "FallingSand_ffi_ast.h"
#include "FallingSand_ffi_util.h"
 ...
 */
static bool parse_type_ptr(lex_state &ls, ast::c_type &tp, util::strbuf *fpname, bool needn) {
...
static bool parse_type(lex_state &ls, ast::c_type &ret, util::strbuf *fpn) { return (parse_typebase(ls, ret) && parse_type_ptr(ls, ret, fpn, false)); }
