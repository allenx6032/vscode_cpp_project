...
struct ME::cpp::details::custom_type_name<std::map<Key, T, Less>> {
...
template <typename Key, typename T>
struct ME::cpp::details::custom_type_name<std::multimap<Key, T>> {
    static constexpr auto get() noexcept { return concat_seq(TSTR("std::multimap<{"), type_name<Key>(), TStr_of_a<','>{}, type_name<T>(), TStrC_of<'}', '>'>{}); }
};

template <typename Key, typename T, typename Less>
struct ME::cpp::details::custom_type_name<std::multimap<Key, T, Less>> {
...
template <>
constexpr auto ME::cpp::type_name<std::string>() noexcept {
    return TSTR("std::string");
}

template <>
constexpr auto ME::cpp::type_name<std::wstring>() noexcept {
    return TSTR("std::wstring");
}

template <>
constexpr auto ME::cpp::type_name<std::u8string>() noexcept {
    return TSTR("std::u8string");
}

template <>
constexpr auto ME::cpp::type_name<std::u16string>() noexcept {
    return TSTR("std::u16string");
}

template <>
constexpr auto ME::cpp::type_name<std::u32string>() noexcept {
    return TSTR("std::u32string");
}

template <typename Key, typename T>
struct ME::cpp::details::custom_type_name<std::unordered_map<Key, T>> {
...
struct ME::cpp::details::custom_type_name<std::unordered_map<Key, T, Hash>> {
...
struct ME::cpp::details::custom_type_name<std::unordered_map<Key, T, Hash, KeyEqual>> {
    static constexpr auto get() noexcept {
...
// template <typename Key, typename T, typename Hash>
// struct ME::cpp::details::custom_type_name<std::pmr::unordered_map<Key, T, Hash>> {
//     static constexpr auto get() noexcept {
...
template <typename Key, typename T>
struct ME::cpp::details::custom_type_name<std::unordered_multimap<Key, T>> {
...
template <typename Key, typename T, typename Hash>
struct ME::cpp::details::custom_type_name<std::unordered_multimap<Key, T, Hash>> {
    static constexpr auto get() noexcept {
...
template <typename Key, typename T, typename Hash, typename KeyEqual>
struct ME::cpp::details::custom_type_name<std::unordered_multimap<Key, T, Hash, KeyEqual>> {
    static constexpr auto get() noexcept {
...
// template <typename Key, typename T>
// struct ME::cpp::details::custom_type_name<std::pmr::unordered_multimap<Key, T>> {
...
struct ME::cpp::details::custom_type_name<std::unordered_set<Key>> {
    static constexpr auto get() noexcept { return concat_seq(TSTR("std::unordered_set<{"), type_name<Key>(), TStrC_of<'}', '>'>{}); }
};

template <typename Key, typename Hash>
struct ME::cpp::details::custom_type_name<std::unordered_set<Key, Hash>> {
...
struct ME::cpp::details::custom_type_name<std::unordered_set<Key, Hash, KeyEqual>> {
    static constexpr auto get() noexcept {
...
template <typename Key>
struct ME::cpp::details::custom_type_name<std::unordered_multiset<Key>> {
    static constexpr auto get() noexcept { return concat_seq(TSTR("std::unordered_multiset<{"), type_name<Key>(), TStrC_of<'}', '>'>{}); }
};

template <typename Key, typename Hash>
struct ME::cpp::details::custom_type_name<std::unordered_multiset<Key, Hash>> {
...
template <typename Key, typename Hash, typename KeyEqual>
struct ME::cpp::details::custom_type_name<std::unordered_multiset<Key, Hash, KeyEqual>> {
    static constexpr auto get() noexcept {
...
template <typename T>
struct ME::cpp::details::custom_type_name<std::vector<T>> {
