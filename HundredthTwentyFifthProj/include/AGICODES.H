...
** agicodes.h
**
** This file is useful for finding the command number for each command,
** the number of arguments to each command, and the type of each argument.
*/
...
agiCommandType agiCommands[NUM_AGI_COMMANDS] = {
 ...
 { "obj.status.v", 1, 0x80 },
 { "quit", 1, 0x00 },                    /* 0 args for AGI version 2.089 */
 { "show.mem", 0, 0x00 },
 { "pause", 0, 0x00 },
 { "echo.line", 0, 0x00 },
 { "cancel.line", 0, 0x00 },
 ...
 { "trace.on", 0, 0x00 },
 { "trace.info", 3, 0x00 },
 { "print.at", 4, 0x00 },          /* 3 args for AGI versions before */
 { "print.at.v", 4, 0x80 },        /* 2.440 (maybe laterz) */
 ...
 { "unknown174", 1, 0 },
 { "unknown175", 1, 0 },
 { "unknown176", 0, 0 },     /* 1 arg for AGI version 3.002.086 */
 { "unknown177", 1, 0 },
 { "unknown178", 0, 0 },
 { "unknown179", 4, 0 },
 { "unknown180", 2, 0 },
