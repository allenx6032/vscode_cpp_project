...
// LuaSocket
extern "C" {
#include "luasocket_luasocket.h"
#include "luasocket_mime.h"
}
...
int __open_luasocket_socket(lua_State * L)
{
	...
	#include "luasocket_socket.lua.h"
