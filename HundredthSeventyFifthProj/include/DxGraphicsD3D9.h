...
struct GRAPHICS_HARDWARE_DIRECT3D9_SHADER_BASE3D
{
	...
	// [ テクスチャRGB無視( 0:無視しない  1:無視する ) ]
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	D_IDirect3DPixelShader9					*Base3D_PixelLighting_Normal_PS[ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 84 ][ 2 ][ 7 ][ 2 ][ 2 ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	D_IDirect3DPixelShader9					*Base3D_ShadowMap_Normal_PS[ 2 ] ;
	...
	// [ テクスチャRGB無視( 0:無視しない  1:無視する ) ]
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	D_IDirect3DPixelShader9					*Base3D_NoLighting_Normal_PS/*[ 5 ]*/[ 7 ][ 2 ][ 2 ] ;
	...
	// [ テクスチャRGB無視( 0:無視しない  1:無視する ) ]
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	D_IDirect3DPixelShader9					*Base3D_VertexLighting_Normal_PS[ 2 ][ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 10 ][ 2 ][ 7 ][ 2 ][ 2 ] ;
} ;
...
struct GRAPHICS_HARDWARE_DIRECT3D9_SHADERCODE_BASE3D
{
	...
	// [ テクスチャRGB無視( 0:無視しない  1:無視する ) ]
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	void					*Base3D_PixelLighting_Normal_PSAddress[ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 84 ][ 2 ][ 7 ][ 2 ][ 2 ] ;
	...
	// モデル描画用のシャドウマップへのレンダリング用ピクセルシェーダー
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	void					*Base3D_ShadowMap_Normal_PSAddress[ 2 ] ;
	...
	// [ テクスチャRGB無視( 0:無視しない  1:無視する ) ]
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	void					*Base3D_NoLighting_Normal_PSAddress/*[ 5 ]*/[ 7 ][ 2 ][ 2 ] ;
	...
	// [ テクスチャRGB無視( 0:無視しない  1:無視する ) ]
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	void					*Base3D_VertexLighting_Normal_PSAddress[ 2 ][ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 10 ][ 2 ][ 7 ][ 2 ][ 2 ] ;
} ;
...
extern	int		Graphics_D3D9_DrawRotaGraphFast( int x, int y, float xf, float yf, float ExRate, float Angle, IMAGEDATA *Image, IMAGEDATA *BlendImage, int TransFlag, int TurnFlag, int IntFlag ) ;				// ハードウエアアクセラレータ使用版 DrawRotaGraphFast
