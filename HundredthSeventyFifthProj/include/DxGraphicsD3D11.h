...
struct GRAPHICS_HARDWARE_DIRECT3D11_SHADER_BASE3D
{
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ ピクセルシェーダーのアルファテストモード ]
	D_ID3D11PixelShader						*Base3D_PixelLighting_Normal_PS[ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 84 ]/*[ 2 ]*/[ 7 ][ 2 ][ 2 ][ DIRECT3D11_PS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ ピクセルシェーダーのアルファテストモード ]
	D_ID3D11PixelShader						*Base3D_ShadowMap_Normal_PS[ 2 ][ DIRECT3D11_PS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ ピクセルシェーダーのアルファテストモード ]
	D_ID3D11PixelShader						*Base3D_NoLighting_Normal_PS/*[ 5 ]*/[ 7 ][ 2 ][ 2 ][ DIRECT3D11_PS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ ピクセルシェーダーのアルファテストモード ]
	D_ID3D11PixelShader						*Base3D_VertexLighting_Normal_PS[ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 10 ]/*[ 2 ]*/[ 7 ][ 2 ][ 2 ][ DIRECT3D11_PS_ALPHATEST_NUM ] ;
} ;
...
struct GRAPHICS_HARDWARE_DIRECT3D11_SHADERCODE_BASE3D
{
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ ピクセルシェーダーのアルファテストモード ]
	GRAPHICS_HARDWARE_DIRECT3D11_SHADERCODE_INFO Base3D_PixelLighting_Normal_PS_Code[ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 84 ]/*[ 2 ]*/[ 7 ][ 2 ][ 2 ][ DIRECT3D11_PS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ ピクセルシェーダーのアルファテストモード ]
	GRAPHICS_HARDWARE_DIRECT3D11_SHADERCODE_INFO Base3D_ShadowMap_Normal_PS_Code[ 2 ][ DIRECT3D11_PS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ ピクセルシェーダーのアルファテストモード ]
	GRAPHICS_HARDWARE_DIRECT3D11_SHADERCODE_INFO Base3D_NoLighting_Normal_PS_Code/*[ 5 ]*/[ 7 ][ 2 ][ 2 ][ DIRECT3D11_PS_ALPHATEST_NUM ] ;
	...
	// [ テクスチャAlpha無視( 0:無視しない  1:無視する ) ]
	// [ ピクセルシェーダーのアルファテストモード ]
	GRAPHICS_HARDWARE_DIRECT3D11_SHADERCODE_INFO Base3D_VertexLighting_Normal_PS_Code[ 2 ]/*[ 5 ]*//*[ 2 ]*//*[ 2 ]*/[ 10 ]/*[ 2 ]*/[ 7 ][ 2 ][ 2 ][ DIRECT3D11_PS_ALPHATEST_NUM ] ;
} ;
...
extern	int		Graphics_D3D11_DrawRotaGraphFast( int x, int y, float xf, float yf, float ExRate, float Angle, IMAGEDATA *Image, IMAGEDATA *BlendImage, int TransFlag, int TurnFlag, int IntFlag ) ;			// ハードウエアアクセラレータ使用版 DrawRotaGraphFast
...
extern	int			Graphics_Hardware_D3D11_SetDrawScreen_ID3D11RenderTargetView_PF( const void *pID3D11RenderTargetView ) ; // 指定の ID3D11RenderTargetView を描画対象にする
