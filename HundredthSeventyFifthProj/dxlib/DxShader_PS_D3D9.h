...
#define DX_PS_CONSTF_SHADOW3_ENBL0_1_2_LGT_NO_GEN          21	// シャドウマップ３用の情報( xyz:ライト０～２への適用情報 )、ライト減衰なしか( w )
#define DX_PS_CONSTF_MUL_ALPHA_COLOR_ADD_COLOR  22		// カラーにアルファ値を乗算するかどうか( x( 0.0f:乗算しない  1.0f:乗算する ) ), 加算する色( RGB=yzw )
