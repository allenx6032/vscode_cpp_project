...
//	}
	...
	case DX_BLENDMODE_NOBLEND :
		Graphics_D3D11_DeviceState_SetBlendMode( BlendMode, FALSE, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, MV1Man.DrawMode != DX_MV1_DRAWMODE_NORMAL_DEPTH && GSYS.DrawSetting.NotWriteAlphaChannelFlag ? TRUE : FALSE ) ;
		break ;

	case DX_BLENDMODE_SUB :
		Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_SUB1, FALSE, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		break ;

	case DX_BLENDMODE_ALPHA :
		if( Frame->Container->UseDrawMulAlphaColor )
		{
			Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_PMA_ALPHA, FALSE, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		}
		else
		{
			Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_ALPHA, FALSE, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		}
		break ;
	...
	case DX_BLENDMODE_ADD :
		if( Frame->Container->UseDrawMulAlphaColor )
		{
			Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_PMA_ADD, FALSE, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		}
		else
		{
			Graphics_D3D11_DeviceState_SetBlendMode( DX_BLENDMODE_ADD, FALSE, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, DX_BLEND_ONE, DX_BLEND_ZERO, DX_BLENDOP_ADD, GSYS.DrawSetting.NotWriteAlphaChannelFlag ) ;
		}
		break ;
	}
...
static int  MV1_D3D11_ShaderSetup( MV1_MESH *Mesh, int VertexType, int IsToonOutLine )
{
	...
	if( IsToonOutLine )
	{
		...
		if( GSYS.DrawSetting.ShadowMapDraw )
		{
			...
			if( SM->MV1_ToonOutLine_ShadowMap_VS[ VertexType ][ BumpMap ] == NULL )
			{
				CreateD3D11MV1ToonOutLineShadowMapVertexShader( VertexType, BumpMap ) ;
			}
			if( SM->MV1_ShadowMap_Normal_PS[ AlphaTestMode ] == NULL )
			{
				CreateD3D11MV1ShadowMapNormalPixelShader( AlphaTestMode ) ;
			}
		#endif // DX_NON_SHADERCODE_BINARY
		...
		#else // DX_NON_SHADERCODE_BINARY
			if( SM->MV1_ToonOutLine_VS[ VertexType ][ BumpMap ][ FogType ] == NULL )
			{
				CreateD3D11MV1ToonOutLineVertexShader( VertexType, BumpMap, FogType ) ;
			}
			if( SM->MV1_NoLighting_Normal_PS[ 0 ][ AlphaTestMode ] == NULL )
			{
				CreateD3D11MV1NoLightingNormalPixelShader( 0, AlphaTestMode ) ;
			}
		#endif // DX_NON_SHADERCODE_BINARY
	...
	#ifndef DX_NON_SHADERCODE_BINARY
		VSAddress_PL = &SCM->MV1_PixelLighting_VS_Code[ 0 ][ VertexType ][ BumpMap ][ 0 ] ;
		VSAddress    = NULL ;
	#else // DX_NON_SHADERCODE_BINARY
		if( SM->MV1_PixelLighting_VS[ 0 ][ VertexType ][ BumpMap ][ 0 ] == NULL )
		{
			CreateD3D11MV1PixelLightingVertexShader( 0, VertexType, BumpMap, 0 ) ;
		}
	#endif // DX_NON_SHADERCODE_BINARY
		VS_PL = &SM->MV1_PixelLighting_VS [ 0 ][ VertexType ][ BumpMap ][ 0 ] ;
		VS    = NULL ;

	#ifndef DX_NON_SHADERCODE_BINARY
		PSAddress_PL = &SCM->MV1_Normal_Depth_PS_Code[ BumpMap ] ;
		PSAddress    = NULL ;
	#else // DX_NON_SHADERCODE_BINARY
		if( SM->MV1_Normal_Depth_PS[ BumpMap ] == NULL )
		{
			CreateD3D11MV1NormalDepthPixelShader( BumpMap ) ;
		}
	#endif // DX_NON_SHADERCODE_BINARY
		PS_PL = &SM->MV1_Normal_Depth_PS[ BumpMap ] ;
		PS    = NULL ;
	}
	else
	if( GSYS.DrawSetting.ShadowMapDraw )
	{
	...
	#else // DX_NON_SHADERCODE_BINARY
		if( SM->MV1_ShadowMap_VS[ VertexType ][ BumpMap ] == NULL )
		{
			CreateD3D11MV1ShadowMapVertexShader( VertexType, BumpMap ) ;
		}
	#endif // DX_NON_SHADERCODE_BINARY
		...
		if( IsToon )
		{
			...
			case DX_MATERIAL_TYPE_TOON :
				...
				#else // DX_NON_SHADERCODE_BINARY
					if( SM->MV1_ShadowMap_Toon_PS[ 0 ][ 0 ][ DiffuseGradBlendType ][ AlphaTestMode ] == NULL )
					{
						CreateD3D11MV1ShadowMapToonPixelShader( 0, 0, DiffuseGradBlendType, AlphaTestMode ) ;
					}
				#endif // DX_NON_SHADERCODE_BINARY
			...
			case DX_MATERIAL_TYPE_TOON_2 :
				...
				#else // DX_NON_SHADERCODE_BINARY
					if( SM->MV1_ShadowMap_Toon_PS[ 1 ][ SphereMapBlendType ][ 0 ][ AlphaTestMode ] == NULL )
					{
						CreateD3D11MV1ShadowMapToonPixelShader( 1, SphereMapBlendType, 0, AlphaTestMode ) ;
					}
				#endif // DX_NON_SHADERCODE_BINARY
	...
	#else // DX_NON_SHADERCODE_BINARY
		if( SM->MV1_NoLighting_VS[ VertexType ][ BumpMap ][ 0 ] == NULL )
		{
			CreateD3D11MV1NoLightingVertexShader( VertexType, BumpMap, 0 ) ;
		}
		if( SM->MV1_MaterialType_PS[ MMaterial->BaseData->Type ][ AlphaTestMode ] == NULL )
		{
			CreateD3D11MV1MaterialTypePixelShader( MMaterial->BaseData->Type, AlphaTestMode ) ;
		}
	#endif // DX_NON_SHADERCODE_BINARY
	...
	if( GD3D11.Device.State.Lighting )
	{
	...
	#else // DX_NON_SHADERCODE_BINARY
		if( GD3D11.UsePixelLightingShader && SM->MV1_PixelLighting_VS[ ShadowMap ][ VertexType ][ BumpMap ][ FogType ] == NULL )
		{
			CreateD3D11MV1PixelLightingVertexShader( ShadowMap, VertexType, BumpMap, FogType ) ;
		}
		if( SM->MV1_VertexLighting_VS[ ShadowMap ][ VertexType ][ BumpMap ][ FogType ][ LightIndex20 ] == NULL )
		{
			CreateD3D11MV1VertexLightingVertexShader( ShadowMap, VertexType, BumpMap, FogType, LightIndex20 ) ;
		}
	#endif // DX_NON_SHADERCODE_BINARY
			...
			case DX_MATERIAL_TYPE_TOON :
				{
					...
					#else // DX_NON_SHADERCODE_BINARY
						if( GD3D11.UsePixelLightingShader && SM->MV1_PixelLighting_ToonType1_PS[ ShadowMap ][ DiffuseGradBlendType ][ SpecularGradBlendType ][ BumpMap ][ EnableLightNum - 1 ][ AlphaTestMode ] == NULL )
						{
							CreateD3D11MV1PixelLightingToonType1PixelShader( ShadowMap, DiffuseGradBlendType, SpecularGradBlendType, BumpMap, EnableLightNum - 1, AlphaTestMode ) ;
						}
					#endif // DX_NON_SHADERCODE_BINARY
				...
				#else // DX_NON_SHADERCODE_BINARY
					if( SM->MV1_VertexLighting_ToonType1_PS[ ShadowMap ][ DiffuseGradBlendType ][ SpecularGradBlendType ][ BumpMap ][ LightIndex10 ][ AlphaTestMode ] == NULL )
					{
						CreateD3D11MV1VertexLightingToonType1PixelShader( ShadowMap, DiffuseGradBlendType, SpecularGradBlendType, BumpMap, LightIndex10, AlphaTestMode ) ;
					}
				#endif // DX_NON_SHADERCODE_BINARY
			...
			case DX_MATERIAL_TYPE_TOON_2 :
				{
					...
					#else // DX_NON_SHADERCODE_BINARY
						if( GD3D11.UsePixelLightingShader && SM->MV1_PixelLighting_ToonType2_PS[ ShadowMap ][ SphereMapBlendType ][ EnableLightNum - 1 ][ AlphaTestMode ] == NULL )
						{
							CreateD3D11MV1PixelLightingToonType2PixelShader( ShadowMap, SphereMapBlendType, EnableLightNum - 1, AlphaTestMode ) ;
						}
					#endif // DX_NON_SHADERCODE_BINARY
				...
				#else // DX_NON_SHADERCODE_BINARY
					if( SM->MV1_VertexLighting_ToonType2_PS[ ShadowMap ][ SphereMapBlendType ][ LightIndex10 ][ AlphaTestMode ] == NULL )
					{
						CreateD3D11MV1VertexLightingToonType2PixelShader( ShadowMap, SphereMapBlendType, LightIndex10, AlphaTestMode ) ;
					}
				#endif // DX_NON_SHADERCODE_BINARY
		...
		else
		{
			...
			#else // DX_NON_SHADERCODE_BINARY
				if( GD3D11.UsePixelLightingShader && SM->MV1_PixelLighting_Normal_PS[ ShadowMap ][ MultiTexMode ][ BumpMap ][ EnableLightNum - 1 ][ AlphaTestMode ] == NULL )
				{
					CreateD3D11MV1PixelLightingNormalPixelShader( ShadowMap, MultiTexMode, BumpMap, EnableLightNum - 1, AlphaTestMode ) ;
				}
			#endif // DX_NON_SHADERCODE_BINARY
		...
		#else // DX_NON_SHADERCODE_BINARY
			if( SM->MV1_VertexLighting_Normal_PS[ ShadowMap ][ MultiTexMode ][ BumpMap ][ LightIndex10 ][ AlphaTestMode ] == NULL )
			{
				CreateD3D11MV1VertexLightingNormalPixelShader( ShadowMap, MultiTexMode, BumpMap, LightIndex10, AlphaTestMode ) ;
			}
		#endif // DX_NON_SHADERCODE_BINARY
	...
	else
	{
	...
	#else // DX_NON_SHADERCODE_BINARY
		if( SM->MV1_NoLighting_VS[ VertexType ][ BumpMap ][ FogType ] == NULL )
		{
			CreateD3D11MV1NoLightingVertexShader( VertexType, BumpMap, FogType ) ;
		}
	#endif // DX_NON_SHADERCODE_BINARY
		...
		if( IsToon )
		{
			...
			case DX_MATERIAL_TYPE_TOON :
				...
				#else // DX_NON_SHADERCODE_BINARY
					if( SM->MV1_NoLighting_Toon_PS[ 0 ][ DiffuseGradBlendType ][ AlphaTestMode ] == NULL )
					{
						CreateD3D11MV1NoLightingToonPixelShader( 0, DiffuseGradBlendType, AlphaTestMode ) ;
					}
				#endif // DX_NON_SHADERCODE_BINARY
			...
			#else // DX_NON_SHADERCODE_BINARY
				if( SM->MV1_NoLighting_Toon_PS[ 1 ][ 0 ][ AlphaTestMode ] == NULL )
				{
					CreateD3D11MV1NoLightingToonPixelShader( 1, 0, AlphaTestMode ) ;
				}
			#endif // DX_NON_SHADERCODE_BINARY
		...
		#else // DX_NON_SHADERCODE_BINARY
			if( SM->MV1_NoLighting_Normal_PS[ MultiTexMode ][ AlphaTestMode ] == NULL )
			{
				CreateD3D11MV1NoLightingNormalPixelShader( MultiTexMode, AlphaTestMode ) ;
			}
		#endif // DX_NON_SHADERCODE_BINARY
