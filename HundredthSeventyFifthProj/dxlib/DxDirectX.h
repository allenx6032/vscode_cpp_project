...
class D_IErrorLog : public D_IUnknown
{
public:
...
#define D_DXGI_ERROR_WAIT_TIMEOUT				( 0x887A0027 )
...
typedef enum tagD_DXGI_SWAP_EFFECT
{
	...
	D_DXGI_SWAP_EFFECT_FLIP_SEQUENTIAL			= 3,
	D_DXGI_SWAP_EFFECT_FLIP_DISCARD				= 4
} D_DXGI_SWAP_EFFECT;
...
typedef enum tagD_DXGI_GPU_PREFERENCE
{
	D_DXGI_GPU_PREFERENCE_UNSPECIFIED			= 0,
	D_DXGI_GPU_PREFERENCE_MINIMUM_POWER			= ( D_DXGI_GPU_PREFERENCE_UNSPECIFIED + 1 ) ,
	D_DXGI_GPU_PREFERENCE_HIGH_PERFORMANCE		= ( D_DXGI_GPU_PREFERENCE_MINIMUM_POWER + 1 ) 
} D_DXGI_GPU_PREFERENCE ;

typedef enum tagD_DXGI_FEATURE
{
	D_DXGI_FEATURE_PRESENT_ALLOW_TEARING		= 0
} D_DXGI_FEATURE ;
...
typedef enum tagD_DXGI_ALPHA_MODE
{
	D_DXGI_ALPHA_MODE_UNSPECIFIED				= 0,
	D_DXGI_ALPHA_MODE_PREMULTIPLIED				= 1,
	D_DXGI_ALPHA_MODE_STRAIGHT					= 2,
	D_DXGI_ALPHA_MODE_IGNORE					= 3,
	D_DXGI_ALPHA_MODE_FORCE_DWORD				= 0xffffffff
} D_DXGI_ALPHA_MODE ;

typedef enum tagD_DXGI_SCALING
{
	D_DXGI_SCALING_STRETCH						= 0,
	D_DXGI_SCALING_NONE							= 1,
	D_DXGI_SCALING_ASPECT_RATIO_STRETCH			= 2
} D_DXGI_SCALING ;
...
typedef struct tagD_DXGI_SWAP_CHAIN_FULLSCREEN_DESC
{
	D_DXGI_RATIONAL								RefreshRate ;
	D_DXGI_MODE_SCANLINE_ORDER					ScanlineOrdering ;
	D_DXGI_MODE_SCALING							Scaling ;
	BOOL										Windowed ;
} D_DXGI_SWAP_CHAIN_FULLSCREEN_DESC ;

typedef struct tagD_DXGI_PRESENT_PARAMETERS
{
	UINT										DirtyRectsCount ;
	RECT *										pDirtyRects ;
	RECT *										pScrollRect ;
	POINT *										pScrollOffset ;
} D_DXGI_PRESENT_PARAMETERS ;
...
typedef enum tagD_DXGI_GRAPHICS_PREEMPTION_GRANULARITY
{
	D_DXGI_GRAPHICS_PREEMPTION_DMA_BUFFER_BOUNDARY	= 0,
	D_DXGI_GRAPHICS_PREEMPTION_PRIMITIVE_BOUNDARY	= 1,
	D_DXGI_GRAPHICS_PREEMPTION_TRIANGLE_BOUNDARY	= 2,
	D_DXGI_GRAPHICS_PREEMPTION_PIXEL_BOUNDARY		= 3,
	D_DXGI_GRAPHICS_PREEMPTION_INSTRUCTION_BOUNDARY	= 4
} D_DXGI_GRAPHICS_PREEMPTION_GRANULARITY ;

typedef enum tagD_DXGI_COMPUTE_PREEMPTION_GRANULARITY
{
	D_DXGI_COMPUTE_PREEMPTION_DMA_BUFFER_BOUNDARY	= 0,
	D_DXGI_COMPUTE_PREEMPTION_DISPATCH_BOUNDARY		= 1,
	D_DXGI_COMPUTE_PREEMPTION_THREAD_GROUP_BOUNDARY	= 2,
	D_DXGI_COMPUTE_PREEMPTION_THREAD_BOUNDARY		= 3,
	D_DXGI_COMPUTE_PREEMPTION_INSTRUCTION_BOUNDARY	= 4
} D_DXGI_COMPUTE_PREEMPTION_GRANULARITY ;

typedef enum tagD_DXGI_ADAPTER_FLAG3
{
	D_DXGI_ADAPTER_FLAG3_NONE						= 0,
	D_DXGI_ADAPTER_FLAG3_REMOTE						= 1,
	D_DXGI_ADAPTER_FLAG3_SOFTWARE					= 2,
	D_DXGI_ADAPTER_FLAG3_ACG_COMPATIBLE				= 4,
	D_DXGI_ADAPTER_FLAG3_SUPPORT_MONITORED_FENCES	= 8,
	D_DXGI_ADAPTER_FLAG3_SUPPORT_NON_MONITORED_FENCES	= 0x10,
	D_DXGI_ADAPTER_FLAG3_KEYED_MUTEX_CONFORMANCE	= 0x20,
	D_DXGI_ADAPTER_FLAG3_FORCE_DWORD				= 0xffffffff
} D_DXGI_ADAPTER_FLAG3 ;

typedef enum tagD_DXGI_MEMORY_SEGMENT_GROUP
{
    D_DXGI_MEMORY_SEGMENT_GROUP_LOCAL				= 0,
    D_DXGI_MEMORY_SEGMENT_GROUP_NON_LOCAL			= 1
} D_DXGI_MEMORY_SEGMENT_GROUP ;
...
typedef struct tagD_DXGI_ADAPTER_DESC2
{
	WCHAR										Description[ 128 ] ;
	UINT										VendorId ;
	UINT										DeviceId ;
	...
	LUID										AdapterLuid ;
	UINT										Flags ;
	D_DXGI_GRAPHICS_PREEMPTION_GRANULARITY		GraphicsPreemptionGranularity ;
	D_DXGI_COMPUTE_PREEMPTION_GRANULARITY		ComputePreemptionGranularity ;
} D_DXGI_ADAPTER_DESC2 ;

typedef struct tagD_DXGI_ADAPTER_DESC3
{
	WCHAR										Description[ 128 ] ;
	UINT										VendorId ;
	UINT										DeviceId ;
	...
	SIZE_T										SharedSystemMemory ;
	LUID										AdapterLuid ;
	D_DXGI_ADAPTER_FLAG3						Flags ;
	D_DXGI_GRAPHICS_PREEMPTION_GRANULARITY		GraphicsPreemptionGranularity ;
	D_DXGI_COMPUTE_PREEMPTION_GRANULARITY		ComputePreemptionGranularity ;
} D_DXGI_ADAPTER_DESC3 ;

typedef struct tagD_DXGI_QUERY_VIDEO_MEMORY_INFO
{
	UINT64										Budget ;
	UINT64										CurrentUsage ;
	UINT64										AvailableForReservation ;
	UINT64										CurrentReservation ;
} D_DXGI_QUERY_VIDEO_MEMORY_INFO ;
...
typedef struct tagD_DXGI_MODE_DESC1
{
	UINT										Width ;
	UINT										Height ;
	D_DXGI_RATIONAL								RefreshRate ;
...
typedef struct tagD_DXGI_SWAP_CHAIN_DESC1
{
	UINT										Width ;
	UINT										Height ;
	D_DXGI_FORMAT								Format ;
	...
	D_DXGI_USAGE								BufferUsage ;
	UINT										BufferCount ;
	D_DXGI_SCALING								Scaling ;
	D_DXGI_SWAP_EFFECT							SwapEffect ;
	D_DXGI_ALPHA_MODE							AlphaMode ;
	UINT										Flags ;
} D_DXGI_SWAP_CHAIN_DESC1 ;
...
typedef struct tagD_DXGI_OUTDUPL_MOVE_RECT
{
	POINT										SourcePoint ;
	RECT										DestinationRect ;
} D_DXGI_OUTDUPL_MOVE_RECT;

typedef struct tagD_DXGI_OUTDUPL_DESC
{
...
typedef struct tagD_DXGI_OUTDUPL_POINTER_POSITION
{
	POINT										Position ;
	BOOL										Visible ;
} D_DXGI_OUTDUPL_POINTER_POSITION ;

typedef enum tagD_DXGI_OUTDUPL_POINTER_SHAPE_TYPE
{
    D_DXGI_OUTDUPL_POINTER_SHAPE_TYPE_MONOCHROME	= 0x1,
    D_DXGI_OUTDUPL_POINTER_SHAPE_TYPE_COLOR			= 0x2,
    D_DXGI_OUTDUPL_POINTER_SHAPE_TYPE_MASKED_COLOR	= 0x4
} D_DXGI_OUTDUPL_POINTER_SHAPE_TYPE ;

typedef struct tagD_DXGI_OUTDUPL_POINTER_SHAPE_INFO
{
	UINT										Type ;
	UINT										Width ;
	UINT										Height ;
	UINT										Pitch ;
	POINT										HotSpot ;
} D_DXGI_OUTDUPL_POINTER_SHAPE_INFO;

typedef struct tagD_DXGI_OUTDUPL_FRAME_INFO
{
	...
	D_DXGI_OUTDUPL_POINTER_POSITION				PointerPosition ;
	UINT										TotalMetadataBufferSize ;
	UINT										PointerShapeBufferSize ;
} D_DXGI_OUTDUPL_FRAME_INFO ;
...
class D_IDXGIResource : public D_IDXGIDeviceSubObject
{
public:
    virtual HRESULT __stdcall GetSharedHandle			( HANDLE *pSharedHandle ) = 0 ;
    virtual HRESULT __stdcall GetUsage					( D_DXGI_USAGE *pUsage ) = 0 ;
...
class D_IDXGIOutputDuplication : public D_IDXGIObject
{
public:
    virtual void	__stdcall GetDesc					( D_DXGI_OUTDUPL_DESC *pDesc ) = 0 ;
    virtual HRESULT __stdcall AcquireNextFrame			( UINT TimeoutInMilliseconds, D_DXGI_OUTDUPL_FRAME_INFO *pFrameInfo, D_IDXGIResource **ppDesktopResource ) = 0 ;
    virtual HRESULT __stdcall GetFrameDirtyRects		( UINT DirtyRectsBufferSize, RECT *pDirtyRectsBuffer, UINT *pDirtyRectsBufferSizeRequired ) = 0 ;
    virtual HRESULT __stdcall GetFrameMoveRects			( UINT MoveRectsBufferSize, D_DXGI_OUTDUPL_MOVE_RECT *pMoveRectBuffer, UINT *pMoveRectsBufferSizeRequired ) = 0 ;
    virtual HRESULT __stdcall GetFramePointerShape		( UINT PointerShapeBufferSize, void *pPointerShapeBuffer, UINT *pPointerShapeBufferSizeRequired, D_DXGI_OUTDUPL_POINTER_SHAPE_INFO *pPointerShapeInfo ) = 0 ;
    virtual HRESULT __stdcall MapDesktopSurface			( D_DXGI_MAPPED_RECT *pLockedRect ) = 0 ;
	virtual HRESULT __stdcall UnMapDesktopSurface		( void ) = 0 ;
    virtual HRESULT __stdcall ReleaseFrame				( void ) = 0 ;
        
};

class D_IDXGIOutput1 : public D_IDXGIOutput
{
public:
    virtual HRESULT __stdcall GetDisplayModeList1		( D_DXGI_FORMAT EnumFormat, UINT Flags, UINT *pNumModes, D_DXGI_MODE_DESC1 *pDesc ) = 0 ;
    virtual HRESULT __stdcall FindClosestMatchingMode1	( const D_DXGI_MODE_DESC1 *pModeToMatch, D_DXGI_MODE_DESC1 *pClosestMatch, D_IUnknown *pConcernedDevice ) = 0 ;
    virtual HRESULT __stdcall GetDisplaySurfaceData1	( D_IDXGIResource *pDestination ) = 0 ;
    virtual HRESULT __stdcall DuplicateOutput			( D_IUnknown *pDevice, D_IDXGIOutputDuplication **ppOutputDuplication ) = 0 ;
};
...
class D_IDXGIAdapter2 : public D_IDXGIAdapter1
{
public:
	virtual HRESULT __stdcall GetDesc2					( D_DXGI_ADAPTER_DESC2 *pDesc ) = 0 ;
} ;

class D_IDXGIAdapter3 : public D_IDXGIAdapter2
{
public:
	virtual HRESULT	__stdcall RegisterHardwareContentProtectionTeardownStatusEvent( HANDLE hEvent, DWORD *pdwCookie ) = 0 ;
	virtual void	__stdcall UnregisterHardwareContentProtectionTeardownStatus( DWORD dwCookie ) = 0 ;
	virtual HRESULT	__stdcall QueryVideoMemoryInfo		( UINT NodeIndex, D_DXGI_MEMORY_SEGMENT_GROUP MemorySegmentGroup, D_DXGI_QUERY_VIDEO_MEMORY_INFO *pVideoMemoryInfo ) = 0 ;
	virtual HRESULT	__stdcall SetVideoMemoryReservation	( UINT NodeIndex, D_DXGI_MEMORY_SEGMENT_GROUP MemorySegmentGroup, UINT64 Reservation ) = 0 ;
	virtual HRESULT	__stdcall RegisterVideoMemoryBudgetChangeNotificationEvent( HANDLE hEvent, DWORD *pdwCookie ) = 0 ;
	virtual void	__stdcall UnregisterVideoMemoryBudgetChangeNotification( DWORD dwCookie ) = 0 ;
} ;

class D_IDXGIAdapter4 : public D_IDXGIAdapter3
{
public:
	virtual HRESULT	__stdcall GetDesc3					( D_DXGI_ADAPTER_DESC3 *pDesc ) = 0 ;
} ;
...
class D_IDXGISwapChain1 : public D_IDXGISwapChain
{
public:
    virtual HRESULT __stdcall GetDesc1					( D_DXGI_SWAP_CHAIN_DESC1 *pDesc ) = 0 ;
    virtual HRESULT __stdcall GetFullscreenDesc			( D_DXGI_SWAP_CHAIN_FULLSCREEN_DESC *pDesc ) = 0 ;
    virtual HRESULT __stdcall GetHwnd					( HWND *pHwnd ) = 0 ;
    virtual HRESULT __stdcall GetCoreWindow				( REFIID refiid, void **ppUnk ) = 0 ;
    virtual HRESULT __stdcall Present1					( UINT SyncInterval, UINT PresentFlags, const D_DXGI_PRESENT_PARAMETERS *pPresentParameters ) = 0 ;
    virtual BOOL	__stdcall IsTemporaryMonoSupported	( void ) = 0 ;
    virtual HRESULT __stdcall GetRestrictToOutput		( D_IDXGIOutput **ppRestrictToOutput ) = 0 ;
    virtual HRESULT __stdcall SetBackgroundColor		( const D_D3DCOLORVALUE *pColor ) = 0 ;
    virtual HRESULT __stdcall GetBackgroundColor		( D_D3DCOLORVALUE *pColor ) = 0 ;
    virtual HRESULT __stdcall SetRotation				( D_DXGI_MODE_ROTATION Rotation ) = 0 ;
    virtual HRESULT __stdcall GetRotation				( D_DXGI_MODE_ROTATION *pRotation ) = 0 ;
} ;
...
class D_IDXGIFactory2 : public D_IDXGIFactory1
{
public:
    virtual BOOL	__stdcall IsWindowedStereoEnabled		( void ) = 0;
    virtual HRESULT __stdcall CreateSwapChainForHwnd		( D_IUnknown *pDevice, HWND hWnd, const D_DXGI_SWAP_CHAIN_DESC1 *pDesc, const D_DXGI_SWAP_CHAIN_FULLSCREEN_DESC *pFullscreenDesc, D_IDXGIOutput *pRestrictToOutput, D_IDXGISwapChain1 **ppSwapChain ) = 0 ;
    virtual HRESULT __stdcall CreateSwapChainForCoreWindow	( D_IUnknown *pDevice, D_IUnknown *pWindow, const D_DXGI_SWAP_CHAIN_DESC1 *pDesc, D_IDXGIOutput *pRestrictToOutput, D_IDXGISwapChain1 **ppSwapChain ) = 0 ;
    virtual HRESULT __stdcall GetSharedResourceAdapterLuid	( HANDLE hResource, LUID *pLuid ) = 0 ;
    virtual HRESULT __stdcall RegisterStereoStatusWindow	( HWND WindowHandle, UINT wMsg, DWORD *pdwCookie ) = 0 ;
    virtual HRESULT __stdcall RegisterStereoStatusEvent		( HANDLE hEvent, DWORD *pdwCookie ) = 0 ;
    virtual void	__stdcall UnregisterStereoStatus		( DWORD dwCookie ) = 0 ;
    virtual HRESULT __stdcall RegisterOcclusionStatusWindow	( HWND WindowHandle, UINT wMsg, DWORD *pdwCookie ) = 0 ;
    virtual HRESULT __stdcall RegisterOcclusionStatusEvent	( HANDLE hEvent, DWORD *pdwCookie ) = 0 ;
    virtual void	__stdcall UnregisterOcclusionStatus		( DWORD dwCookie ) = 0 ;
    virtual HRESULT __stdcall CreateSwapChainForComposition	( D_IUnknown *pDevice, const D_DXGI_SWAP_CHAIN_DESC1 *pDesc, D_IDXGIOutput *pRestrictToOutput, D_IDXGISwapChain1 **ppSwapChain ) = 0 ;
} ;

class D_IDXGIFactory3 : public D_IDXGIFactory2
{
public:
...
class D_IDXGIFactory4 : public D_IDXGIFactory3
{
public:
	virtual HRESULT __stdcall EnumAdapterByLuid				( LUID AdapterLuid, REFIID riid, void **ppvAdapter ) = 0 ;
	virtual HRESULT __stdcall EnumWarpAdapter				( REFIID riid, void **ppvAdapter) = 0 ;
        
} ;

class D_IDXGIFactory5 : public D_IDXGIFactory4
{
public:
	virtual HRESULT __stdcall CheckFeatureSupport			( D_DXGI_FEATURE Feature, void *pFeatureSupportData, UINT FeatureSupportDataSize ) = 0 ;
} ;

class D_IDXGIFactory6 : public D_IDXGIFactory5
{
public:
	virtual HRESULT __stdcall EnumAdapterByGpuPreference	( UINT Adapter, D_DXGI_GPU_PREFERENCE GpuPreference, REFIID riid, void **ppvAdapter ) = 0 ;
};
...
typedef HRESULT ( WINAPI * LPD_CREATEDXGIFACTORY2 )( UINT Flags, REFIID riid, void **ppFactory ) ;
...
typedef enum tagD_WICDecodeOptions
{
	D_WICDecodeMetadataCacheOnDemand				= 0,
	D_WICDecodeMetadataCacheOnLoad					= 0x1,
	D_WICMETADATACACHEOPTION_FORCE_DWORD			= 0x7fffffff
} D_WICDecodeOptions ;

typedef enum tagD_WICComponentType
{
	D_WICDecoder									= 0x1,
	D_WICEncoder									= 0x2,
	D_WICPixelFormatConverter						= 0x4,
	D_WICMetadataReader								= 0x8,
	D_WICMetadataWriter								= 0x10,
	D_WICPixelFormat								= 0x20,
	D_WICAllComponents								= 0x3f,
	D_WICCOMPONENTTYPE_FORCE_DWORD					= 0x7fffffff
} D_WICComponentType ;

typedef enum tagD_WICBitmapPaletteType
{
	D_WICBitmapPaletteTypeCustom					= 0,
	D_WICBitmapPaletteTypeMedianCut					= 0x1,
	D_WICBitmapPaletteTypeFixedBW					= 0x2,
	D_WICBitmapPaletteTypeFixedHalftone8			= 0x3,
	D_WICBitmapPaletteTypeFixedHalftone27			= 0x4,
	D_WICBitmapPaletteTypeFixedHalftone64			= 0x5,
	D_WICBitmapPaletteTypeFixedHalftone125			= 0x6,
	D_WICBitmapPaletteTypeFixedHalftone216			= 0x7,
	D_WICBitmapPaletteTypeFixedWebPalette			= D_WICBitmapPaletteTypeFixedHalftone216,
	D_WICBitmapPaletteTypeFixedHalftone252			= 0x8,
	D_WICBitmapPaletteTypeFixedHalftone256			= 0x9,
	D_WICBitmapPaletteTypeFixedGray4				= 0xa,
	D_WICBitmapPaletteTypeFixedGray16				= 0xb,
	D_WICBitmapPaletteTypeFixedGray256				= 0xc,
	D_WICBITMAPPALETTETYPE_FORCE_DWORD				= 0x7fffffff
} D_WICBitmapPaletteType ;

typedef enum tagD_WICBitmapEncoderCacheOption
{
	D_WICBitmapEncoderCacheInMemory					= 0,
	D_WICBitmapEncoderCacheTempFile					= 0x1,
	D_WICBitmapEncoderNoCache						= 0x2,
	D_WICBITMAPENCODERCACHEOPTION_FORCE_DWORD		= 0x7fffffff
} D_WICBitmapEncoderCacheOption ;

typedef enum tagD_WICColorContextType
{
	D_WICColorContextUninitialized					= 0,
	D_WICColorContextProfile						= 0x1,
	D_WICColorContextExifColorSpace					= 0x2
} D_WICColorContextType ;

typedef enum tagD_WICBitmapDitherType
{
	D_WICBitmapDitherTypeNone						= 0,
	D_WICBitmapDitherTypeSolid						= 0,
	D_WICBitmapDitherTypeOrdered4x4					= 0x1,
	D_WICBitmapDitherTypeOrdered8x8					= 0x2,
	D_WICBitmapDitherTypeOrdered16x16				= 0x3,
	D_WICBitmapDitherTypeSpiral4x4					= 0x4,
	D_WICBitmapDitherTypeSpiral8x8					= 0x5,
	D_WICBitmapDitherTypeDualSpiral4x4				= 0x6,
	D_WICBitmapDitherTypeDualSpiral8x8				= 0x7,
	D_WICBitmapDitherTypeErrorDiffusion				= 0x8,
	D_WICBITMAPDITHERTYPE_FORCE_DWORD				= 0x7fffffff
} D_WICBitmapDitherType;

typedef enum tagD_WICBitmapInterpolationMode
{
	D_WICBitmapInterpolationModeNearestNeighbor		= 0,
	D_WICBitmapInterpolationModeLinear				= 0x1,
	D_WICBitmapInterpolationModeCubic				= 0x2,
	D_WICBitmapInterpolationModeFant				= 0x3,
	D_WICBitmapInterpolationModeHighQualityCubic	= 0x4,
	D_WICBITMAPINTERPOLATIONMODE_FORCE_DWORD		= 0x7fffffff
} D_WICBitmapInterpolationMode ;

typedef enum tagD_WICBitmapTransformOptions
{
	D_WICBitmapTransformRotate0						= 0,
	D_WICBitmapTransformRotate90					= 0x1,
	D_WICBitmapTransformRotate180					= 0x2,
	D_WICBitmapTransformRotate270					= 0x3,
	D_WICBitmapTransformFlipHorizontal				= 0x8,
	D_WICBitmapTransformFlipVertical				= 0x10,
	D_WICBITMAPTRANSFORMOPTIONS_FORCE_DWORD			= 0x7fffffff
} D_WICBitmapTransformOptions ;

typedef enum tagD_WICBitmapCreateCacheOption
{
	D_WICBitmapNoCache								= 0,
	D_WICBitmapCacheOnDemand						= 0x1,
	D_WICBitmapCacheOnLoad							= 0x2,
	D_WICBITMAPCREATECACHEOPTION_FORCE_DWORD		= 0x7fffffff
} D_WICBitmapCreateCacheOption ;

typedef enum tagD_WICBitmapAlphaChannelOption
{
	D_WICBitmapUseAlpha								= 0,
	D_WICBitmapUsePremultipliedAlpha				= 0x1,
	D_WICBitmapIgnoreAlpha							= 0x2,
	D_WICBITMAPALPHACHANNELOPTIONS_FORCE_DWORD		= 0x7fffffff
} D_WICBitmapAlphaChannelOption ;

typedef UINT32		D_WICColor ;
typedef REFGUID		D_REFWICPixelFormatGUID ;
typedef GUID		D_WICPixelFormatGUID ;
typedef BYTE *		D_WICInProcPointer ;

typedef struct tagD_PROPBAG2
{
	DWORD										dwType ;
	VARTYPE										vt ;
	CLIPFORMAT									cfType ;
...
typedef struct tagD_WICBitmapPattern
{
...
class D_IWICComponentInfo : public D_IUnknown
{
public:
	virtual HRESULT __stdcall GetComponentType			( D_WICComponentType *pType ) = 0 ;
	virtual HRESULT __stdcall GetCLSID					( CLSID *pclsid ) = 0 ;
	virtual HRESULT __stdcall GetSigningStatus			( DWORD *pStatus ) = 0 ;
	virtual HRESULT __stdcall GetAuthor					( UINT cchAuthor, WCHAR *wzAuthor, UINT *pcchActual ) = 0 ;
	virtual HRESULT __stdcall GetVendorGUID				( GUID *pguidVendor ) = 0 ;
	virtual HRESULT __stdcall GetVersion				( UINT cchVersion, WCHAR *wzVersion, UINT *pcchActual ) = 0 ;
	virtual HRESULT __stdcall GetSpecVersion			( UINT cchSpecVersion, WCHAR *wzSpecVersion, UINT *pcchActual ) = 0 ;
	virtual HRESULT __stdcall GetFriendlyName			( UINT cchFriendlyName, WCHAR *wzFriendlyName, UINT *pcchActual ) = 0 ;
} ;

// MIDL_INTERFACE("E87A44C4-B76E-4c47-8B09-298EB12A2714")
class D_IWICBitmapCodecInfo : public D_IWICComponentInfo
{
public:
	virtual HRESULT __stdcall GetContainerFormat		( GUID *pguidContainerFormat ) = 0 ;
	virtual HRESULT __stdcall GetPixelFormats			( UINT cFormats, GUID *pguidPixelFormats, UINT *pcActual ) = 0 ;
	virtual HRESULT __stdcall GetColorManagementVersion	( UINT cchColorManagementVersion, WCHAR *wzColorManagementVersion, UINT *pcchActual ) = 0 ;
	virtual HRESULT __stdcall GetDeviceManufacturer		( UINT cchDeviceManufacturer, WCHAR *wzDeviceManufacturer, UINT *pcchActual ) = 0 ;
	virtual HRESULT __stdcall GetDeviceModels			( UINT cchDeviceModels, WCHAR *wzDeviceModels, UINT *pcchActual ) = 0 ;
	virtual HRESULT __stdcall GetMimeTypes				( UINT cchMimeTypes, WCHAR *wzMimeTypes, UINT *pcchActual ) = 0 ;
	virtual HRESULT __stdcall GetFileExtensions			( UINT cchFileExtensions, WCHAR *wzFileExtensions, UINT *pcchActual ) = 0 ;
	virtual HRESULT __stdcall DoesSupportAnimation		( BOOL *pfSupportAnimation ) = 0 ; 
	virtual HRESULT __stdcall DoesSupportChromakey		( BOOL *pfSupportChromakey ) = 0 ;
	virtual HRESULT __stdcall DoesSupportLossless		( BOOL *pfSupportLossless ) = 0 ;
	virtual HRESULT __stdcall DoesSupportMultiframe		( BOOL *pfSupportMultiframe ) = 0 ;
	virtual HRESULT __stdcall MatchesMimeType			( LPCWSTR wzMimeType, BOOL *pfMatches ) = 0 ;
} ;

// MIDL_INTERFACE("D8CD007F-D08F-4191-9BFC-236EA7F0E4B5")
class D_IWICBitmapDecoderInfo : public D_IWICBitmapCodecInfo
{
public:
	virtual HRESULT __stdcall GetPatterns				( UINT cbSizePatterns, D_WICBitmapPattern *pPatterns, UINT *pcPatterns, UINT *pcbPatternsActual ) = 0 ;
	virtual HRESULT __stdcall MatchesPattern			( IStream *pIStream, BOOL *pfMatches ) = 0 ;
	virtual HRESULT __stdcall CreateInstance			( class D_IWICBitmapDecoder **ppIBitmapDecoder ) = 0 ;
} ;

// MIDL_INTERFACE("00000120-a8f2-4877-ba0a-fd2b6645fb94")
class D_IWICBitmapSource : public D_IUnknown
{
public:
	virtual HRESULT __stdcall GetSize					( UINT *puiWidth, UINT *puiHeight ) = 0 ;
	virtual HRESULT __stdcall GetPixelFormat			( D_WICPixelFormatGUID *pPixelFormat ) = 0 ;
	virtual HRESULT __stdcall GetResolution				( double *pDpiX, double *pDpiY ) = 0 ;
	virtual HRESULT __stdcall CopyPalette				( class D_IWICPalette *pIPalette ) = 0 ;
	virtual HRESULT __stdcall CopyPixels				( const D_WICRect *prc, UINT cbStride, UINT cbBufferSize, BYTE *pbBuffer ) = 0 ;
} ;

// MIDL_INTERFACE("00000040-a8f2-4877-ba0a-fd2b6645fb94")
class D_IWICPalette : public D_IUnknown
{
public:
	virtual HRESULT __stdcall InitializePredefined		( D_WICBitmapPaletteType ePaletteType, BOOL fAddTransparentColor ) = 0 ;
	virtual HRESULT __stdcall InitializeCustom			( D_WICColor *pColors, UINT cCount ) = 0 ;
	virtual HRESULT __stdcall InitializeFromBitmap		( D_IWICBitmapSource *pISurface, UINT cCount, BOOL fAddTransparentColor ) = 0 ;
	virtual HRESULT __stdcall InitializeFromPalette		( D_IWICPalette *pIPalette ) = 0 ; 
	virtual HRESULT __stdcall GetType					( D_WICBitmapPaletteType *pePaletteType ) = 0 ;
	virtual HRESULT __stdcall GetColorCount				( UINT *pcCount ) = 0 ;
	virtual HRESULT __stdcall GetColors					( UINT cCount, D_WICColor *pColors, UINT *pcActualColors ) = 0 ;
	virtual HRESULT __stdcall IsBlackWhite				( BOOL *pfIsBlackWhite ) = 0 ;
	virtual HRESULT __stdcall IsGrayscale				( BOOL *pfIsGrayscale ) = 0 ;
	virtual HRESULT __stdcall HasAlpha					( BOOL *pfHasAlpha ) = 0 ;
} ;

// MIDL_INTERFACE("30989668-E1C9-4597-B395-458EEDB808DF")
class D_IWICMetadataQueryReader : public D_IUnknown
{
public:
	virtual HRESULT __stdcall GetContainerFormat		( GUID *pguidContainerFormat ) = 0 ;
	virtual HRESULT __stdcall GetLocation				( UINT cchMaxLength, WCHAR *wzNamespace, UINT *pcchActualLength ) = 0 ;
	virtual HRESULT __stdcall GetMetadataByName			( LPCWSTR wzName, PROPVARIANT *pvarValue ) = 0 ;
	virtual HRESULT __stdcall GetEnumerator				( IEnumString **ppIEnumString ) = 0 ;
} ;

// MIDL_INTERFACE("3C613A02-34B2-44ea-9A7C-45AEA9C6FD6D")
class D_IWICColorContext : public D_IUnknown
{
public:
	virtual HRESULT __stdcall InitializeFromFilename	( LPCWSTR wzFilename ) = 0 ;
	virtual HRESULT __stdcall InitializeFromMemory		( const BYTE *pbBuffer, UINT cbBufferSize ) = 0 ;
	virtual HRESULT __stdcall InitializeFromExifColorSpace( UINT value ) = 0 ;
	virtual HRESULT __stdcall GetType					( D_WICColorContextType *pType ) = 0 ;
	virtual HRESULT __stdcall GetProfileBytes			( UINT cbBuffer, BYTE *pbBuffer, UINT *pcbActual ) = 0 ;
	virtual HRESULT __stdcall GetExifColorSpace			( UINT *pValue ) = 0 ;
} ;

// MIDL_INTERFACE("3B16811B-6A43-4ec9-A813-3D930C13B940")
class D_IWICBitmapFrameDecode : public D_IWICBitmapSource
{
public:
	virtual HRESULT __stdcall GetMetadataQueryReader	( D_IWICMetadataQueryReader **ppIMetadataQueryReader ) = 0 ;
	virtual HRESULT __stdcall GetColorContexts			( UINT cCount, D_IWICColorContext **ppIColorContexts, UINT *pcActualCount ) = 0 ;
	virtual HRESULT __stdcall GetThumbnail				( D_IWICBitmapSource **ppIThumbnail ) = 0 ;
} ;

// MIDL_INTERFACE("9EDDE9E7-8DEE-47ea-99DF-E6FAF2ED44BF")
class D_IWICBitmapDecoder : public D_IUnknown
{
public:
	virtual HRESULT __stdcall QueryCapability			( IStream *pIStream, DWORD *pdwCapability ) = 0 ;
	virtual HRESULT __stdcall Initialize				( IStream *pIStream, D_WICDecodeOptions cacheOptions ) = 0 ;
	virtual HRESULT __stdcall GetContainerFormat		( GUID *pguidContainerFormat ) = 0 ;
	virtual HRESULT __stdcall GetDecoderInfo			( D_IWICBitmapDecoderInfo **ppIDecoderInfo ) = 0 ;
	virtual HRESULT __stdcall CopyPalette				( D_IWICPalette *pIPalette ) = 0 ;
	virtual HRESULT __stdcall GetMetadataQueryReader	( D_IWICMetadataQueryReader **ppIMetadataQueryReader ) = 0 ;
	virtual HRESULT __stdcall GetPreview				( D_IWICBitmapSource **ppIBitmapSource ) = 0 ;
	virtual HRESULT __stdcall GetColorContexts			( UINT cCount, D_IWICColorContext **ppIColorContexts, UINT *pcActualCount ) = 0 ;
	virtual HRESULT __stdcall GetThumbnail				( D_IWICBitmapSource **ppIThumbnail ) = 0 ;
	virtual HRESULT __stdcall GetFrameCount				( UINT *pCount ) = 0 ;
	virtual HRESULT __stdcall GetFrame					( UINT index, D_IWICBitmapFrameDecode **ppIBitmapFrame ) = 0 ;
} ;

// MIDL_INTERFACE("94C9B4EE-A09F-4f92-8A1E-4A9BCE7E76FB")
class D_IWICBitmapEncoderInfo : public D_IWICBitmapCodecInfo
{
public:
	virtual HRESULT __stdcall CreateInstance			( class D_IWICBitmapEncoder **ppIBitmapEncoder ) = 0 ;
} ;

// MIDL_INTERFACE("22F55882-280B-11d0-A8A9-00A0C90C2004")
class D_IPropertyBag2 : public D_IUnknown
{
public:
	virtual HRESULT __stdcall Read						( ULONG cProperties, D_PROPBAG2 *pPropBag, D_IErrorLog *pErrLog, VARIANT *pvarValue, HRESULT *phrError ) = 0 ;
	virtual HRESULT __stdcall Write						( ULONG cProperties, D_PROPBAG2 *pPropBag, VARIANT *pvarValue ) = 0 ; 
	virtual HRESULT __stdcall CountProperties			( ULONG *pcProperties ) = 0 ;
	virtual HRESULT __stdcall GetPropertyInfo			( ULONG iProperty, ULONG cProperties, D_PROPBAG2 *pPropBag, ULONG *pcProperties ) = 0 ;
	virtual HRESULT __stdcall LoadObject				( LPCOLESTR pstrName, DWORD dwHint, D_IUnknown *pUnkObject, D_IErrorLog *pErrLog ) = 0 ;
} ;

// MIDL_INTERFACE("A721791A-0DEF-4d06-BD91-2118BF1DB10B")
class D_IWICMetadataQueryWriter : public D_IWICMetadataQueryReader
{
public:
	virtual HRESULT __stdcall SetMetadataByName			( LPCWSTR wzName, const PROPVARIANT *pvarValue ) = 0 ;
	virtual HRESULT __stdcall RemoveMetadataByName		( LPCWSTR wzName ) = 0 ;
} ;

// MIDL_INTERFACE("00000105-a8f2-4877-ba0a-fd2b6645fb94")
class D_IWICBitmapFrameEncode : public D_IUnknown
{
public:
	virtual HRESULT __stdcall Initialize				( D_IPropertyBag2 *pIEncoderOptions ) = 0 ;
	virtual HRESULT __stdcall SetSize					( UINT uiWidth, UINT uiHeight ) = 0 ;
	virtual HRESULT __stdcall SetResolution				( double dpiX, double dpiY ) = 0 ;
	virtual HRESULT __stdcall SetPixelFormat			( D_WICPixelFormatGUID *pPixelFormat ) = 0 ;
	virtual HRESULT __stdcall SetColorContexts			( UINT cCount, D_IWICColorContext **ppIColorContext ) = 0 ;
	virtual HRESULT __stdcall SetPalette				( D_IWICPalette *pIPalette ) = 0 ;
	virtual HRESULT __stdcall SetThumbnail				( D_IWICBitmapSource *pIThumbnail ) = 0 ;
	virtual HRESULT __stdcall WritePixels				( UINT lineCount, UINT cbStride, UINT cbBufferSize, BYTE *pbPixels ) = 0 ;
	virtual HRESULT __stdcall WriteSource				( D_IWICBitmapSource *pIBitmapSource, D_WICRect *prc ) = 0 ;
	virtual HRESULT __stdcall Commit					( void ) = 0 ;
	virtual HRESULT __stdcall GetMetadataQueryWriter	( D_IWICMetadataQueryWriter **ppIMetadataQueryWriter ) = 0 ;
} ;

// MIDL_INTERFACE("00000103-a8f2-4877-ba0a-fd2b6645fb94")
class D_IWICBitmapEncoder : public D_IUnknown
{
public:
	virtual HRESULT __stdcall Initialize				( IStream *pIStream, D_WICBitmapEncoderCacheOption cacheOption ) = 0 ;
	virtual HRESULT __stdcall GetContainerFormat		( GUID *pguidContainerFormat ) = 0 ;
	virtual HRESULT __stdcall GetEncoderInfo			( D_IWICBitmapEncoderInfo **ppIEncoderInfo ) = 0 ;
	virtual HRESULT __stdcall SetColorContexts			( UINT cCount, D_IWICColorContext **ppIColorContext ) = 0 ;
	virtual HRESULT __stdcall SetPalette				( D_IWICPalette *pIPalette ) = 0 ;
	virtual HRESULT __stdcall SetThumbnail				( D_IWICBitmapSource *pIThumbnail ) = 0 ;
	virtual HRESULT __stdcall SetPreview				( D_IWICBitmapSource *pIPreview ) = 0 ;
	virtual HRESULT __stdcall CreateNewFrame			( D_IWICBitmapFrameEncode **ppIFrameEncode, D_IPropertyBag2 **ppIEncoderOptions ) = 0 ;
	virtual HRESULT __stdcall Commit					( void ) = 0 ;
	virtual HRESULT __stdcall GetMetadataQueryWriter	( D_IWICMetadataQueryWriter **ppIMetadataQueryWriter ) = 0 ;
} ;

// MIDL_INTERFACE("00000301-a8f2-4877-ba0a-fd2b6645fb94")
class D_IWICFormatConverter : public D_IWICBitmapSource
{
public:
	virtual HRESULT __stdcall Initialize				( D_IWICBitmapSource *pISource, D_REFWICPixelFormatGUID dstFormat, D_WICBitmapDitherType dither, D_IWICPalette *pIPalette, double alphaThresholdPercent, D_WICBitmapPaletteType paletteTranslate ) = 0 ;
	virtual HRESULT __stdcall CanConvert				( D_REFWICPixelFormatGUID srcPixelFormat, D_REFWICPixelFormatGUID dstPixelFormat, BOOL *pfCanConvert ) = 0 ;
} ;

// MIDL_INTERFACE("9F34FB65-13F4-4f15-BC57-3726B5E53D9F")
class D_IWICFormatConverterInfo : public D_IWICComponentInfo
{
public:
	virtual HRESULT __stdcall GetPixelFormats			( UINT cFormats, D_WICPixelFormatGUID *pPixelFormatGUIDs, UINT *pcActual ) = 0 ;
	virtual HRESULT __stdcall CreateInstance			( D_IWICFormatConverter **ppIConverter ) = 0 ;
} ;

// MIDL_INTERFACE("00000302-a8f2-4877-ba0a-fd2b6645fb94")
class D_IWICBitmapScaler : public D_IWICBitmapSource
{
public:
	virtual HRESULT __stdcall Initialize				( D_IWICBitmapSource *pISource, UINT uiWidth, UINT uiHeight, D_WICBitmapInterpolationMode mode ) = 0 ;
} ;

// MIDL_INTERFACE("E4FBCF03-223D-4e81-9333-D635556DD1B5")
class D_IWICBitmapClipper : public D_IWICBitmapSource
{
public:
	virtual HRESULT __stdcall Initialize				( D_IWICBitmapSource *pISource, const D_WICRect *prc ) = 0 ;
} ;

// MIDL_INTERFACE("5009834F-2D6A-41ce-9E1B-17C5AFF7A782")
class D_IWICBitmapFlipRotator : public D_IWICBitmapSource
{
public:
	virtual HRESULT __stdcall Initialize				( D_IWICBitmapSource *pISource, D_WICBitmapTransformOptions options ) = 0 ;
} ;

// MIDL_INTERFACE("135FF860-22B7-4ddf-B0F6-218F4F299A43")
class D_IWICStream : public IStream
{
public:
	virtual HRESULT __stdcall InitializeFromIStream		( IStream *pIStream ) = 0 ;
	virtual HRESULT __stdcall InitializeFromFilename	( LPCWSTR wzFileName, DWORD dwDesiredAccess ) = 0 ;
	virtual HRESULT __stdcall InitializeFromMemory		( D_WICInProcPointer pbBuffer, DWORD cbBufferSize ) = 0 ;
	virtual HRESULT __stdcall InitializeFromIStreamRegion( IStream *pIStream, ULARGE_INTEGER ulOffset, ULARGE_INTEGER ulMaxSize ) = 0 ;
} ;

// MIDL_INTERFACE("B66F034F-D0E2-40ab-B436-6DE39E321A94")
class D_IWICColorTransform : public D_IWICBitmapSource
{
public:
	virtual HRESULT __stdcall Initialize				( D_IWICBitmapSource *pIBitmapSource, D_IWICColorContext *pIContextSource, D_IWICColorContext *pIContextDest, D_REFWICPixelFormatGUID pixelFmtDest ) = 0 ;
} ;

// MIDL_INTERFACE("00000123-a8f2-4877-ba0a-fd2b6645fb94")
class D_IWICBitmapLock : public D_IUnknown
{
public:
	virtual HRESULT __stdcall GetSize					( UINT *puiWidth, UINT *puiHeight ) = 0 ;
	virtual HRESULT __stdcall GetStride					( UINT *pcbStride ) = 0 ;
	virtual HRESULT __stdcall GetDataPointer			( UINT *pcbBufferSize, D_WICInProcPointer *ppbData ) = 0 ;
	virtual HRESULT __stdcall GetPixelFormat			( D_WICPixelFormatGUID *pPixelFormat ) = 0 ;
} ;

// MIDL_INTERFACE("00000121-a8f2-4877-ba0a-fd2b6645fb94")
class D_IWICBitmap : public D_IWICBitmapSource
{
public:
	virtual HRESULT __stdcall Lock						( const D_WICRect *prcLock, DWORD flags, D_IWICBitmapLock **ppILock ) = 0 ;
	virtual HRESULT __stdcall SetPalette				( D_IWICPalette *pIPalette ) = 0 ;
	virtual HRESULT __stdcall SetResolution				( double dpiX, double dpiY ) = 0 ;
} ;

// MIDL_INTERFACE("B84E2C09-78C9-4AC4-8BD3-524AE1663A2F")
class D_IWICFastMetadataEncoder : public D_IUnknown
{
public:
	virtual HRESULT __stdcall Commit					( void ) = 0 ;
	virtual HRESULT __stdcall GetMetadataQueryWriter	( D_IWICMetadataQueryWriter **ppIMetadataQueryWriter ) = 0 ;
...
class D_IWICImagingFactory : public D_IUnknown
{
public:
	virtual HRESULT __stdcall CreateDecoderFromFilename	( LPCWSTR wzFilename, const GUID *pguidVendor, DWORD dwDesiredAccess, D_WICDecodeOptions metadataOptions, D_IWICBitmapDecoder **ppIDecoder ) = 0 ;
	virtual HRESULT __stdcall CreateDecoderFromStream	( IStream *pIStream, const GUID *pguidVendor, D_WICDecodeOptions metadataOptions, D_IWICBitmapDecoder **ppIDecoder ) = 0 ;
	virtual HRESULT __stdcall CreateDecoderFromFileHandle( DWORD_PTR hFile, const GUID *pguidVendor, D_WICDecodeOptions metadataOptions, D_IWICBitmapDecoder **ppIDecoder ) = 0 ;
	virtual HRESULT __stdcall CreateComponentInfo		( REFCLSID clsidComponent, D_IWICComponentInfo **ppIInfo ) = 0 ;
	virtual HRESULT __stdcall CreateDecoder				( REFGUID guidContainerFormat, const GUID *pguidVendor, D_IWICBitmapDecoder **ppIDecoder ) = 0 ;
	virtual HRESULT __stdcall CreateEncoder				( REFGUID guidContainerFormat, const GUID *pguidVendor, D_IWICBitmapEncoder **ppIEncoder ) = 0 ;
	virtual HRESULT __stdcall CreatePalette				( D_IWICPalette **ppIPalette ) = 0 ;
	virtual HRESULT __stdcall CreateFormatConverter		( D_IWICFormatConverter **ppIFormatConverter ) = 0 ;
	virtual HRESULT __stdcall CreateBitmapScaler		( D_IWICBitmapScaler **ppIBitmapScaler ) = 0 ;
	virtual HRESULT __stdcall CreateBitmapClipper		( D_IWICBitmapClipper **ppIBitmapClipper ) = 0 ;
	virtual HRESULT __stdcall CreateBitmapFlipRotator	( D_IWICBitmapFlipRotator **ppIBitmapFlipRotator ) = 0 ;
	virtual HRESULT __stdcall CreateStream				( D_IWICStream **ppIWICStream ) = 0 ;
	virtual HRESULT __stdcall CreateColorContext		( D_IWICColorContext **ppIWICColorContext ) = 0 ;
	virtual HRESULT __stdcall CreateColorTransformer	( D_IWICColorTransform **ppIWICColorTransform ) = 0 ;
	virtual HRESULT __stdcall CreateBitmap				( UINT uiWidth, UINT uiHeight, D_REFWICPixelFormatGUID pixelFormat, D_WICBitmapCreateCacheOption option, D_IWICBitmap **ppIBitmap ) = 0 ;
	virtual HRESULT __stdcall CreateBitmapFromSource	( D_IWICBitmapSource *pIBitmapSource, D_WICBitmapCreateCacheOption option, D_IWICBitmap **ppIBitmap ) = 0 ;
	virtual HRESULT __stdcall CreateBitmapFromSourceRect( D_IWICBitmapSource *pIBitmapSource, UINT x, UINT y, UINT width, UINT height, D_IWICBitmap **ppIBitmap ) = 0 ;
	virtual HRESULT __stdcall CreateBitmapFromMemory	( UINT uiWidth, UINT uiHeight, D_REFWICPixelFormatGUID pixelFormat, UINT cbStride, UINT cbBufferSize, BYTE *pbBuffer, D_IWICBitmap **ppIBitmap ) = 0 ;
	virtual HRESULT __stdcall CreateBitmapFromHBITMAP	( HBITMAP hBitmap, HPALETTE hPalette, D_WICBitmapAlphaChannelOption options, D_IWICBitmap **ppIBitmap ) = 0 ;
	virtual HRESULT __stdcall CreateBitmapFromHICON		( HICON hIcon, D_IWICBitmap **ppIBitmap ) = 0 ;
	virtual HRESULT __stdcall CreateComponentEnumerator	( DWORD componentTypes, DWORD options, IEnumUnknown **ppIEnumUnknown ) = 0 ;
	virtual HRESULT __stdcall CreateFastMetadataEncoderFromDecoder( D_IWICBitmapDecoder *pIDecoder, D_IWICFastMetadataEncoder **ppIFastEncoder ) = 0 ;
	virtual HRESULT __stdcall CreateFastMetadataEncoderFromFrameDecode( D_IWICBitmapFrameDecode *pIFrameDecoder, D_IWICFastMetadataEncoder **ppIFastEncoder ) = 0 ;
	virtual HRESULT __stdcall CreateQueryWriter			( REFGUID guidMetadataFormat, const GUID *pguidVendor, D_IWICMetadataQueryWriter **ppIQueryWriter ) = 0 ;
	virtual HRESULT __stdcall CreateQueryWriterFromReader( D_IWICMetadataQueryReader *pIQueryReader, const GUID *pguidVendor, D_IWICMetadataQueryWriter **ppIQueryWriter ) = 0 ;
} ;
...
{
public :
	virtual HRESULT __stdcall GetCapabilities			( D_DIDEVCAPS * ) = 0 ;
...
#define D_AUDCLNT_E_BUFFER_SIZE_NOT_ALIGNED				MAKE_HRESULT( SEVERITY_ERROR, 2185 /* FACILITY_AUDCLNT */, 0x019 )

#define D_WAVE_FORMAT_EXTENSIBLE						(0xFFFE)

typedef struct tagD_PROPERTYKEY
{
	GUID										fmtid ;
	DWORD										pid ;
} D_PROPERTYKEY ;
...
public:
	...
	virtual HRESULT __stdcall GetAt						( DWORD iProp, D_PROPERTYKEY *pkey ) = 0 ;
	virtual HRESULT __stdcall GetValue					( D_PROPERTYKEY &key, D_PROPVARIANT *pv ) = 0 ;
	virtual HRESULT __stdcall SetValue					( D_PROPERTYKEY &key, D_PROPVARIANT &propvar ) = 0 ;
	virtual HRESULT __stdcall Commit					( void ) = 0 ;
};
...
public:
	...
	virtual HRESULT __stdcall OnPropertyValueChanged	( LPCWSTR pwstrDeviceId, const D_PROPERTYKEY key ) = 0 ;
} ;
...
class D_IAudioClock : public D_IUnknown
{
public:
	virtual HRESULT __stdcall GetFrequency				( UINT64 *pu64Frequency ) = 0 ;
	virtual HRESULT __stdcall GetPosition				( UINT64 *pu64Position, UINT64 *pu64QPCPosition ) = 0 ;
	virtual HRESULT __stdcall GetCharacteristics		( DWORD *pdwCharacteristics ) = 0 ;
} ;

class D_IAudioClient : public D_IUnknown
{
public:
	virtual HRESULT __stdcall Initialize				( D_AUDCLNT_SHAREMODE ShareMode, DWORD StreamFlags, D_REFERENCE_TIME hnsBufferDuration, D_REFERENCE_TIME hnsPeriodicity, const WAVEFORMATEX *pFormat, const GUID * AudioSessionGuid ) = 0 ;
...
enum
{
	...
	D_ASIOSTInt24MSB							= 1,
	D_ASIOSTInt32MSB							= 2,
	D_ASIOSTFloat32MSB							= 3,
	D_ASIOSTFloat64MSB							= 4,

	D_ASIOSTInt32MSB16							= 8,
	D_ASIOSTInt32MSB18							= 9,
	D_ASIOSTInt32MSB20							= 10,
	D_ASIOSTInt32MSB24							= 11,
	
	D_ASIOSTInt16LSB							= 16,
	D_ASIOSTInt24LSB							= 17,
	D_ASIOSTInt32LSB							= 18,
	D_ASIOSTFloat32LSB							= 19,
	D_ASIOSTFloat64LSB							= 20,

	D_ASIOSTInt32LSB16							= 24,
	D_ASIOSTInt32LSB18							= 25,
	D_ASIOSTInt32LSB20							= 26,
	D_ASIOSTInt32LSB24							= 27,

	D_ASIOSTDSDInt8LSB1							= 32,
	D_ASIOSTDSDInt8MSB1							= 33,
	D_ASIOSTDSDInt8NER8							= 40,

	D_ASIOSTLastEntry
} ;

typedef struct D_tagASIOTimeStamp
{
	unsigned long			hi ;
	unsigned long			lo ;
} D_ASIOTimeStamp ;

typedef struct D_tagASIOSamples
{
	unsigned long			hi ;
	unsigned long			lo ;
} D_ASIOSamples ;

// typedef struct D_tagASIODriverInfo
// {
//	long					asioVersion ;
//	long					driverVersion ;
//	char					name[ 32 ] ;
...
typedef struct D_tagASIOBufferInfo
{
	long					isInput ;
	long					channelNum ;
	void					*buffers[ 2 ] ;
...
typedef struct D_tagAsioTimeInfo
{
	double					speed ;
	D_ASIOTimeStamp			systemTime ;
	D_ASIOSamples			samplePosition ;
	double					sampleRate ;
	unsigned long			flags ;
	char					reserved[ 12 ] ;
} D_AsioTimeInfo ;

typedef struct D_ASIOTimeCode
{       
	double					speed ;
	D_ASIOSamples			timeCodeSamples ;
	unsigned long			flags ;
	char					future[ 64 ] ;
} D_ASIOTimeCode ;

typedef struct D_tagASIOTime
{
	long					reserved[ 4 ] ;
	D_AsioTimeInfo			timeInfo ;
	D_ASIOTimeCode			timeCode ;
} D_ASIOTime ;

typedef struct D_tagASIOChannelInfo
{
	long					channel ;
	long					isInput ;
	long					isActive ;
...
typedef struct D_tagASIOCallbacks
{
	void					( *bufferSwitch )( long doubleBufferIndex, long directProcess ) ;
	void					( *sampleRateDidChange )( double sRate ) ;
	long					( *asioMessage )( long selector, long value, void *message, double *opt ) ;
	D_ASIOTime*				( *bufferSwitchTimeInfo )( D_ASIOTime *params, long doubleBufferIndex, long directProcess ) ;
} D_ASIOCallbacks ;

typedef struct D_tagASIOClockSource
{
	long					index ;
...
class D_IASIO : public D_IUnknown
{
public :
	virtual	long			  init						( void *sysHandle ) = 0 ;
	virtual	void			  getDriverName				( char *name ) = 0 ;
	virtual	long			  getDriverVersion			( void ) = 0 ;
	virtual	void			  getErrorMessage			( char *string ) = 0 ;
	virtual	long			  start						( void ) = 0 ;
	virtual	long			  stop						( void ) = 0 ;
	...
	virtual	long			  getClockSources			( D_ASIOClockSource *clocks, long *numSources ) = 0 ;
	virtual	long			  setClockSource			( long reference ) = 0 ;
	virtual	long			  getSamplePosition			( D_ASIOSamples *sPos, D_ASIOTimeStamp *tStamp ) = 0;
	virtual	long			  getChannelInfo			( D_ASIOChannelInfo *info ) = 0 ;
	virtual	long			  createBuffers				( D_ASIOBufferInfo *bufferInfos, long numChannels,long bufferSize, D_ASIOCallbacks *callbacks ) = 0 ;
	virtual	long			  disposeBuffers			( void ) = 0 ;
	virtual	long			  controlPanel				( void ) = 0 ;
...
{
	D_EOAC_NONE									= 0,
	D_EOAC_MUTUAL_AUTH							= 0x1,
	D_EOAC_STATIC_CLOAKING						= 0x20,
	D_EOAC_DYNAMIC_CLOAKING						= 0x40,
	D_EOAC_ANY_AUTHORITY						= 0x80,
	D_EOAC_MAKE_FULLSIC							= 0x100,
	D_EOAC_DEFAULT								= 0x800,
	D_EOAC_SECURE_REFS							= 0x2,
	D_EOAC_ACCESS_CONTROL						= 0x4,
	D_EOAC_APPID								= 0x8,
	D_EOAC_DYNAMIC								= 0x10,
	D_EOAC_REQUIRE_FULLSIC						= 0x200,
	D_EOAC_AUTO_IMPERSONATE						= 0x400,
	D_EOAC_DISABLE_AAA							= 0x1000,
	D_EOAC_NO_CUSTOM_MARSHAL					= 0x2000,
	D_EOAC_RESERVED1							= 0x4000
} D_EOLE_AUTHENTICATION_CAPABILITIES;

typedef long D_CIMTYPE ;

class D_IWbemContext : public D_IUnknown
{
public:
    virtual HRESULT __stdcall Clone						( D_IWbemContext **ppNewCopy ) = 0 ;
    virtual HRESULT __stdcall GetNames					( long lFlags, SAFEARRAY * *pNames ) = 0 ;
    virtual HRESULT __stdcall BeginEnumeration			( long lFlags ) = 0 ;
    virtual HRESULT __stdcall Next						( long lFlags, BSTR *pstrName, VARIANT *pValue ) = 0 ;
    virtual HRESULT __stdcall EndEnumeration			( void ) = 0 ;
    virtual HRESULT __stdcall SetValue					( LPCWSTR wszName, long lFlags, VARIANT *pValue ) = 0 ;
    virtual HRESULT __stdcall GetValue					( LPCWSTR wszName, long lFlags, VARIANT *pValue ) = 0 ;
    virtual HRESULT __stdcall DeleteValue				( LPCWSTR wszName, long lFlags ) = 0 ;
    virtual HRESULT __stdcall DeleteAll					( void ) = 0 ;
} ;

class D_IWbemQualifierSet : public D_IUnknown
{
public:
	virtual HRESULT __stdcall Get						( LPCWSTR wszName, long lFlags, VARIANT *pVal, long *plFlavor ) = 0 ;
	virtual HRESULT __stdcall Put						( LPCWSTR wszName, VARIANT *pVal, long lFlavor ) = 0 ;
	virtual HRESULT __stdcall Delete					( LPCWSTR wszName ) = 0 ;
	virtual HRESULT __stdcall GetNames					( long lFlags, SAFEARRAY * *pNames ) = 0 ;
	virtual HRESULT __stdcall BeginEnumeration			( long lFlags ) = 0 ;
	virtual HRESULT __stdcall Next						( long lFlags, BSTR *pstrName, VARIANT *pVal, long *plFlavor ) = 0 ;
	virtual HRESULT __stdcall EndEnumeration			( void ) = 0 ;
} ;

class D_IWbemClassObject : public D_IUnknown
{
public:
	virtual HRESULT __stdcall GetQualifierSet			( D_IWbemQualifierSet **ppQualSet ) = 0 ;
	virtual HRESULT __stdcall Get						( LPCWSTR wszName, long lFlags, VARIANT *pVal, D_CIMTYPE *pType, long *plFlavor ) = 0 ;
	virtual HRESULT __stdcall Put						( LPCWSTR wszName, long lFlags, VARIANT *pVal, D_CIMTYPE Type ) = 0 ;
	virtual HRESULT __stdcall Delete					( LPCWSTR wszName ) = 0 ;
	virtual HRESULT __stdcall GetNames					( LPCWSTR wszQualifierName, long lFlags, VARIANT *pQualifierVal, SAFEARRAY * *pNames ) = 0 ;
	virtual HRESULT __stdcall BeginEnumeration			( long lEnumFlags ) = 0 ;
	virtual HRESULT __stdcall Next						( long lFlags, BSTR *strName, VARIANT *pVal, D_CIMTYPE *pType, long *plFlavor ) = 0 ;
	virtual HRESULT __stdcall EndEnumeration			( void ) = 0 ;
	virtual HRESULT __stdcall GetPropertyQualifierSet	( LPCWSTR wszProperty, D_IWbemQualifierSet **ppQualSet ) = 0 ;
	virtual HRESULT __stdcall Clone						( D_IWbemClassObject **ppCopy ) = 0 ;
	virtual HRESULT __stdcall GetObjectText				( long lFlags, BSTR *pstrObjectText ) = 0 ;
	virtual HRESULT __stdcall SpawnDerivedClass			( long lFlags, D_IWbemClassObject **ppNewClass ) = 0 ;
	virtual HRESULT __stdcall SpawnInstance				( long lFlags, D_IWbemClassObject **ppNewInstance ) = 0 ;
	virtual HRESULT __stdcall CompareTo					( long lFlags, D_IWbemClassObject *pCompareTo ) = 0 ;
	virtual HRESULT __stdcall GetPropertyOrigin			( LPCWSTR wszName, BSTR *pstrClassName ) = 0 ;
	virtual HRESULT __stdcall InheritsFrom				( LPCWSTR strAncestor ) = 0 ;
	virtual HRESULT __stdcall GetMethod					( LPCWSTR wszName, long lFlags, D_IWbemClassObject **ppInSignature, D_IWbemClassObject **ppOutSignature ) = 0 ;
	virtual HRESULT __stdcall PutMethod					( LPCWSTR wszName, long lFlags, D_IWbemClassObject *pInSignature, D_IWbemClassObject *pOutSignature ) = 0 ;
	virtual HRESULT __stdcall DeleteMethod				( LPCWSTR wszName ) = 0 ;
	virtual HRESULT __stdcall BeginMethodEnumeration	( long lEnumFlags ) = 0 ;
	virtual HRESULT __stdcall NextMethod				( long lFlags, BSTR *pstrName, D_IWbemClassObject **ppInSignature, D_IWbemClassObject **ppOutSignature ) = 0 ;
	virtual HRESULT __stdcall EndMethodEnumeration		( void ) = 0 ;
	virtual HRESULT __stdcall GetMethodQualifierSet		( LPCWSTR wszMethod, D_IWbemQualifierSet **ppQualSet ) = 0 ;
	virtual HRESULT __stdcall GetMethodOrigin			( LPCWSTR wszMethodName, BSTR *pstrClassName ) = 0 ;
} ;

class D_IWbemObjectSink : public D_IUnknown
{
public:
	virtual HRESULT __stdcall Indicate					( long lObjectCount, D_IWbemClassObject **apObjArray ) = 0 ;
	virtual HRESULT __stdcall SetStatus					( long lFlags, HRESULT hResult, BSTR strParam, D_IWbemClassObject *pObjParam ) = 0 ;
} ;

class D_IEnumWbemClassObject : public D_IUnknown
{
public:
	virtual HRESULT __stdcall Reset						( void ) = 0 ;
	virtual HRESULT __stdcall Next						( long lTimeout, ULONG uCount, D_IWbemClassObject **apObjects, ULONG *puReturned ) = 0 ;
	virtual HRESULT __stdcall NextAsync					( ULONG uCount, D_IWbemObjectSink *pSink ) = 0 ;
	virtual HRESULT __stdcall Clone						( D_IEnumWbemClassObject **ppEnum ) = 0 ;
	virtual HRESULT __stdcall Skip						( long lTimeout, ULONG nCount ) = 0 ;
} ;

class D_IWbemServices ;

class D_IWbemCallResult : public D_IUnknown
{
public:
	virtual HRESULT __stdcall GetResultObject			( long lTimeout, D_IWbemClassObject **ppResultObject ) = 0 ;
	virtual HRESULT __stdcall GetResultString			( long lTimeout, BSTR *pstrResultString ) = 0 ;
	virtual HRESULT __stdcall GetResultServices			( long lTimeout, D_IWbemServices **ppServices ) = 0 ;
	virtual HRESULT __stdcall GetCallStatus				( long lTimeout, long *plStatus ) = 0 ;
} ;

class D_IWbemServices : public D_IUnknown
{
public:
	virtual HRESULT __stdcall OpenNamespace				( const BSTR strNamespace, long lFlags, D_IWbemContext *pCtx, D_IWbemServices **ppWorkingNamespace, D_IWbemCallResult **ppResult ) = 0 ;
	virtual HRESULT __stdcall CancelAsyncCall			( D_IWbemObjectSink *pSink ) = 0 ;
	virtual HRESULT __stdcall QueryObjectSink			( long lFlags, D_IWbemObjectSink **ppResponseHandler ) = 0 ;
	virtual HRESULT __stdcall GetObject					( const BSTR strObjectPath, long lFlags, D_IWbemContext *pCtx, D_IWbemClassObject **ppObject, D_IWbemCallResult **ppCallResult ) = 0 ;
	virtual HRESULT __stdcall GetObjectAsync			( const BSTR strObjectPath, long lFlags, D_IWbemContext *pCtx, D_IWbemObjectSink *pResponseHandler ) = 0 ;
	virtual HRESULT __stdcall PutClass					( D_IWbemClassObject *pObject, long lFlags, D_IWbemContext *pCtx, D_IWbemCallResult **ppCallResult ) = 0 ;
	virtual HRESULT __stdcall PutClassAsync				( D_IWbemClassObject *pObject, long lFlags, D_IWbemContext *pCtx, D_IWbemObjectSink *pResponseHandler ) = 0 ;
	virtual HRESULT __stdcall DeleteClass				( const BSTR strClass, long lFlags, D_IWbemContext *pCtx, D_IWbemCallResult **ppCallResult ) = 0 ;
	virtual HRESULT __stdcall DeleteClassAsync			( const BSTR strClass, long lFlags, D_IWbemContext *pCtx, D_IWbemObjectSink *pResponseHandler ) = 0 ;
	virtual HRESULT __stdcall CreateClassEnum			( const BSTR strSuperclass, long lFlags, D_IWbemContext *pCtx, D_IEnumWbemClassObject **ppEnum ) = 0 ;
	virtual HRESULT __stdcall CreateClassEnumAsync		( const BSTR strSuperclass, long lFlags, D_IWbemContext *pCtx, D_IWbemObjectSink *pResponseHandler ) = 0 ;
	virtual HRESULT __stdcall PutInstance				( D_IWbemClassObject *pInst, long lFlags, D_IWbemContext *pCtx, D_IWbemCallResult **ppCallResult ) = 0 ;
	virtual HRESULT __stdcall PutInstanceAsync			( D_IWbemClassObject *pInst, long lFlags, D_IWbemContext *pCtx, D_IWbemObjectSink *pResponseHandler ) = 0 ;
	virtual HRESULT __stdcall DeleteInstance			( const BSTR strObjectPath, long lFlags, D_IWbemContext *pCtx, D_IWbemCallResult **ppCallResult ) = 0 ;
	virtual HRESULT __stdcall DeleteInstanceAsync		( const BSTR strObjectPath, long lFlags, D_IWbemContext *pCtx, D_IWbemObjectSink *pResponseHandler ) = 0 ;
	virtual HRESULT __stdcall CreateInstanceEnum		( const BSTR strFilter, long lFlags, D_IWbemContext *pCtx, D_IEnumWbemClassObject **ppEnum ) = 0 ;
	virtual HRESULT __stdcall CreateInstanceEnumAsync	( const BSTR strFilter, long lFlags, D_IWbemContext *pCtx, D_IWbemObjectSink *pResponseHandler ) = 0 ;
	virtual HRESULT __stdcall ExecQuery					( const BSTR strQueryLanguage, const BSTR strQuery, long lFlags, D_IWbemContext *pCtx, D_IEnumWbemClassObject **ppEnum ) = 0 ;
	virtual HRESULT __stdcall ExecQueryAsync			( const BSTR strQueryLanguage, const BSTR strQuery, long lFlags, D_IWbemContext *pCtx, D_IWbemObjectSink *pResponseHandler ) = 0 ;
	virtual HRESULT __stdcall ExecNotificationQuery		( const BSTR strQueryLanguage, const BSTR strQuery, long lFlags, D_IWbemContext *pCtx, D_IEnumWbemClassObject **ppEnum ) = 0 ;
	virtual HRESULT __stdcall ExecNotificationQueryAsync( const BSTR strQueryLanguage, const BSTR strQuery, long lFlags, D_IWbemContext *pCtx, D_IWbemObjectSink *pResponseHandler ) = 0 ;
	virtual HRESULT __stdcall ExecMethod				( const BSTR strObjectPath, const BSTR strMethodName, long lFlags, D_IWbemContext *pCtx, D_IWbemClassObject *pInParams, D_IWbemClassObject **ppOutParams, D_IWbemCallResult **ppCallResult ) = 0 ;
	virtual HRESULT __stdcall ExecMethodAsync			( const BSTR strObjectPath, const BSTR strMethodName, long lFlags, D_IWbemContext *pCtx, D_IWbemClassObject *pInParams, D_IWbemObjectSink *pResponseHandler ) = 0 ;
} ;

class D_IWbemLocator : public D_IUnknown
{
public:
	virtual HRESULT	__stdcall ConnectServer				( const BSTR strNetworkResource, const BSTR strUser, const BSTR strPassword, const BSTR strLocale, long lSecurityFlags, const BSTR strAuthority, D_IWbemContext *pCtx, D_IWbemServices **ppNamespace ) = 0 ;
} ;
