...
#if ( defined( DX_THREAD_SAFE ) || defined( DX_THREAD_SAFE_NETWORK_ONLY ) ) && defined( WINDOWS_DESKTOP_OS )
...
extern	void 		*DxAllocAligned( size_t AllocSize, size_t Alignment, const char *File , int Line  )
{
	void *Result ;
	DXFUNC_BEGIN
	Result = NS_DxAllocAligned( AllocSize, Alignment, File , Line  ) ;
	DXFUNC_END
	return Result ;
}
...
extern	void 		*DxCallocAligned( size_t AllocSize, size_t Alignment, const char *File , int Line  )
{
	void *Result ;
	DXFUNC_BEGIN
	Result = NS_DxCallocAligned(  AllocSize, Alignment,  File ,  Line  ) ;
	DXFUNC_END
	return Result ;
}
...
extern	void		*DxReallocAligned( void *Memory, size_t AllocSize, size_t Alignment, const char *File , int Line  )
{
	void *Result ;
	DXFUNC_BEGIN
	Result = NS_DxReallocAligned( Memory,  AllocSize, Alignment, File , Line ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetUseCharCodeFormat( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetUseCharCodeFormat() ;
	DXFUNC_END
	return Result ;
}
...
extern LONGLONG FileRead_size_handle( int FileHandle )
{
	LONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_FileRead_size_handle( FileHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetResourceInfoWithStrLen( const TCHAR *ResourceName, size_t ResourceNameLength, const TCHAR *ResourceType, size_t ResourceTypeLength, void **DataPointerP , size_t *DataSizeP )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int SetOutApplicationSystemLogValidFlag( int Flag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetOutApplicationSystemLogValidFlag( Flag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetBackgroundColor( int Red, int Green, int Blue, int Alpha )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetBackgroundColor(  Red,  Green,  Blue, Alpha ) ;
	DXFUNC_END
	return Result ;
}
extern int GetBackgroundColor( int *Red, int *Green, int *Blue, int *Alpha )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetBackgroundColor(  Red,  Green,  Blue, Alpha ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetUseMouseEventTransparentWindowFlag( int Flag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUseMouseEventTransparentWindowFlag( Flag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetHandleNum( int HandleType )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetHandleNum( HandleType ) ;
	DXFUNC_END
	return Result ;
}
extern int GetMaxHandleNum( int HandleType )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetMaxHandleNum( HandleType ) ;
	DXFUNC_END
	return Result ;
}
extern int DumpHandleInfo( int HandleType )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DumpHandleInfo( HandleType ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetPrivateProfileStringDx( const TCHAR *AppName, const TCHAR *KeyName, const TCHAR *Default, TCHAR *ReturnedString, size_t ReturnedStringBytes, const TCHAR *IniFilePath, int IniFileCharCodeFormat )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetPrivateProfileStringDx( AppName, KeyName, Default, ReturnedString, ReturnedStringBytes, IniFilePath, IniFileCharCodeFormat ) ;
	DXFUNC_END
	return Result ;
}

extern int GetPrivateProfileStringDxWithStrLen( const TCHAR *AppName, size_t AppNameLength, const TCHAR *KeyName, size_t KeyNameLength, const TCHAR *Default, size_t DefaultLength, TCHAR *ReturnedString, size_t ReturnedStringBufferBytes, const TCHAR *IniFilePath, size_t IniFilePathLength, int IniFileCharCodeFormat )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetPrivateProfileStringDxWithStrLen( AppName, AppNameLength, KeyName, KeyNameLength, Default, DefaultLength, ReturnedString, ReturnedStringBufferBytes, IniFilePath, IniFilePathLength, IniFileCharCodeFormat ) ;
	DXFUNC_END
	return Result ;
}

extern int GetPrivateProfileIntDx( const TCHAR *AppName, const TCHAR *KeyName, int Default, const TCHAR *IniFilePath, int IniFileCharCodeFormat )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetPrivateProfileIntDx( AppName, KeyName, Default, IniFilePath, IniFileCharCodeFormat ) ;
	DXFUNC_END
	return Result ;
}

extern int GetPrivateProfileIntDxWithStrLen( const TCHAR *AppName, size_t AppNameLength, const TCHAR *KeyName, size_t KeyNameLength, int Default, const TCHAR *IniFilePath, size_t IniFilePathLength, int IniFileCharCodeFormat )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetPrivateProfileIntDxWithStrLen( AppName, AppNameLength, KeyName, KeyNameLength, Default, IniFilePath, IniFilePathLength, IniFileCharCodeFormat ) ;
	DXFUNC_END
	return Result ;
}

extern int GetPrivateProfileStringDxForMem( const TCHAR *AppName, const TCHAR *KeyName, const TCHAR *Default, TCHAR *ReturnedStringBuffer, size_t ReturnedStringBufferBytes, const void *IniFileImage, size_t IniFileImageBytes, int IniFileCharCodeFormat )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetPrivateProfileStringDxForMem( AppName, KeyName, Default, ReturnedStringBuffer, ReturnedStringBufferBytes, IniFileImage, IniFileImageBytes, IniFileCharCodeFormat ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetPrivateProfileStringDxForMemWithStrLen( const TCHAR *AppName, size_t AppNameLength, const TCHAR *KeyName, size_t KeyNameLength, const TCHAR *Default, size_t DefaultLength, TCHAR *ReturnedStringBuffer, size_t ReturnedStringBufferBytes, const void *IniFileImage, size_t IniFileImageBytes, int IniFileCharCodeFormat )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetPrivateProfileStringDxForMemWithStrLen( AppName, AppNameLength, KeyName, KeyNameLength, Default, DefaultLength, ReturnedStringBuffer, ReturnedStringBufferBytes, IniFileImage, IniFileImageBytes, IniFileCharCodeFormat ) ;
	DXFUNC_END
	return Result ;
}

extern int GetPrivateProfileIntDxForMem( const TCHAR *AppName, const TCHAR *KeyName, int Default, const void *IniFileImage, size_t IniFileImageBytes, int IniFileCharCodeFormat )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetPrivateProfileIntDxForMem( AppName, KeyName, Default, IniFileImage, IniFileImageBytes, IniFileCharCodeFormat ) ;
	DXFUNC_END
	return Result ;
}

extern int GetPrivateProfileIntDxForMemWithStrLen( const TCHAR *AppName, size_t AppNameLength, const TCHAR *KeyName, size_t KeyNameLength, int Default, const void *IniFileImage, size_t IniFileImageBytes, int IniFileCharCodeFormat )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetPrivateProfileIntDxForMemWithStrLen( AppName, AppNameLength, KeyName, KeyNameLength, Default, IniFileImage, IniFileImageBytes, IniFileCharCodeFormat ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetMouseDispIgnoreMenuFlag( int IgnoreMenuFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetMouseDispIgnoreMenuFlag( IgnoreMenuFlag ) ;
	DXFUNC_END
	return Result ;
}
#ifndef DX_NON_INPUT
...
extern	int	GetTouchInput( int InputNo, int *PositionX, int *PositionY, int *ID , int *Device, float *Pressure )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetTouchInput( InputNo, PositionX, PositionY, ID , Device, Pressure ) ;
	DXFUNC_END
	return Result ;
}
...
extern ULONGLONG GetNowSysPerformanceCount( void )
{
	ULONGLONG Result ;
//	DXFUNC_BEGIN
	Result = NS_GetNowSysPerformanceCount() ;
//	DXFUNC_END
	return Result ;
}
extern ULONGLONG GetSysPerformanceFrequency( void )
{
	ULONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_GetSysPerformanceFrequency() ;
	DXFUNC_END
	return Result ;
}
extern ULONGLONG ConvSysPerformanceCountToSeconds( ULONGLONG Count )
{
	ULONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_ConvSysPerformanceCountToSeconds( Count ) ;
	DXFUNC_END
	return Result ;
}
extern ULONGLONG ConvSysPerformanceCountToMilliSeconds( ULONGLONG Count )
{
	ULONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_ConvSysPerformanceCountToMilliSeconds( Count ) ;
	DXFUNC_END
	return Result ;
}
extern ULONGLONG ConvSysPerformanceCountToMicroSeconds( ULONGLONG Count )
{
	ULONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_ConvSysPerformanceCountToMicroSeconds( Count ) ;
	DXFUNC_END
	return Result ;
}
extern ULONGLONG ConvSysPerformanceCountToNanoSeconds( ULONGLONG Count )
{
	ULONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_ConvSysPerformanceCountToNanoSeconds( Count ) ;
	DXFUNC_END
	return Result ;
}
extern ULONGLONG ConvSecondsToSysPerformanceCount( ULONGLONG Seconds )
{
	ULONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_ConvSecondsToSysPerformanceCount( Seconds ) ;
	DXFUNC_END
	return Result ;
}
extern ULONGLONG ConvMilliSecondsToSysPerformanceCount( ULONGLONG MilliSeconds )
{
	ULONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_ConvMilliSecondsToSysPerformanceCount( MilliSeconds ) ;
	DXFUNC_END
	return Result ;
}
extern ULONGLONG ConvMicroSecondsToSysPerformanceCount( ULONGLONG MicroSeconds )
{
	ULONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_ConvMicroSecondsToSysPerformanceCount( MicroSeconds ) ;
	DXFUNC_END
	return Result ;
}
extern ULONGLONG ConvNanoSecondsToSysPerformanceCount( ULONGLONG NanoSeconds )
{
	ULONGLONG Result ;
	DXFUNC_BEGIN
	Result = NS_ConvNanoSecondsToSysPerformanceCount( NanoSeconds ) ;
	DXFUNC_END
	return Result ;
}
...
extern DWORD GetMersenneTwisterRand( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetMersenneTwisterRand() ;
	DXFUNC_END
	return Result ;
}
...
extern DWORD GetMersenneTwisterRandHandle( DWORD_PTR RandHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetMersenneTwisterRandHandle( RandHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawIMEInputExtendString( int x, int y, double ExRateX, double ExRateY, int SelectStringNum , int DrawCandidateList )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawIMEInputExtendString(  x,  y,  ExRateX,  ExRateY,  SelectStringNum ,  DrawCandidateList ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetIMEInputString( const TCHAR *String )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetIMEInputString( String ) ;
	DXFUNC_END
	return Result ;
}

extern int SetIMEInputStringWithStrLen(	const TCHAR *String, size_t StringLength )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetIMEInputStringWithStrLen( String, StringLength ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawKeyInputExtendString( int x, int y, double ExRateX, double ExRateY, int InputHandle , int DrawCandidateList )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawKeyInputExtendString( x, y, ExRateX, ExRateY, InputHandle , DrawCandidateList ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetJoypadButtonNum( int InputType )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetJoypadButtonNum( InputType ) ;
	DXFUNC_END
	return Result ;
}
...
extern	double GetJoypadDefaultDeadZoneAll( void )
{
	double Result ;
	DXFUNC_BEGIN
	Result = NS_GetJoypadDefaultDeadZoneAll() ;
	DXFUNC_END
	return Result ;
}
...
extern int ReSetupInputSystem( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReSetupInputSystem();
	DXFUNC_END
	return Result ;
}
...
extern int SetUseXboxControllerDirectInputFlag( int Flag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUseXboxControllerDirectInputFlag( Flag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetVideoMemorySizeEx( ULONGLONG *TotalSize, ULONGLONG *UseSize )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetVideoMemorySizeEx( TotalSize, UseSize ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetUserScreenImage( void *Image, int PixelFormat )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUserScreenImage( Image, PixelFormat ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetUseFullScreenResolutionMode( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetUseFullScreenResolutionMode() ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawCircleGauge( int CenterX, int CenterY, double Percent, int GrHandle, double StartPercent , double Scale, int ReverseX, int ReverseY )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawCircleGauge(  CenterX,  CenterY, Percent,  GrHandle, StartPercent, Scale, ReverseX, ReverseY ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawPolygon32bitIndexed2D( const VERTEX2D *Vertex, int VertexNum, const unsigned int *Indices, int PolygonNum, int GrHandle, int TransFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawPolygon32bitIndexed2D( Vertex, VertexNum, Indices, PolygonNum, GrHandle, TransFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawPolygon32bitIndexed3D( const VERTEX3D *Vertex, int VertexNum, const unsigned int *Indices, int PolygonNum, int GrHandle, int TransFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawPolygon32bitIndexed3D( Vertex, VertexNum, Indices,  PolygonNum,  GrHandle,  TransFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawPolygon32bitIndexed3DBase( const VERTEX_3D *Vertex, int VertexNum, const unsigned int *Indices, int IndexNum, int PrimitiveType /* DX_PRIMTYPE_TRIANGLELIST 等 */, int GrHandle, int TransFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawPolygon32bitIndexed3DBase( Vertex, VertexNum, Indices, IndexNum, PrimitiveType,  GrHandle,  TransFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawPrimitive32bitIndexed2D( const VERTEX2D *Vertex, int VertexNum, const unsigned int *Indices, int IndexNum, int PrimitiveType, int GrHandle, int TransFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawPrimitive32bitIndexed2D( Vertex,  VertexNum, Indices,  IndexNum,  PrimitiveType,  GrHandle,  TransFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawPrimitive32bitIndexed3D( const VERTEX3D *Vertex, int VertexNum, const unsigned int *Indices, int IndexNum, int PrimitiveType, int GrHandle, int TransFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawPrimitive32bitIndexed3D( Vertex,  VertexNum, Indices,  IndexNum,  PrimitiveType,  GrHandle,  TransFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawBoxSet( const RECTDATA *RectData, int Num )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawBoxSet( RectData, Num ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawFormatString2( int x, int y, unsigned int Color, unsigned int EdgeColor, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawFormatVString2( int x, int y, unsigned int Color, unsigned int EdgeColor, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawExtendFormatString2( int x, int y, double ExRateX, double ExRateY, unsigned int Color, unsigned int EdgeColor, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawExtendFormatVString2( int x, int y, double ExRateX, double ExRateY, unsigned int Color, unsigned int EdgeColor, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawFormatString2F( float x, float y, unsigned int Color, unsigned int EdgeColor, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawFormatVString2F( float x, float y, unsigned int Color, unsigned int EdgeColor, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawExtendFormatString2F( float x, float y, double ExRateX, double ExRateY, unsigned int Color, unsigned int EdgeColor, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawExtendFormatVString2F( float x, float y, double ExRateX, double ExRateY, unsigned int Color, unsigned int EdgeColor, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawFormatString2ToHandle( int x, int y, unsigned int Color, unsigned int EdgeColor, int FontHandle, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawFormatVString2ToHandle( int x, int y, unsigned int Color, unsigned int EdgeColor, int FontHandle, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawExtendFormatString2ToHandle( int x, int y, double ExRateX, double ExRateY, unsigned int Color, unsigned int EdgeColor, int FontHandle, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
	...
	va_end( VaList ) ;
	DXFUNC_BEGIN
	Result = NS_DrawExtendStringToHandle( x, y, ExRateX, ExRateY, String,  Color, EdgeColor,  FontHandle ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawExtendFormatVString2ToHandle( int x, int y, double ExRateX, double ExRateY, unsigned int Color, unsigned int EdgeColor, int FontHandle, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
	...
	DXFUNC_BEGIN
	Result = NS_DrawExtendVStringToHandle( x, y, ExRateX, ExRateY, String,  Color, EdgeColor,  FontHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawFormatString2FToHandle( float x, float y, unsigned int Color, unsigned int EdgeColor, int FontHandle, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
	...
	va_end( VaList ) ;
	DXFUNC_BEGIN
	Result = NS_DrawStringFToHandle( x,  y, String,  Color,  FontHandle, EdgeColor ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawFormatVString2FToHandle( float x, float y, unsigned int Color, unsigned int EdgeColor, int FontHandle, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern int DrawExtendFormatString2FToHandle( float x, float y, double ExRateX, double ExRateY, unsigned int Color, unsigned int EdgeColor, int FontHandle, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
	...
	va_end( VaList ) ;
	DXFUNC_BEGIN
	Result = NS_DrawExtendStringFToHandle( x, y, ExRateX, ExRateY, String,  Color,  FontHandle, EdgeColor ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawExtendFormatVString2FToHandle( float x, float y, double ExRateX, double ExRateY, unsigned int Color, unsigned int EdgeColor, int FontHandle, const TCHAR *FormatString, ... )
{
	int Result ;
	va_list VaList ;
	TCHAR String[ 2048 ] ;
...
extern void * GetBufferVertexBuffer( int VertexBufHandle )
{
	void *Result ;
	DXFUNC_BEGIN
	Result = NS_GetBufferVertexBuffer( VertexBufHandle ) ;
	DXFUNC_END
	return Result ;
}
extern int UpdateVertexBuffer( int VertexBufHandle, int UpdateStartIndex, int UpdateVertexNum )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_UpdateVertexBuffer( VertexBufHandle, UpdateStartIndex, UpdateVertexNum ) ;
	DXFUNC_END
	return Result ;
}
...
extern void * GetBufferIndexBuffer( int IndexBufHandle )
{
	void * Result ;
	DXFUNC_BEGIN
	Result = NS_GetBufferIndexBuffer( IndexBufHandle ) ;
	DXFUNC_END
	return Result ;
}
extern int UpdateIndexBuffer( int IndexBufHandle, int UpdateStartIndex, int UpdateIndexNum )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_UpdateIndexBuffer( IndexBufHandle, UpdateStartIndex, UpdateIndexNum ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			LoadGeometryShader( const TCHAR *FileName )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadGeometryShader( FileName ) ;
	DXFUNC_END
	return Result ;
}
extern int LoadGeometryShaderWithStrLen( const TCHAR *FileName, size_t FileNameLength )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadGeometryShaderWithStrLen( FileName, FileNameLength ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			LoadGeometryShaderFromMem( const void *ImageAddress, int ImageSize )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadGeometryShaderFromMem( ImageAddress,  ImageSize ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			SetUseGeometryShader( int ShaderHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUseGeometryShader( ShaderHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			CalcPolygon32bitIndexedBinormalAndTangentsToShader( VERTEX3DSHADER *Vertex, int VertexNum, const unsigned int *Indices, int PolygonNum )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CalcPolygon32bitIndexedBinormalAndTangentsToShader( Vertex, VertexNum, Indices, PolygonNum ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			DrawPolygon32bitIndexed2DToShader( const VERTEX2DSHADER *Vertex, int VertexNum, const unsigned int *Indices, int PolygonNum )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawPolygon32bitIndexed2DToShader( Vertex, VertexNum, Indices, PolygonNum ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			DrawPolygon32bitIndexed3DToShader( const VERTEX3DSHADER *Vertex, int VertexNum, const unsigned int *Indices, int PolygonNum )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawPolygon32bitIndexed3DToShader( Vertex, VertexNum, Indices, PolygonNum ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			DrawPrimitive32bitIndexed2DToShader( const VERTEX2DSHADER *Vertex, int VertexNum, const unsigned int *Indices, int IndexNum, int PrimitiveType )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawPrimitive32bitIndexed2DToShader( Vertex, VertexNum, Indices,  IndexNum,  PrimitiveType ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			DrawPrimitive32bitIndexed3DToShader( const VERTEX3DSHADER *Vertex, int VertexNum, const unsigned int *Indices, int IndexNum, int PrimitiveType )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawPrimitive32bitIndexed3DToShader( Vertex,  VertexNum, Indices,  IndexNum,  PrimitiveType ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			SetGraphBlendScalingFilterMode( int IsBilinearFilter )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetGraphBlendScalingFilterMode( IsBilinearFilter ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			GraphBlendRectBlt2( int SrcGrHandle, int BlendGrHandle, int DestGrHandle, int SrcX1, int SrcY1, int SrcX2, int SrcY2, int BlendX1, int BlendY1, int BlendX2, int BlendY2, int DestX, int DestY, int BlendRatio /* ブレンド効果の影響度( 0:０％  255:１００％ ) */ , int BlendType /* DX_GRAPH_BLEND_ADD 等 */ , ... )
{
	int Result ;
	va_list VaList ;
...
extern int GetDrawAlphaTest( int *TestMode, int *TestParam )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetDrawAlphaTest(  TestMode,  TestParam ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetUseRightHandClippingProcess( int Flag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUseRightHandClippingProcess( Flag ) ;
	DXFUNC_END
	return Result ;
}
extern int GetUseRightHandClippingProcess( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetUseRightHandClippingProcess() ;
	DXFUNC_END
	return Result ;
}
...
extern void *GetDesktopScreenGraphMemImage( int x1, int y1, int x2, int y2, int *Width, int *Height, int *Stride, int ColorBitDepth )
{
	void *Result ;
	DXFUNC_BEGIN
	Result = NS_GetDesktopScreenGraphMemImage( x1, y1, x2, y2, Width, Height, Stride, ColorBitDepth ) ;
	DXFUNC_END
	return Result ;
}
extern int GetOtherWindowGraph( HWND Window, int x1, int y1, int x2, int y2, int GrHandle, int DestX, int DestY )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetOtherWindowGraph( Window,  x1,  y1,  x2,  y2,  GrHandle,  DestX,  DestY ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetUseDirect3D11BGRASupport( int Flag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUseDirect3D11BGRASupport( Flag ) ;
	DXFUNC_END
	return Result ;
}
extern int GetUseDirect3D11BGRASupport( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetUseDirect3D11BGRASupport() ;
	DXFUNC_END
	return Result ;
}
...
extern	int		ReCreateDivGraphFromSoftImage(		int SIHandle, int AllNum, int XNum, int YNum, int   SizeX, int   SizeY, const int *HandleArray )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFromSoftImage(		 SIHandle,  AllNum,  XNum,  YNum,    SizeX,    SizeY, HandleArray ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int		ReCreateDivGraphFFromSoftImage(	    int SIHandle, int AllNum, int XNum, int YNum, float SizeX, float SizeY, const int *HandleArray )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFFromSoftImage(	     SIHandle,  AllNum,  XNum,  YNum, SizeX, SizeY, HandleArray ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int		ReCreateDivGraphFromBaseImage( BASEIMAGE *BaseImage, int AllNum, int XNum, int YNum, int   SizeX, int   SizeY, const int *HandleArray )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFromBaseImage( BaseImage,  AllNum,  XNum,  YNum,    SizeX,    SizeY, HandleArray );
	DXFUNC_END
	return Result ;
}
extern	int		ReCreateDivGraphFFromBaseImage( BASEIMAGE *BaseImage, int AllNum, int XNum, int YNum, float SizeX, float SizeY, const int *HandleArray )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFFromBaseImage( BaseImage,  AllNum,  XNum,  YNum, SizeX, SizeY, HandleArray );
	DXFUNC_END
	return Result ;
}
...
extern	int			SetUseLightAngleAttenuation( int UseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUseLightAngleAttenuation( UseFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetCreateGraphHandle( int GrHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetCreateGraphHandle( GrHandle ) ;
	DXFUNC_END
	return Result ;
}
extern int GetCreateGraphHandle( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetCreateGraphHandle() ;
	DXFUNC_END
	return Result ;
}
extern int SetCreateDivGraphHandle( const int *HandleArray, int HandleNum )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetCreateDivGraphHandle( HandleArray, HandleNum ) ;
	DXFUNC_END
	return Result ;
}
extern int GetCreateDivGraphHandle( int *HandleArray )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetCreateDivGraphHandle( HandleArray ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetUseLoadDivGraphSizeCheckFlag( int Flag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUseLoadDivGraphSizeCheckFlag( Flag ) ;
	DXFUNC_END
	return Result ;
}
extern int GetUseLoadDivGraphSizeCheckFlag( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetUseLoadDivGraphSizeCheckFlag() ;
	DXFUNC_END
	return Result ;
}
...
extern int SetDrawCustomBlendMode( int BlendEnable, int SrcBlendRGB /* DX_BLEND_SRC_COLOR 等 */, int DestBlendRGB /* DX_BLEND_SRC_COLOR 等 */, int BlendOpRGB /* DX_BLENDOP_ADD 等 */, int SrcBlendA /* DX_BLEND_SRC_COLOR 等 */, int DestBlendA /* DX_BLEND_SRC_COLOR 等 */, int BlendOpA /* DX_BLENDOP_ADD 等 */, int BlendParam )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetDrawCustomBlendMode( BlendEnable, SrcBlendRGB, DestBlendRGB, BlendOpRGB, SrcBlendA,  DestBlendA, BlendOpA, BlendParam ) ;
	DXFUNC_END
	return Result ;
}
extern int GetDrawCustomBlendMode( int *BlendEnable, int *SrcBlendRGB, int *DestBlendRGB, int *BlendOpRGB, int *SrcBlendA, int *DestBlendA, int *BlendOpA, int *BlendParam )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetDrawCustomBlendMode( BlendEnable, SrcBlendRGB, DestBlendRGB, BlendOpRGB, SrcBlendA, DestBlendA, BlendOpA, BlendParam ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetWriteAlphaChannelFlag( int Flag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetWriteAlphaChannelFlag( Flag ) ;
	DXFUNC_END
	return Result ;
}
extern int GetWriteAlphaChannelFlag( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetWriteAlphaChannelFlag() ;
	DXFUNC_END
	return Result ;
}
extern int CheckSeparateAlphaBlendEnable( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CheckSeparateAlphaBlendEnable() ;
	DXFUNC_END
	return Result ;
}
...
extern int GetMaskBaseImageInfo( BASEIMAGE *BaseImage, int MaskHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetMaskBaseImageInfo( BaseImage, MaskHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int ChangeFontFromHandle( int FontHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ChangeFontFromHandle( FontHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetFontMaxCacheCharNumToHandle( int FontHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetFontMaxCacheCharNumToHandle( FontHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetDrawStringKerningPairInfo( const TCHAR *PairChar, int *KernAmount )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetDrawStringKerningPairInfo( PairChar, KernAmount ) ;
	DXFUNC_END
	return Result ;
}
extern int GetDrawStringKerningPairInfoWithStrLen(	const TCHAR *PairChar, size_t PairCharLength, int *KernAmount )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetDrawStringKerningPairInfoWithStrLen(	PairChar, PairCharLength, KernAmount ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetDrawStringKerningPairInfoToHandle( const TCHAR *PairChar, int *KernAmount, int FontHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetDrawStringKerningPairInfoToHandle( PairChar, KernAmount, FontHandle ) ;
	DXFUNC_END
	return Result ;
}
extern int GetDrawStringKerningPairInfoToHandleWithStrLen( const TCHAR *PairChar, size_t PairCharLength, int *KernAmount, int FontHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetDrawStringKerningPairInfoToHandleWithStrLen( PairChar, PairCharLength, KernAmount, FontHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int GetFontMaxCacheCharNum( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetFontMaxCacheCharNum() ;
	DXFUNC_END
	return Result ;
}
...
extern int SetFontOnlyDrawType( int OnlyType )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetFontOnlyDrawType( OnlyType ) ;
	DXFUNC_END
	return Result ;
}
extern int GetFontOnlyDrawType( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetFontOnlyDrawType() ;
	DXFUNC_END
	return Result ;
}
...
extern int GetUsePremulAlphaConvertLoad( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetUsePremulAlphaConvertLoad() ;
	DXFUNC_END
	return Result ;
}
extern int SetUseConvertNormalFormatLoad( int UseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUseConvertNormalFormatLoad( UseFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int GetUseConvertNormalFormatLoad( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_GetUseConvertNormalFormatLoad() ;
	DXFUNC_END
	return Result ;
}
...
extern int CreateBGR8ColorData( COLORDATA *ColorDataBuf )
{
	int Result ;
	Result = NS_CreateBGR8ColorData( ColorDataBuf ) ;
	return Result ;
}
...
extern int AddStreamSoundMemToMem( const void *FileImageBuffer, size_t ImageSize, int LoopNum,  int SoundHandle, int StreamDataType, int UnionHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int StopStreamSoundMem( int SoundHandle, int IsNextLoopEnd )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_StopStreamSoundMem( SoundHandle, IsNextLoopEnd ) ;
	DXFUNC_END
	return Result ;
}
extern int SetStreamSoundCurrentPosition( LONGLONG Byte, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern LONGLONG GetStreamSoundCurrentPosition( int SoundHandle )
{
	LONGLONG Result ;
	DXFUNC_BEGIN
...
extern int SetStreamSoundCurrentTime( LONGLONG Time, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern LONGLONG GetStreamSoundCurrentTime( int SoundHandle )
{
	LONGLONG Result ;
	DXFUNC_BEGIN
...
extern int LoadSoundMemByMemImageBase( const void *FileImageBuffer, size_t ImageSize, int BufferNum, int UnionHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int LoadSoundMemByMemImage( const void *FileImageBuffer, size_t ImageSize, int BufferNum, int UnionHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int LoadSoundMemByMemImage2( const void *UData, size_t UDataSize, const WAVEFORMATEX *UFormat, size_t UHeaderSize )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int LoadSoundMemByMemImageToBufNumSitei( const void *FileImageBuffer, size_t ImageSize, int BufferNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int LoadSoundMem2ByMemImage( const void *FileImageBuffer1, size_t ImageSize1, const void *FileImageBuffer2, size_t ImageSize2 )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int StopSoundMem( int SoundHandle, int IsNextLoopEnd )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_StopSoundMem( SoundHandle, IsNextLoopEnd ) ;
	DXFUNC_END
	return Result ;
}
...
extern LONGLONG GetCurrentPositionSoundMem( int SoundHandle )
{
	LONGLONG Result ;
	DXFUNC_BEGIN
...
extern int SetSoundCurrentPosition( LONGLONG Byte, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern LONGLONG GetSoundCurrentPosition( int SoundHandle )
{
	LONGLONG Result ;
	DXFUNC_BEGIN
...
extern int SetSoundCurrentTime( LONGLONG Time, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern LONGLONG GetSoundCurrentTime( int SoundHandle )
{
	LONGLONG Result ;
	DXFUNC_BEGIN
...
extern LONGLONG GetSoundTotalSample( int SoundHandle )
{
	LONGLONG Result ;
	DXFUNC_BEGIN
...
extern LONGLONG GetSoundTotalTime( int SoundHandle )
{
	LONGLONG Result ;
	DXFUNC_BEGIN
...
extern int SetLoopTimePosSoundMem( LONGLONG LoopTime, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int SetLoopSamplePosSoundMem( LONGLONG LoopSamplePosition, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int SetLoopStartTimePosSoundMem( LONGLONG LoopStartTime, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int SetLoopStartSamplePosSoundMem( LONGLONG LoopStartSamplePosition, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int SetLoopAreaTimePosSoundMem( LONGLONG LoopStartTime, LONGLONG LoopEndTime, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int GetLoopAreaTimePosSoundMem( LONGLONG *LoopStartTime, LONGLONG *LoopEndTime, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int SetLoopAreaSamplePosSoundMem( LONGLONG LoopStartSamplePosition, LONGLONG LoopEndSamplePosition, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int GetLoopAreaSamplePosSoundMem( LONGLONG *LoopStartSamplePosition, LONGLONG *LoopEndSamplePosition, int SoundHandle )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int	SetCreateSoundLoopAreaTimePos( LONGLONG  LoopStartTime, LONGLONG  LoopEndTime )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int	GetCreateSoundLoopAreaTimePos( LONGLONG *LoopStartTime, LONGLONG *LoopEndTime )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int	SetCreateSoundLoopAreaSamplePos( LONGLONG  LoopStartSamplePosition, LONGLONG  LoopEndSamplePosition )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int	GetCreateSoundLoopAreaSamplePos( LONGLONG *LoopStartSamplePosition, LONGLONG *LoopEndSamplePosition )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int SetEnableWASAPIFlag( int Flag, int IsExclusive, int DevicePeriod, int SamplePerSec )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetEnableWASAPIFlag( Flag, IsExclusive, DevicePeriod, SamplePerSec ) ;
	DXFUNC_END
	return Result ;
}
#ifndef DX_NON_ASIO
extern int SetEnableASIOFlag( int Flag, int BufferSize, int SamplePerSec )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetEnableASIOFlag( Flag, BufferSize, SamplePerSec ) ;
	DXFUNC_END
	return Result ;
}
extern int SetUseASIODriverIndex( int Index )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetUseASIODriverIndex( Index ) ;
	DXFUNC_END
	return Result ;
}
#endif // DX_NON_ASIO
extern	int SetEnableMMEwaveOutFlag( int Flag, int BufferSamples, int SamplePerSec )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetEnableMMEwaveOutFlag( Flag, BufferSamples, SamplePerSec ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			MakeSoftSound2Ch16Bit44KHz( LONGLONG SampleNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			MakeSoftSound2Ch16Bit22KHz( LONGLONG SampleNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			MakeSoftSound2Ch8Bit44KHz( LONGLONG SampleNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			MakeSoftSound2Ch8Bit22KHz( LONGLONG SampleNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			MakeSoftSound1Ch16Bit44KHz( LONGLONG SampleNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			MakeSoftSound1Ch16Bit22KHz( LONGLONG SampleNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			MakeSoftSound1Ch8Bit44KHz( LONGLONG SampleNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			MakeSoftSound1Ch8Bit22KHz( LONGLONG SampleNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			MakeSoftSoundCustom( int ChannelNum, int BitsPerSample, int SamplesPerSec, LONGLONG SampleNum, int IsFloatType )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			ReadSoftSoundData( int SoftSoundHandle, LONGLONG SamplePosition, int *Channel1, int *Channel2 )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			ReadSoftSoundDataF( int SoftSoundHandle, LONGLONG SamplePosition, float *Channel1, float *Channel2 )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			WriteSoftSoundData( int SoftSoundHandle, LONGLONG SamplePosition, int Channel1, int Channel2 )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			WriteSoftSoundDataF( int SoftSoundHandle, LONGLONG SamplePosition, float Channel1, float Channel2 )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int			GetFFTVibrationSoftSound( int SoftSoundHandle, int Channel, LONGLONG SamplePosition, int SampleNum, float *Buffer, int BufferLength )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			GetFFTVibrationSoftSoundBase( int SoftSoundHandle, int Channel, LONGLONG SamplePosition, int SampleNum, float *RealBuffer_Array, float *ImagBuffer_Array, int BufferLength )
{
	int Result ;
	DXFUNC_BEGIN
...
extern	int			AddDataSoftSoundPlayer( int SSoundPlayerHandle, int SoftSoundHandle, LONGLONG AddSamplePosition, int AddSampleNum )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int LoadMusicMemByMemImage( const void *FileImageBuffer, size_t FileImageSize )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int MV1SetLoadModelTextureLoad( int Flag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1SetLoadModelTextureLoad( Flag ) ;
	DXFUNC_END
	return Result ;
}

extern int MV1SetLoadModelIgnoreIK( int IgnoreFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1SetLoadModelIgnoreIK( IgnoreFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int MV1SetAttachAnimTimeToFrame(	int MHandle, int AttachIndex, int FrameIndex, float Time, int SetChild )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_MV1SetAttachAnimTimeToFrame( MHandle, AttachIndex, FrameIndex, Time, SetChild ) ;
	DXFUNC_END
	return Result ;
}

extern float MV1GetAttachAnimTimeToFrame( int MHandle, int AttachIndex, int FrameIndex )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_MV1GetAttachAnimTimeToFrame( MHandle, AttachIndex, FrameIndex ) ;
	DXFUNC_END
	return Result ;
}
...
extern int MV1GetFrameVertexNum( int MHandle, int FrameIndex )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1GetFrameVertexNum( MHandle, FrameIndex ) ;
	DXFUNC_END
	return Result ;
}
...
extern int MV1SetupCollInfo( int MHandle, int FrameIndex, int XDivNum, int YDivNum, int ZDivNum, int MeshIndex ) 
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1SetupCollInfo( MHandle, FrameIndex,  XDivNum,  YDivNum,  ZDivNum, MeshIndex )  ;
	DXFUNC_END
	return Result ;
}

extern int MV1TerminateCollInfo( int MHandle, int FrameIndex, int MeshIndex ) 
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1TerminateCollInfo( MHandle, FrameIndex, MeshIndex )  ;
	DXFUNC_END
	return Result ;
}

extern int MV1RefreshCollInfo( int MHandle, int FrameIndex, int MeshIndex ) 
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1RefreshCollInfo( MHandle, FrameIndex, MeshIndex )  ;
	DXFUNC_END
	return Result ;
}

extern MV1_COLL_RESULT_POLY MV1CollCheck_Line( int MHandle, int FrameIndex, VECTOR PosStart, VECTOR PosEnd, int MeshIndex ) 
{
	MV1_COLL_RESULT_POLY Result ;
	DXFUNC_BEGIN
	Result = NS_MV1CollCheck_Line( MHandle, FrameIndex,  PosStart,  PosEnd, MeshIndex )  ;
	DXFUNC_END
	return Result ;
}

extern	MV1_COLL_RESULT_POLY_DIM MV1CollCheck_LineDim( int MHandle, int FrameIndex, VECTOR PosStart, VECTOR PosEnd, int MeshIndex )
{
	MV1_COLL_RESULT_POLY_DIM Result ;
	DXFUNC_BEGIN
	Result = NS_MV1CollCheck_LineDim(  MHandle,  FrameIndex,  PosStart,  PosEnd, MeshIndex ) ;
	DXFUNC_END
	return Result ;
}

extern MV1_COLL_RESULT_POLY_DIM MV1CollCheck_Sphere( int MHandle, int FrameIndex, VECTOR CenterPos, float r, int MeshIndex ) 
{
	MV1_COLL_RESULT_POLY_DIM Result ;
	DXFUNC_BEGIN
	Result = NS_MV1CollCheck_Sphere( MHandle, FrameIndex,  CenterPos, r, MeshIndex )  ;
	DXFUNC_END
	return Result ;
}

extern	MV1_COLL_RESULT_POLY_DIM MV1CollCheck_Capsule( int MHandle, int FrameIndex, VECTOR Pos1, VECTOR Pos2, float r, int MeshIndex )
{
	MV1_COLL_RESULT_POLY_DIM Result ;
	DXFUNC_BEGIN
	Result = NS_MV1CollCheck_Capsule(  MHandle,  FrameIndex,  Pos1,  Pos2,  r, MeshIndex ) ;
	DXFUNC_END
	return Result ;
}

extern	MV1_COLL_RESULT_POLY_DIM MV1CollCheck_Triangle( int MHandle, int FrameIndex, VECTOR Pos1, VECTOR Pos2, VECTOR Pos3, int MeshIndex )
{
	MV1_COLL_RESULT_POLY_DIM Result ;
	DXFUNC_BEGIN
	Result = NS_MV1CollCheck_Triangle( MHandle, FrameIndex, Pos1, Pos2, Pos3, MeshIndex ) ;
	DXFUNC_END
	return Result ;
}
...
extern int MV1SetupReferenceMesh( int MHandle, int FrameIndex, int IsTransform, int IsPositionOnly, int MeshIndex ) 
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1SetupReferenceMesh( MHandle, FrameIndex,  IsTransform, IsPositionOnly, MeshIndex )  ;
	DXFUNC_END
	return Result ;
}

extern int MV1TerminateReferenceMesh( int MHandle, int FrameIndex, int IsTransform, int IsPositionOnly, int MeshIndex ) 
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1TerminateReferenceMesh( MHandle, FrameIndex,  IsTransform, IsPositionOnly, MeshIndex )  ;
	DXFUNC_END
	return Result ;
}

extern int MV1RefreshReferenceMesh( int MHandle, int FrameIndex, int IsTransform, int IsPositionOnly, int MeshIndex ) 
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1RefreshReferenceMesh( MHandle, FrameIndex,  IsTransform, IsPositionOnly, MeshIndex )  ;
	DXFUNC_END
	return Result ;
}

extern MV1_REF_POLYGONLIST	MV1GetReferenceMesh( int MHandle, int FrameIndex, int IsTransform, int IsPositionOnly, int MeshIndex ) 
{
	MV1_REF_POLYGONLIST Result ;
	DXFUNC_BEGIN
	Result = NS_MV1GetReferenceMesh( MHandle, FrameIndex,  IsTransform, IsPositionOnly, MeshIndex )  ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_SetCubism4CoreDLLPath( const TCHAR *CoreDLLFilePath )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_SetCubism4CoreDLLPath( CoreDLLFilePath )  ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_SetCubism4CoreDLLPathWithStrLen( const TCHAR *CoreDLLFilePath, size_t CoreDLLFilePathLength )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_SetCubism4CoreDLLPathWithStrLen( CoreDLLFilePath, CoreDLLFilePathLength )  ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_SetCubism3CoreDLLPath( const TCHAR *CoreDLLFilePath )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_SetCubism3CoreDLLPath( CoreDLLFilePath )  ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_SetCubism3CoreDLLPathWithStrLen( const TCHAR *CoreDLLFilePath, size_t CoreDLLFilePathLength )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_SetCubism3CoreDLLPathWithStrLen( CoreDLLFilePath, CoreDLLFilePathLength )  ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_RenderBegin( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_RenderBegin()  ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_RenderEnd( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_RenderEnd()  ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_LoadModel( const TCHAR *FilePath )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_LoadModel( FilePath )  ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_LoadModelWithStrLen( const TCHAR *FilePath, size_t FilePathLength )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_LoadModelWithStrLen( FilePath, FilePathLength ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_DeleteModel( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_DeleteModel( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_InitModel( void )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_InitModel() ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_SetUserShader( int TargetShader, int ShaderHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_SetUserShader( TargetShader, ShaderHandle ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_DrawCallback( void ( *Callback )( int Live2DModelHandle, int TextureIndex, void *UserData ), void *UserData )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_DrawCallback( Callback, UserData ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_SetUseAutoScaling( int UseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_SetUseAutoScaling( UseFlag ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_SetUseAutoCentering( int UseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_SetUseAutoCentering( UseFlag ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_SetUseReverseYAxis( int UseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_SetUseReverseYAxis( UseFlag ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_Update( int Live2DModelHandle, float DeltaTime )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_Update( Live2DModelHandle, DeltaTime ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_SetTranslate( int Live2DModelHandle, float x, float y )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_SetTranslate( Live2DModelHandle, x, y ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_SetExtendRate( int Live2DModelHandle, float ExRateX, float ExRateY )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_SetExtendRate( Live2DModelHandle, ExRateX, ExRateY ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_SetRotate( int Live2DModelHandle, float Angle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_SetRotate( Live2DModelHandle, Angle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_Draw( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_Draw( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_GetLastPlayMotionNo( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetLastPlayMotionNo( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_IsMotionFinished( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_IsMotionFinished( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern float Live2D_Model_GetMotionPlayTime( int Live2DModelHandle )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionPlayTime( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_SetExpression( int Live2DModelHandle, const TCHAR *expressionID )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_SetExpression( Live2DModelHandle, expressionID ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_SetExpressionWithStrLen( int Live2DModelHandle, const TCHAR *expressionID, size_t expressionIDLength )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_SetExpressionWithStrLen( Live2DModelHandle, expressionID, expressionIDLength ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_HitTest( int Live2DModelHandle, const TCHAR *hitAreaName, float x, float y )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_HitTest( Live2DModelHandle, hitAreaName, x, y ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_HitTestWithStrLen( int Live2DModelHandle, const TCHAR *hitAreaName, size_t hitAreaNameLength, float x, float y )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_HitTestWithStrLen( Live2DModelHandle, hitAreaName, hitAreaNameLength, x, y ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_GetParameterCount( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetParameterCount( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetParameterId( int Live2DModelHandle, int index )
{
	const TCHAR *Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetParameterId( Live2DModelHandle, index ) ;
	DXFUNC_END
	return Result ;
}

extern float Live2D_Model_GetParameterValue( int Live2DModelHandle, const TCHAR *parameterId )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetParameterValue( Live2DModelHandle, parameterId ) ;
	DXFUNC_END
	return Result ;
}

extern float Live2D_Model_GetParameterValueWithStrLen( int Live2DModelHandle, const TCHAR *parameterId, size_t parameterIdLength )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetParameterValueWithStrLen( Live2DModelHandle, parameterId, parameterIdLength ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_SetParameterValue( int Live2DModelHandle, const TCHAR *parameterId, float value )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_SetParameterValue( Live2DModelHandle, parameterId, value ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_SetParameterValueWithStrLen( int Live2DModelHandle, const TCHAR *parameterId, size_t parameterIdLength, float value )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_SetParameterValueWithStrLen( Live2DModelHandle, parameterId, parameterIdLength, value ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_GetHitAreasCount( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetHitAreasCount( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetHitAreaName( int Live2DModelHandle, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetHitAreaName( Live2DModelHandle, index ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetPhysicsFileName( int Live2DModelHandle )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetPhysicsFileName( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetPoseFileName( int Live2DModelHandle )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetPoseFileName( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_GetExpressionCount( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetExpressionCount( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetExpressionName( int Live2DModelHandle, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetExpressionName( Live2DModelHandle, index ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetExpressionFileName( int Live2DModelHandle, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetExpressionFileName( Live2DModelHandle, index ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_GetMotionGroupCount( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionGroupCount( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetMotionGroupName( int Live2DModelHandle, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionGroupName( Live2DModelHandle, index ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_GetMotionCount( int Live2DModelHandle, const TCHAR* groupName )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionCount( Live2DModelHandle, groupName ) ;
	DXFUNC_END
	return Result ;
}

extern int Live2D_Model_GetMotionCountWithStrLen( int Live2DModelHandle, const TCHAR* groupName, size_t groupNameLength )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionCountWithStrLen( Live2DModelHandle, groupName, groupNameLength ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetMotionFileName( int Live2DModelHandle, const TCHAR* groupName, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionFileName( Live2DModelHandle, groupName, index ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetMotionFileNameWithStrLen( int Live2DModelHandle, const TCHAR* groupName, size_t groupNameLength, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionFileNameWithStrLen( Live2DModelHandle, groupName, groupNameLength, index ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetMotionSoundFileName( int Live2DModelHandle, const TCHAR* groupName, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionSoundFileName( Live2DModelHandle, groupName, index ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetMotionSoundFileNameWithStrLen( int Live2DModelHandle, const TCHAR* groupName, size_t groupNameLength, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionSoundFileNameWithStrLen( Live2DModelHandle, groupName, groupNameLength, index ) ;
	DXFUNC_END
	return Result ;
}

extern float Live2D_Model_GetMotionFadeInTimeValue( int Live2DModelHandle, const TCHAR* groupName, int index )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionFadeInTimeValue( Live2DModelHandle, groupName, index ) ;
	DXFUNC_END
	return Result ;
}

extern float Live2D_Model_GetMotionFadeInTimeValueWithStrLen( int Live2DModelHandle, const TCHAR* groupName, size_t groupNameLength, int index )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionFadeInTimeValueWithStrLen( Live2DModelHandle, groupName, groupNameLength, index ) ;
	DXFUNC_END
	return Result ;
}

extern float Live2D_Model_GetMotionFadeOutTimeValue( int Live2DModelHandle, const TCHAR* groupName, int index )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionFadeOutTimeValue( Live2DModelHandle, groupName, index ) ;
	DXFUNC_END
	return Result ;
}

extern float Live2D_Model_GetMotionFadeOutTimeValueWithStrLen( int Live2DModelHandle, const TCHAR* groupName, size_t groupNameLength, int index )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetMotionFadeOutTimeValueWithStrLen( Live2DModelHandle, groupName, groupNameLength, index ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetUserDataFile( int Live2DModelHandle )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetUserDataFile( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_GetEyeBlinkParameterCount( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetEyeBlinkParameterCount( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetEyeBlinkParameterId( int Live2DModelHandle, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetEyeBlinkParameterId( Live2DModelHandle, index ) ;
	DXFUNC_END
	return Result ;
}
...
extern int Live2D_Model_GetLipSyncParameterCount( int Live2DModelHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetLipSyncParameterCount( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern const TCHAR *Live2D_Model_GetLipSyncParameterId( int Live2DModelHandle, int index )
{
	const TCHAR* Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetLipSyncParameterId( Live2DModelHandle, index ) ;
	DXFUNC_END
	return Result ;
}

extern float Live2D_Model_GetCanvasWidth( int Live2DModelHandle )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetCanvasWidth( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}

extern float Live2D_Model_GetCanvasHeight( int Live2DModelHandle )
{
	float Result ;
	DXFUNC_BEGIN
	Result = NS_Live2D_Model_GetCanvasHeight( Live2DModelHandle ) ;
	DXFUNC_END
	return Result ;
}
