...
#define DX_FISDXA( handle )							StreamIsDXA( (DWORD_PTR)(handle) )
...
extern	DWORD_PTR	StreamOpenW( const char    *PathW, int UseCacheFlag, int BlockFlag, int UseASyncReadFlag ) ; // Visual C++ 6.0 用に引数を char 型にしただけのもの
