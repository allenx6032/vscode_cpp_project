...
extern	void		AddASyncLoadParamSize_t( BYTE *Data, int *Addr, size_t Param ) ;				// 非同期読み込みデータのパラメータに size_t 型のパラメータを追加
...
extern	size_t		GetASyncLoadParamSize_t( BYTE *Data, int *Addr ) ;								// 非同期読み込みデータのパラメータから size_t 型のパラメータを取得
