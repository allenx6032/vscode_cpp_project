...
extern VECTOR	Get_Line_Point_MinPosition(  VECTOR   Point, VECTOR   LinePos1, VECTOR   LinePos2, float *pT = NULL ) ;								// 点に一番近い線上の座標を得る
extern VECTOR_D	Get_Line_Point_MinPositionD( VECTOR_D Point, VECTOR_D LinePos1, VECTOR_D LinePos2, double *pT = NULL ) ;							// 点に一番近い線上の座標を得る
