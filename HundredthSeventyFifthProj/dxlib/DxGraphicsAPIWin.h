// -------------------------------------------------------------------------------
// 
// 		ÇcÇwÉâÉCÉuÉâÉä		ï`âÊÇ`ÇoÇhÉvÉçÉOÉâÉÄÉwÉbÉ_ÉtÉ@ÉCÉã
// 
// 				Ver 3.24b
// 
// -------------------------------------------------------------------------------

#ifndef DX_GRAPHICSAPIWIN_H
#define DX_GRAPHICSAPIWIN_H
...
{
	D_IDirectDraw7			*DirectDraw7Object ;					// ÇcÇâÇíÇÖÇÉÇîÇcÇíÇÅÇóÉCÉìÉ^Å[ÉtÉFÉCÉX
	LONGLONG				DirectDraw7_VSyncWaitTime ;				// ëOâÒÇuÇrÇxÇmÇbë“ÇøÇÇµÇƒÇ©ÇÁéüÇ…É`ÉFÉbÉNÇ∑ÇÈÇ‹Ç≈Ç…ë“Ç¬éûä‘
	ULONGLONG				DirectDraw7_VSyncTime ;					// ëOâÒÇuÇrÇxÇmÇbë“ÇøÇÇµÇΩéûä‘

#ifndef DX_NON_DIRECT3D9
	HINSTANCE				Direct3D9DLL ;							// ÇcÇâÇíÇÖÇÉÇîÇRÇcÇXÅDÇcÇkÇk
	D_IDirect3D9			*Direct3D9Object ;						// ÇcÇâÇíÇÖÇÉÇîÇRÇcÇXÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDirect3D9Ex			*Direct3D9ExObject ;					// ÇcÇâÇíÇÖÇÉÇîÇRÇcÇXÇdÇòÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDirect3DDevice9		*Direct3DDevice9Object ;				// ÇcÇâÇíÇÖÇÉÇîÇRÇcÇcÇÖÇñÇâÇÉÇÖÇXÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDirect3DDevice9Ex	*Direct3DDevice9ExObject ;				// ÇcÇâÇíÇÖÇÉÇîÇRÇcÇcÇÖÇñÇâÇÉÇÖÇXÇdÇòÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDirect3DSwapChain9	*Direct3DSwapChain9Object ;				// ÇcÇâÇíÇÖÇÉÇîÇRÇcÇrÇóÇÅÇêÇbÇàÇÅÇâÇéÇXÉCÉìÉ^Å[ÉtÉFÉCÉX
#endif // DX_NON_DIRECT3D9

#ifndef DX_NON_DIRECT3D11
	HINSTANCE				Direct3D11DLL ;							// ÇcÇâÇíÇÖÇÉÇîÇRÇcÇPÇPÅDÇcÇkÇk
	HINSTANCE				DXGIDLL ;								// ÇÑÇòÇáÇâÅDÇÑÇåÇå
	D_IDXGIDevice1			*DXGIDevice1Object ;					// ÇcÇwÇfÇhÇcÇÖÇñÇâÇÉÇÖÇPÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDXGIAdapter			*DXGIAdapterObject ;					// ÇcÇwÇfÇhÇ`ÇÑÇÅÇêÇîÇÖÇíÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDXGIAdapter1			*DXGIAdapter1Object ;					// ÇcÇwÇfÇhÇ`ÇÑÇÅÇêÇîÇÖÇíÇPÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDXGIAdapter2			*DXGIAdapter2Object ;					// ÇcÇwÇfÇhÇ`ÇÑÇÅÇêÇîÇÖÇíÇQÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDXGIAdapter3			*DXGIAdapter3Object ;					// ÇcÇwÇfÇhÇ`ÇÑÇÅÇêÇîÇÖÇíÇRÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDXGIAdapter4			*DXGIAdapter4Object ;					// ÇcÇwÇfÇhÇ`ÇÑÇÅÇêÇîÇÖÇíÇSÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDXGIFactory			*DXGIFactoryObject ;					// ÇcÇwÇfÇhÇeÇÅÇÉÇîÇèÇíÇôÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDXGIFactory1			*DXGIFactory1Object ;					// ÇcÇwÇfÇhÇeÇÅÇÉÇîÇèÇíÇôÇPÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDXGIFactory2			*DXGIFactory2Object ;					// ÇcÇwÇfÇhÇeÇÅÇÉÇîÇèÇíÇôÇQÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_IDXGIFactory6			*DXGIFactory6Object ;					// ÇcÇwÇfÇhÇeÇÅÇÉÇîÇèÇíÇôÇUÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_ID3D11Device			*D3D11DeviceObject ;					// ÇcÇRÇcÇPÇPÇcÇÖÇñÇâÇÉÇÖÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_ID3D11DeviceContext	*D3D11DeviceContext ;					// ÇcÇRÇcÇPÇPÇcÇÖÇñÇâÇÉÇÖÇbÇèÇéÇîÇÖÇòÇîÉCÉìÉ^Å[ÉtÉFÉCÉX
	D_ID3D11DeviceContext	*D3D11DeferredContext ;					// ÇcÇRÇcÇPÇPÇcÇÖÇñÇâÇÉÇÖÇbÇèÇéÇîÇÖÇòÇîÉCÉìÉ^Å[ÉtÉFÉCÉX( DeferredContext )
	int						D3D11BufferNum ;
...
extern	ULONG	Direct3D11_Release_GeometryShader_ASync			( D_ID3D11GeometryShader *pGeometryShader, int ASyncThread = FALSE ) ;
...
extern	HRESULT	D3D11Device_CreateGeometryShader_ASync			( const void *pShaderBytecode, SIZE_T BytecodeLength, D_ID3D11ClassLinkage *pClassLinkage, D_ID3D11GeometryShader **ppGeometryShader, int ASyncThread = FALSE ) ;
...
extern	int		DXGI_LoadDLL							( int OutputLog = TRUE ) ;
extern	int		DXGI_FreeDLL							( int OutputLog = TRUE ) ;

extern	int		Direct3D11_LoadDLL						( void ) ;
extern	int		Direct3D11_FreeDLL						( void ) ;

extern	int		DXGIFactory_Create						( int OutputLog = TRUE ) ;
...
extern	int		D3D11Device_CheckMultiSampleParam		( D_DXGI_FORMAT Format, UINT *Samples, UINT *Quality, int SamplesFailedBreak ) ;	// É}ÉãÉ`ÉTÉìÉvÉãÉåÉìÉ_ÉäÉìÉOÇÃÉTÉìÉvÉãêîÇ∆ÉNÉIÉäÉeÉBÇÉ`ÉFÉbÉN
...
extern	int		Direct3D9_CheckMultiSampleParam_ASync				( D_D3DFORMAT Format, D_D3DMULTISAMPLE_TYPE *Samples, DWORD *Quality, int SamplesFailedBreak, int ASyncThread = FALSE ) ;	// É}ÉãÉ`ÉTÉìÉvÉãÉåÉìÉ_ÉäÉìÉOÇÃÉTÉìÉvÉãêîÇ∆ÉNÉIÉäÉeÉBÇÉ`ÉFÉbÉN
...
extern	int		Direct3DDevice9_CreateVertexBuffer_ASync			( DWORD Length, DWORD Usage, DWORD FVFFlag, D_D3DPOOL Pool, D_IDirect3DVertexBuffer9 **BufferP, int ASyncThread = FALSE ) ;		// í∏ì_ÉoÉbÉtÉ@ÇçÏê¨Ç∑ÇÈ
extern	int		Direct3DDevice9_CreateIndexBuffer_ASync				( DWORD Length, DWORD Usage, D_D3DFORMAT Format, D_D3DPOOL Pool, D_IDirect3DIndexBuffer9 **BufferP, int ASyncThread = FALSE ) ;	// ÉCÉìÉfÉbÉNÉXÉoÉbÉtÉ@ÇçÏê¨Ç∑ÇÈ
...
extern	int		Direct3D9_CheckMultiSampleParam			( D_D3DFORMAT Format, D_D3DMULTISAMPLE_TYPE *Samples, DWORD *Quality, int SamplesFailedBreak ) ;	// É}ÉãÉ`ÉTÉìÉvÉãÉåÉìÉ_ÉäÉìÉOÇÃÉTÉìÉvÉãêîÇ∆ÉNÉIÉäÉeÉBÇÉ`ÉFÉbÉN
