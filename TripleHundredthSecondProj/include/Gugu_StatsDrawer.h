...
#include <SFML_Sprite.hpp>   //TODO: use pointers + forward declaration
#include <SFML_Text.hpp>   //TODO: use pointers + forward declaration
#include <SFML_VertexArray.hpp>   //TODO: use pointers + forward declaration
