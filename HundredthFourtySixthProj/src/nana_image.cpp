...
#include <nana_image_impl_interface.hpp>
#include <nana_pixel_buffer.hpp>
#include <nana_filesystem_ext.hpp>

#if defined(NANA_ENABLE_JPEG)
#include "nana_image_jpeg.hpp"
#endif

#if defined(NANA_ENABLE_PNG)
	#include "nana_image_png.hpp"
#endif

#include "nana_image_bmp.hpp"

#include "nana_image_accessor.hpp"
#include "nana_image_ico_resource.hpp"
