...
#include "raylib_utils.h"              // Required for: TRACELOG()
#include "raylib_lgl.h"               // OpenGL abstraction layer to multiple versions
...
#include "raylib_stb_image_resize.h"     // Required for: stbir_resize_uint8_linear() [ImageResize()]
