...
// Headers
////////////////////////////////////////////////////////////
#include <SFML_WindowImpl.hpp> // included first to avoid a warning about macro redefinition
#include <SFML_OpenGL.hpp> // included second to avoid an error in WglExtensions.hpp
