...
#include <wolfssl_cpuid.h>
#ifdef HAVE_ENTROPY_MEMUSE
#include <wolfssl_sha3.h>
...
#include <wolfssl_sha256.h>
    ...
    #include "port/xilinx/xil-versal-trng.h"
...
#include <port/silabs/silabs_random.h>
#endif
...
int wc_GenerateSeed(OS_Seed* os, byte* output, word32 sz)
{
    ...
    #include "libsimulator_App_error.h"
