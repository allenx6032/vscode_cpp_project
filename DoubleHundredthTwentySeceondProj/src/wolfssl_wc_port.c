...
#include <wolfssl_error-crypt.h>
#include <wolfssl_logging.h>
#include <wolfssl_wc_port.h>
#ifdef HAVE_ECC
    ...
    #include <port/maxim/max3266x.h>
#ifdef WOLF_CRYPTO_CB
    #include <port/maxim/max3266x-cryptocb.h>
#endif
#endif

#ifdef WOLFSSL_PSOC6_CRYPTO
    #include <port/cypress/psoc6_crypto.h>
#endif

#ifdef MAXQ10XX_MODULE_INIT
    #include <port/maxim/maxq10xx.h>
#endif

#if defined(WOLFSSL_ATMEL) || defined(WOLFSSL_ATECC508A) || \
    defined(WOLFSSL_ATECC608A)
    #include <port/atmel/atmel.h>
#endif
#if defined(WOLFSSL_RENESAS_TSIP)
    #include <port/Renesas/renesas-tsip-crypt.h>
#endif
#if defined(WOLFSSL_RENESAS_FSPSM)
    #include <port/Renesas/renesas-fspsm-crypt.h>
#endif
#if defined(WOLFSSL_RENESAS_RX64_HASH)
    #include <port/Renesas/renesas-rx64-hw-crypt.h>
#endif
#if defined(WOLFSSL_STSAFEA100)
    #include <port/st/stsafe.h>
#endif
...
#include <memory.h>
    ...
    #include <wolfssl_mem_track.h>
#endif

#if defined(WOLFSSL_CAAM)
    #include <port/caam/wolfcaam.h>
#endif
#if defined(HAVE_ARIA)
    #include <port/aria/aria-cryptocb.h>
#endif
#if defined(WOLFSSL_DEVCRYPTO)
    #include <port/devcrypto/wc_devcrypto.h>
#endif
#ifdef WOLFSSL_IMXRT_DCP
    #include <port/nxp/dcp_port.h>
#endif

#ifdef WOLF_CRYPTO_CB
    #include <wolfssl_cryptocb.h>
#endif

#ifdef HAVE_INTEL_QA_SYNC
    #include <port/intel/quickassist_sync.h>
#endif

#ifdef HAVE_CAVIUM_OCTEON_SYNC
    #include <port/cavium/cavium_octeon_sync.h>
#endif

#if defined(WOLFSSL_SE050) && defined(WOLFSSL_SE050_INIT)
#include <port/nxp/se050_port.h>
#endif
    ...
    #include <port/psa/psa.h>
#endif

#if defined(HAVE_LIBOQS)
    #include <port/liboqs/liboqs.h>
#endif
