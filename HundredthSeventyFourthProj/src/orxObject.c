...
#include "orxMemory.h"
#include "orxFrame.h"
#include "orxFXPointer.h"
#include "orxSpawner.h"
#include "orxTimeLine.h"
#include "orxTrigger.h"
#include "orxBody.h"
#include "orxCamera.h"
#include "orxShaderPointer.h"
#include "orxSoundPointer.h"
...
orxSTATUS orxFASTCALL orxObject_SetLifeTime(orxOBJECT *_pstObject, orxFLOAT _fLifeTime)
{
  ...
  {
    /* Updates status */
    orxStructure_SetFlags(_pstObject, orxOBJECT_KU32_FLAG_NONE, orxOBJECT_KU32_FLAG_HAS_LIFETIME | orxOBJECT_KU32_FLAG_DEATH_ROW | orxOBJECT_KU32_MASK_STRUCTURE_LIFETIME);
  }
