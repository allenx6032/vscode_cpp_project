...
#include "ahk_globaldata.h" // for a lot of things
#include "ahk_util.h" // for strlcpy() etc.
#include "ahk_mt19937ar-cok.h" // for random number generator
#include "ahk_window.h" // for a lot of things
...
#undef BIF_OBJ_CASE
	...
	else if (!_tcsicmp(func_name, _T("InputHook")))
	{
		bif = BIF_InputHook;
		min_params = 0;
		max_params = 3;
