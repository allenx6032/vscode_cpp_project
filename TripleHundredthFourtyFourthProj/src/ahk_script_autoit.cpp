...
#include "ahk_globaldata.h" // for g_ErrorLevel and probably other globals.
#include "ahk_window.h" // For ControlExist().
#include "ahk_application.h" // For SLEEP_WITHOUT_INTERRUPTION and MsgSleep().
