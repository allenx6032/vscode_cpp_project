...
#include "ahk_application.h"
#include "ahk_globaldata.h" // for access to g_clip, the "g" global struct, etc.
#include "ahk_window.h" // for several MsgBox and window functions
#include "ahk_util.h" // for strlcpy()
#include "ahk_resources/resource.h"  // For ID_TRAY_OPEN.
