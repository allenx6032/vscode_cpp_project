...
#include "ahk_qmath.h" // Used by Transform() [math.h incurs 2k larger code size just for ceil() & floor()]
#include "ahk_mt19937ar-cok.h" // for sorting in random order
#include "ahk_script.h"
#include "ahk_window.h" // for IF_USE_FOREGROUND_WINDOW
#include "ahk_application.h" // for MsgSleep()
#include "ahk_resources/resource.h"  // For InputBox.
