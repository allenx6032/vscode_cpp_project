...
#include "ahk_hook.h" // For KeyHistoryItem and probably other things.
#include "ahk_clipboard.h"  // For the global clipboard object
#include "ahk_script.h" // For the global script object and g_ErrorLevel
