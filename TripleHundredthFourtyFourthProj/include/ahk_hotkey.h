...
#include "ahk_keyboard_mouse.h"
#include "ahk_script.h"  // For which label (and in turn which line) in the script to jump to.
...
public:
	...
	//#define HOTKEY_EL_WIN9X              _T("50") // Reserved; no longer used.
