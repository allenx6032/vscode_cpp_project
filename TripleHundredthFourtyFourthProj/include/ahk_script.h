...
#include "ahk_defines.h"
#include "ahk_SimpleHeap.h" // for overloaded new/delete operators.
#include "ahk_keyboard_mouse.h" // for modLR_type
#include "ahk_var.h" // for a script's variables.
#include "ahk_WinGroup.h" // for a script's Window Groups.
#include "ahk_Util.h" // for FileTimeToYYYYMMDD(), strlcpy()
#include "resource.h"  // For tray icon.
#include "ahk_script_object.h"
#include "ahk_Debugger.h"
#include <mmeapi.h>
#include "ahk_os_version.h" // For the global OS_Version object
