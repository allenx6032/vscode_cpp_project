...
#include "wget_init.h"
#include "wget_host.h"
#include "wget_netrc.h"
#include "wget_progress.h"
#include "wget_recur.h"              /* for INFINITE_RECURSION */
#include "wget_convert.h"            /* for convert_cleanup */
#include "wget_res.h"                /* for res_cleanup */
#include "wget_http.h"               /* for http_cleanup */
#include "wget_retr.h"               /* for output_stream */
