...
#include "quick_cocos2dx_extra_luabinding.h"
...
#include "quick_CCCrypto.h"
#include "quick_CCNative.h"
#include "quick_CCNetwork.h"
using namespace std;
using namespace cocos2d;
...
TOLUA_API int tolua_cocos2dx_extra_luabinding_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,"cc");
  ...
  tolua_constant(tolua_S,"kCCHTTPRequestMethodDELETE",kCCHTTPRequestMethodDELETE);
