#include "cocos_dragonBonesCCSlot.h"
#include "cocos_dragonBonesCCTextureAtlasData.h"
    ...
    if (_displayIndex >= 0 && _display != nullptr && currentTextureData != nullptr)
    {
        if (currentTextureData->spriteFrame != nullptr)
        {
            if (currentVerticesData != nullptr) // Mesh.
            {
                ...
                auto triangles = new cocos2d::TrianglesCommand::Triangles;
                ...
                frameDisplay->setTriangles(triangles);
            ...
            {
                frameDisplay->setTriangles(nullptr); // clean status
...
void CCSlot::_updateMesh() 
{
    ...
    const auto vertices = meshDisplay->getTriangles()->verts;
    cocos2d::Rect boundsRect(999999.0f, 999999.0f, -999999.0f, -999999.0f);
