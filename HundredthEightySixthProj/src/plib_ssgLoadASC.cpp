...
#include "plib_ssgLoaderWriterStuff.h" 
#include "plib_ssgParser.h"
...
// if exists, gets the index. Else sets sName and creates the ss
{
  ...
  for(int i=0; i<noOfAscmaterials; i++)
    if(ulStrEqual(s, AscMaterials[i].sName))
      return i;
  // **** not found - create it ****
