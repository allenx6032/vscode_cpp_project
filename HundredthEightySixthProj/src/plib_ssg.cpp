/*
     ...
     $Id: ssg.cxx 2125 2007-09-29 17:20:40Z fayjf $
*/
...
static bool ssgSearchExtensionString(char *extString, char *extName)
{
...
bool ssgIsExtensionSupported(char *extName)
{
  ...
  return ssgSearchExtensionString ( (char *)glGetString(GL_EXTENSIONS), extName );
}
