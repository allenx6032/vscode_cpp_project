/*
     ...
     $Id: puAuxBiSlider.cxx 2022 2005-05-06 18:39:18Z fayjf $
*/


#include "plib_puAuxLocal.h"

UL_RTTI_DEF1(puaBiSlider,puSlider)


void puaBiSlider::draw ( int dx, int dy )
{
...
void puaBiSlider::doHit ( int button, int updown, int x, int y )
{
