/*
     ...
     $Id: puAuxTriSlider.cxx 2022 2005-05-06 18:39:18Z fayjf $
*/


#include "plib_puAuxLocal.h"

UL_RTTI_DEF1(puaTriSlider,puaBiSlider)


void puaTriSlider::draw ( int dx, int dy )
{
...
void puaTriSlider::doHit ( int button, int updown, int x, int y )
{
