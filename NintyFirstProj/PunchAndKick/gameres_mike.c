...
static const ActionInfo action_set[MAX_ACTION_NUM]={
	...
	{ ACTION_WALK, TRUE, {
		...
		{ TRUE, FALSE, FALSE, "walk-02", 5, 0, 2,
			{-16, -GLOBAL_Y_WIDTH/2, 0, 32, GLOBAL_Y_WIDTH, 64},
			{0,0,0,0,0,0} 
		},
		{ TRUE, FALSE, FALSE, "stance", 5, 0, 0,
	...
	{ ACTION_A_ATTACK, FALSE, {
		{ TRUE, TRUE, FALSE, "A-attack-01", 2, -11, 0,
			{-4, -GLOBAL_Y_WIDTH/2, 0, 34, GLOBAL_Y_WIDTH, 62},
			{0,0,0,0,0,0} 
		},
		{ TRUE, FALSE, FALSE, "A-attack-02", 5, -19, 0,
			{0, -GLOBAL_Y_WIDTH/2, 0, 34, GLOBAL_Y_WIDTH, 62},
			{17, -GLOBAL_Y_WIDTH/2, 28, 32, GLOBAL_Y_WIDTH, 20} 
		},
		{ TRUE, TRUE, FALSE, "A-attack-01", 2, -11, 0,
			{-4, -GLOBAL_Y_WIDTH/2, 0, 34, GLOBAL_Y_WIDTH, 62},
			{0,0,0,0,0,0} 
	...
	{ ACTION_MACH_A_ATTACK, FALSE, {
		...
		{ TRUE, FALSE, FALSE, "A-attack-02", 3, -19, 0,
			{0, -GLOBAL_Y_WIDTH/2, 0, 34, GLOBAL_Y_WIDTH, 62},
			{17, -GLOBAL_Y_WIDTH/2, 28, 32, GLOBAL_Y_WIDTH, 20} 
		},
		{ TRUE, TRUE, FALSE, "A-attack-01", 2, -11, 0,
	...
	{ ACTION_B_ATTACK, FALSE, {
		{ TRUE, FALSE, FALSE, "B-attack-01", 2, 0, 0, 
			{-16, -GLOBAL_Y_WIDTH/2, 0, 38, GLOBAL_Y_WIDTH, 62},
			{0,0,0,0,0,0} 
		},
		{ TRUE, TRUE, FALSE, "B-attack-02", 5, -5, 0, 
			{-20, -GLOBAL_Y_WIDTH/2, 0, 38, GLOBAL_Y_WIDTH, 62},
			{7, -GLOBAL_Y_WIDTH/2, 12, 30, GLOBAL_Y_WIDTH, 38}
		},
		{ TRUE, FALSE, FALSE, "B-attack-01", 2, 0, 0, 
			{-16, -GLOBAL_Y_WIDTH/2, 0, 38, GLOBAL_Y_WIDTH, 62},
			{0,0,0,0,0,0} 
	...
	{ ACTION_MACH_B_ATTACK, FALSE, {
		...
		{ TRUE, TRUE, FALSE, "B-attack-02", 3, -5, 0, 
			{-20, -GLOBAL_Y_WIDTH/2, 0, 38, GLOBAL_Y_WIDTH, 62},
			{7, -GLOBAL_Y_WIDTH/2, 12, 30, GLOBAL_Y_WIDTH, 38}
		},
		{ TRUE, FALSE, FALSE, "B-attack-01", 2, 0, 0, 
	...
	{ ACTION_FINAL_BLOW, FALSE, {
		...
		{ TRUE, TRUE, FALSE, "final-blow-01", 3, 0, 5,
			{-4, -GLOBAL_Y_WIDTH/2, 0, 36, GLOBAL_Y_WIDTH, 60},
			{0, -GLOBAL_Y_WIDTH/2, 0, 26, GLOBAL_Y_WIDTH, 50},
		},
		{ TRUE, FALSE, FALSE, "final-blow-02", 3, -2, 5+10,
			{-4, -GLOBAL_Y_WIDTH/2, 0, 36, GLOBAL_Y_WIDTH, 60},
			{-12, -GLOBAL_Y_WIDTH/2, 0, 24, GLOBAL_Y_WIDTH, 34},
		},
		{ TRUE, FALSE, FALSE, "final-blow-03", 3, 0, 5+4,
			{-4, -GLOBAL_Y_WIDTH/2, 0, 36, GLOBAL_Y_WIDTH, 60},
			{0, 0, 0, 0, 0, 0},
		},
		{ TRUE, FALSE, FALSE, "final-blow-04", 3, -5, 5+7,
			{-4, -GLOBAL_Y_WIDTH/2, 0, 36, GLOBAL_Y_WIDTH, 60},
			{0, -GLOBAL_Y_WIDTH/2, 0, 30, GLOBAL_Y_WIDTH, 34},
		},
		{ TRUE, FALSE, FALSE, "final-blow-05", 3, -2, 5+7,
			{-4, -GLOBAL_Y_WIDTH/2, 0, 36, GLOBAL_Y_WIDTH, 60},
			{-20, -GLOBAL_Y_WIDTH/2, 0, 44, GLOBAL_Y_WIDTH, 28},
		},
		{ TRUE, FALSE, TRUE, "ready", 5, -6, 0,
			{-16, -GLOBAL_Y_WIDTH/2, 0, 32, GLOBAL_Y_WIDTH, 62},
			{0,0,0,0,0,0} 
		},
		END_ACTION_FRAME
	...
	{ ACTION_CATCH_SKILL_FA, FALSE, {
		{ TRUE, FALSE, FALSE, "hug-jump-01", 2, 0, 0,
			{-16, -GLOBAL_Y_WIDTH/2, 0, 32, GLOBAL_Y_WIDTH, 58},
			{0,0,0,0,0,0} 
		},
		{ TRUE, FALSE, FALSE, "hug-jump-02", 2, 0, 0,
			{-16, -GLOBAL_Y_WIDTH/2, 0, 32, GLOBAL_Y_WIDTH, 56},
			{0,0,0,0,0,0} 
		},
		...
		{ TRUE, FALSE, FALSE, "hug-jump-04", 10, 0, 0,
			{-16, -GLOBAL_Y_WIDTH/2, 0, 30, GLOBAL_Y_WIDTH, 48},
			{0,0,0,0,0,0} 
		},
		END_ACTION_FRAME
	}},
