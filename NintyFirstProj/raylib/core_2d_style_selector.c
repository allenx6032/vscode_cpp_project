...
#include "rstyle_jungle.h"            // raygui style: jungle
#include "rstyle_candy.h"             // raygui style: candy
#include "rstyle_lavanda.h"           // raygui style: lavanda
#include "rstyle_cyber.h"             // raygui style: cyber
#include "rstyle_terminal.h"          // raygui style: terminal
#include "rstyle_ashes.h"             // raygui style: ashes
#include "rstyle_bluish.h"            // raygui style: bluish
#include "rstyle_dark.h"              // raygui style: dark
#include "rstyle_cherry.h"            // raygui style: cherry
#include "rstyle_sunny.h"             // raygui style: sunny
#include "rstyle_enefete.h"           // raygui style: enefete
