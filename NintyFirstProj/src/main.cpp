...
void c2_toi_kyavi_already_intersecting()
{
	float x = 149.0f;
	float y = 230.0f;
	c2AABB c2_a = { c2V(149.0f-x, 230.0f-y), c2V(181.0f-x, 262.0f-y) };
	c2AABB c2_b = { c2V(144.0f-x, 224.0f-y), c2V(176.0f-x, 256.0f-y) };
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		case 24: try_out_and_render_dual(); break;
