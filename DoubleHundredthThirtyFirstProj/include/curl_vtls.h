...
#include "curl_openssl.h"        /* OpenSSL versions */
#include "curl_gtls.h"           /* GnuTLS versions */
#include "curl_nssg.h"           /* NSS versions */
#include "curl_gskit.h"          /* Global Secure ToolKit versions */
#include "curl_wolfssl.h"        /* wolfSSL versions */
#include "curl_schannel.h"       /* Schannel SSPI version */
#include "curl_sectransp.h"      /* SecureTransport (Darwin) version */
#include "curl_mbedtls.h"        /* mbedTLS versions */
#include "curl_mesalink.h"       /* MesaLink versions */
#include "curl_bearssl.h"        /* BearSSL versions */
