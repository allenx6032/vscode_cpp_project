...
#include <sp.h>
    ...
    #include <port/kcapi/kcapi_ecc.h>
#endif
...
#ifdef ECC_WOLFSSL_TIMING_RESISTANT
    if (rng == NULL) {
        rng = key->rng;
    }
#endif
...
#ifndef ECC_WOLFSSL_TIMING_RESISTANT
...
#endif /* ECC_WOLFSSL_TIMING_RESISTANT */
#endif
...
int wc_ecc_set_rng(ecc_key* key, WC_RNG* rng)
{
    ...
    (void)key;
    (void)rng;
    /* report success, not an error if ECC_WOLFSSL_TIMING_RESISTANT is not defined */
#endif
