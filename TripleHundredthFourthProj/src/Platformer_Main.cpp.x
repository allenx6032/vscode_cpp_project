...
TextureAtlas player_idle_atlas(".\\Assets\\player_idle.png", 29, 35);
TextureAtlas player_run_atlas(".\\Assets\\player_run.png", 40, 35);
TextureAtlas player_run_atlas_flipped(".\\Assets\\player_run_flipped.png", 40, 35);
...
// The block
Texture block(".\\Assets\\block.png");
...
Background main_background(".\\Assets\\background.png", "main_background");
...
int main()
{
	...
	// Load the scene file
	scene.LoadSceneFile(".\\Assets\\DemoScene.sce");
