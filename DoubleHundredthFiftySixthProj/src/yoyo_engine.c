...
void ye_init_engine() {
    ...
    snprintf(engine_default_path, sizeof(engine_default_path), "%s", executable_path);
    snprintf(game_default_path, sizeof(game_default_path), "%s", executable_path);
    snprintf(log_default_path, sizeof(log_default_path), "%s/debug.log", executable_path);
    ...
    YE_STATE.engine.screen_width            = ye_config_int(SETTINGS, "screen_width", 900);
    YE_STATE.engine.screen_height           = ye_config_int(SETTINGS, "screen_height", 600);
