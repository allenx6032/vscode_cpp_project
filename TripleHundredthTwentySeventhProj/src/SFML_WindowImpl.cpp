...
#include <cmath>
    ...
    #include <SFML_Win32_WindowImplWin32.hpp>
    ...
    #include <SFML_OSX_WindowImplCocoa.hpp>
    typedef sf::priv::WindowImplCocoa WindowImplType;

#elif defined(SFML_SYSTEM_IOS)

    #include <SFML_iOS_WindowImplUIKit.hpp>
    typedef sf::priv::WindowImplUIKit WindowImplType;

#elif defined(SFML_SYSTEM_ANDROID)

    #include <SFML_Android_WindowImplAndroid.hpp>
