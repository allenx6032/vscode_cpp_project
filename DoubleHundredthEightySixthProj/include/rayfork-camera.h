...
enum rf_camera_type {
    RF_CAMERA_PERSPECTIVE = 0,
    RF_CAMERA_ORTHOGRAPHIC = 1
};
typedef enum rf_camera_type rf_camera_type;

// typedef int rf_camera_type
// #define RF_CAMERA_PERSPECTIVE = 0
// #define RF_CAMERA_ORTHOGRAPHIC = 0
