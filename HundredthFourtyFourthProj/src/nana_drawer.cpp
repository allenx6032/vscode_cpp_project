...
#include <nana_drawer.hpp>
#include <nana_dynamic_drawing_object.hpp>
#include <nana_effects_renderer.hpp>

#if defined(NANA_X11)
	#include <nana_x11_platform_spec.hpp>
#endif
...
namespace gui
{
	...
	//class drawer_trigger
		...
		void drawer_trigger::attached(widget_reference, graph_reference){}	//none-const
