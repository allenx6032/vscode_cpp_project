...
#include <nana_text_token_stream.hpp>
#include <nana_platform.hpp>
#include <stdexcept>
#include <sstream>
...
namespace gui
{
	...
	//class label
		...
		label& label::add_format_listener(const nana::functor<void(command::t, const nana::string&)> & f)
		{
		...
		label& label::text_align(align::t th, align_v::t tv)
		{
