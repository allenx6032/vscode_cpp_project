...
#include "raylib_rutils.h"          // Required for: LoadFile*()
#include "raylib_rlgl.h"           // OpenGL abstraction layer to OpenGL 1.1, 2.1, 3.3+ or ES2 -> Only DrawTextPro()
...
#include <ctype.h>          // Required for: toupper(), tolower() [Used in TextToUpper(), TextToLower()]
    ...
    #include "raylib_stb_rect_pack.h"     // Required for: ttf/bdf font rectangles packaging
    ...
    #include "raylib_stb_truetype.h"      // Required for: ttf font data reading
