...
**********************************************************************************************/
    ...
    #endif
    #include "raylib_rutils.h"          // Required for: fopen() Android mapping
#endif
...
#include "raylib_miniaudio.h"         // Audio device initialization and management
...
#include <string.h>                     // Required for: strcmp() [Used in IsFileExtension(), LoadWaveFromMemory(), LoadMusicStreamFromMemory()]
    ...
    #include "raylib_dr_wav.h"        // WAV loading functions
#endif

#if defined(SUPPORT_FILEFORMAT_OGG)
    // TODO: Remap stb_vorbis malloc()/free() calls to RL_MALLOC/RL_FREE
    #include "raylib_stb_vorbis.c.h"    // OGG loading functions
#endif
    ...
    #include "raylib_dr_mp3.h"        // MP3 loading functions
#endif
    ...
    #include "raylib_qoa.h"           // QOA loading and saving functions
    #include "raylib_qoaplay.c.h"       // QOA stream playing helper functions
    ...
    #include "raylib_dr_flac.h"       // FLAC loading functions
#endif
    ...
    #include "raylib_jar_xm.h"        // XM loading functions
    ...
    #include "raylib_jar_mod.h"       // MOD loading functions
#endif
