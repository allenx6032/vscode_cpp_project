...
#include "deccan_core_internal.h"
...
int core_init(deccan_core_desc_t *settings) {
    ...
    if ((core_info.window = SDL_CreateWindow(core_info.settings.title, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,core_info.settings.resolution.x, core_info.settings.resolution.y, window_flags)) == NULL) {
