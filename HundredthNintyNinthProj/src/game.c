...
void game_init() {
    ...
    batch_renderer_set_sprite_sheet(asset_pool_load_texture("./assets/textures/terrain.png"));
    ...
    tile_map_load_from_file(&map, "./assets/textures/tilemap.png");
    ...
    tile_map_load_from_file(&map_water, "./assets/textures/tilemap_water.png");
