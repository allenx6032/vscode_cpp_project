...
#define WIN_MOUSEINPUT_LOG_NUM		(64)				// 保持するマウスのクリック情報
...
#ifndef DX_NON_INPUT
	int						MouseInputNum ;							// マウスの入力情報の数( GetMouseInputLog用 )
	WINMOUSEINPUT			MouseInput[ WIN_MOUSEINPUT_LOG_NUM ] ;	// マウスの入力情報( GetMouseInputLog用 )

	int						MouseInput2Num ;						// マウスの入力情報の数( GetMouseInputLog2用 )
	WINMOUSEINPUT			MouseInput2[ WIN_MOUSEINPUT_LOG_NUM ] ;	// マウスの入力情報( GetMouseInputLog2用 )
#endif // DX_NON_INPUT
