...
extern int GetHostIPbyName( const TCHAR *HostName, IPDATA *IPDataBuf )
{
	int Result ;
	DXFUNC_NET_BEGIN
	Result = NS_GetHostIPbyName( HostName, IPDataBuf ) ;
	DXFUNC_NET_END
	return Result ;
}
extern int GetHostIPbyName_IPv6( const TCHAR *HostName, IPDATA_IPv6 *IPDataBuf )
{
	int Result ;
	DXFUNC_NET_BEGIN
	Result = NS_GetHostIPbyName_IPv6( HostName, IPDataBuf ) ;
	DXFUNC_NET_END
	return Result ;
}
...
extern int DrawIMEInputString( int x, int y, int SelectStringNum )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawIMEInputString( x,  y,  SelectStringNum ) ;
	DXFUNC_END
	return Result ;
}
...
extern int InputStringToCustom( int x, int y, size_t BufLength, TCHAR *StrBuffer, int CancelValidFlag, int SingleCharOnlyFlag, int NumCharOnlyFlag, int DoubleCharOnlyFlag )
{
	int Result ;
	Result = NS_InputStringToCustom( x, y, BufLength, StrBuffer, CancelValidFlag, SingleCharOnlyFlag, NumCharOnlyFlag, DoubleCharOnlyFlag ) ;
	return Result ;
}
...
extern int DrawKeyInputString( int x, int y, int InputHandle )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawKeyInputString( x, y, InputHandle ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawRotaGraph( int x, int y, double ExRate, double Angle, int GrHandle, int TransFlag, int TurnFlag   )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraph( x,  y, ExRate, Angle,  GrHandle,  TransFlag,  TurnFlag   ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphF( float xf, float yf, double ExRate, double Angle, int GrHandle, int TransFlag, int TurnFlag   )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphF( xf,  yf, ExRate, Angle,  GrHandle,  TransFlag,  TurnFlag   ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraph2( int x, int y, int cx, int cy, double ExtRate, double Angle, int GrHandle, int TransFlag, int TurnFlag   )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraph2( x,  y, cx,  cy, ExtRate, Angle,  GrHandle,  TransFlag,  TurnFlag   ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraph2F( float xf, float yf, float cxf, float cyf, double ExtRate, double Angle, int GrHandle, int TransFlag, int TurnFlag   )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraph2F( xf,  yf, cxf,  cyf, ExtRate, Angle,  GrHandle,  TransFlag,  TurnFlag   ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraph3(  int   x,  int   y,  int   cx,  int   cy,  double ExtRateX, double ExtRateY, double Angle, int GrHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraph3(     x,     y,     cx,     cy,   ExtRateX,  ExtRateY,  Angle,  GrHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraph3F( float xf, float yf, float cxf, float cyf, double ExtRateX, double ExtRateY, double Angle, int GrHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraph3F(  xf,  yf,  cxf,  cyf,  ExtRateX,  ExtRateY,  Angle,  GrHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphFast( int x, int y, float ExRate, float Angle, int GrHandle, int TransFlag, int TurnFlag   )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphFast( x,  y, ExRate, Angle,  GrHandle,  TransFlag,  TurnFlag   ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphFastF( float xf, float yf, float ExRate, float Angle, int GrHandle, int TransFlag, int TurnFlag   )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphFastF( xf,  yf, ExRate, Angle,  GrHandle,  TransFlag,  TurnFlag   ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphFast2( int x, int y, int cx, int cy, float ExtRate, float Angle, int GrHandle, int TransFlag, int TurnFlag   )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphFast2( x,  y, cx,  cy, ExtRate, Angle,  GrHandle,  TransFlag,  TurnFlag   ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphFast2F( float xf, float yf, float cxf, float cyf, float ExtRate, float Angle, int GrHandle, int TransFlag, int TurnFlag   )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphFast2F( xf,  yf, cxf,  cyf, ExtRate, Angle,  GrHandle,  TransFlag,  TurnFlag   ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphFast3(  int   x,  int   y,  int   cx,  int   cy,  float ExtRateX, float ExtRateY, float Angle, int GrHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphFast3(     x,     y,     cx,     cy,   ExtRateX,  ExtRateY,  Angle,  GrHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphFast3F( float xf, float yf, float cxf, float cyf, float ExtRateX, float ExtRateY, float Angle, int GrHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphFast3F(  xf,  yf,  cxf,  cyf,  ExtRateX,  ExtRateY,  Angle,  GrHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawRectGraph( int DestX, int DestY, int SrcX, int SrcY, int Width, int Height, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectGraph( DestX,  DestY,  SrcX,  SrcY,  Width,  Height,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawRectRotaGraph( int X, int Y, int SrcX, int SrcY, int Width, int Height, double ExtRate, double Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraph( X,  Y,  SrcX,  SrcY,  Width,  Height, ExtRate, Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRectRotaGraph2( int x, int y, int SrcX, int SrcY, int Width, int Height, int cx, int cy, double ExtRate, double Angle, int GraphHandle, int TransFlag, int TurnFlag ) 
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraph2(  x,  y,  SrcX,  SrcY,  Width,  Height,  cx,  cy,  ExtRate,  Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRectRotaGraph3(  int x,   int y,   int SrcX, int SrcY, int Width, int Height, int cx, int cy, double ExtRateX, double ExtRateY, double Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraph3(   x,    y,    SrcX,  SrcY,  Width,  Height,  cx,  cy,  ExtRateX,  ExtRateY,  Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRectRotaGraphFast( int X, int Y, int SrcX, int SrcY, int Width, int Height, float ExtRate, float Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraphFast( X,  Y,  SrcX,  SrcY,  Width,  Height, ExtRate, Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRectRotaGraphFast2( int x, int y, int SrcX, int SrcY, int Width, int Height, int cx, int cy, float ExtRate, float Angle, int GraphHandle, int TransFlag, int TurnFlag ) 
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraphFast2(  x,  y,  SrcX,  SrcY,  Width,  Height,  cx,  cy,  ExtRate,  Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRectRotaGraphFast3(  int x,   int y,   int SrcX, int SrcY, int Width, int Height, int cx, int cy, float ExtRateX, float ExtRateY, float Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraphFast3(   x,    y,    SrcX,  SrcY,  Width,  Height,  cx,  cy,  ExtRateX,  ExtRateY,  Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawRectGraphF( float DestX, float DestY, int SrcX, int SrcY, int Width, int Height, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectGraphF(  DestX,  DestY,  SrcX,  SrcY,  Width,  Height,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawRectRotaGraphF( float X, float Y, int SrcX, int SrcY, int Width, int Height, double ExtRate, double Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraphF(  X,  Y,  SrcX,  SrcY,  Width,  Height,  ExtRate,  Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRectRotaGraph2F( float x, float y, int SrcX, int SrcY, int Width, int Height, float cxf, float cyf, double ExtRate, double Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraph2F(  x,  y,  SrcX,  SrcY,  Width,  Height,  cxf,  cyf,  ExtRate,  Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRectRotaGraph3F( float x, float y, int SrcX, int SrcY, int Width, int Height, float cxf, float cyf, double ExtRateX, double ExtRateY, double Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int DrawRectRotaGraphFastF( float X, float Y, int SrcX, int SrcY, int Width, int Height, float ExtRate, float Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraphFastF(  X,  Y,  SrcX,  SrcY,  Width,  Height,  ExtRate,  Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRectRotaGraphFast2F( float x, float y, int SrcX, int SrcY, int Width, int Height, float cxf, float cyf, float ExtRate, float Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraphFast2F(  x,  y,  SrcX,  SrcY,  Width,  Height,  cxf,  cyf,  ExtRate,  Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRectRotaGraphFast3F( float x, float y, int SrcX, int SrcY, int Width, int Height, float cxf, float cyf, float ExtRateX, float ExtRateY, float Angle, int GraphHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRectRotaGraphFast3F(  x,  y,  SrcX,  SrcY,  Width,  Height,  cxf,  cyf,  ExtRateX,  ExtRateY,  Angle,  GraphHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawRotaGraphToZBuffer( int x, int y, double ExRate, double Angle, int GrHandle, int WriteZMode /* DX_ZWRITE_MASK 等 */, int TurnFlag  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphToZBuffer( x,  y,  ExRate,  Angle,  GrHandle,  WriteZMode, TurnFlag  );
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraph2ToZBuffer(  int x, int y, int cx, int cy, double ExtRate,                   double Angle, int GrHandle, int WriteZMode /* DX_ZWRITE_MASK 等 */ , int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraph2ToZBuffer(   x,  y,  cx,  cy,  ExtRate,                    Angle,  GrHandle,  WriteZMode /* DX_ZWRITE_MASK 等 */ ,  TurnFlag );
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraph3ToZBuffer(  int x, int y, int cx, int cy, double ExtRateX, double ExtRateY, double Angle, int GrHandle, int WriteZMode /* DX_ZWRITE_MASK 等 */ , int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraph3ToZBuffer(   x,  y,  cx,  cy,  ExtRateX,  ExtRateY,  Angle,  GrHandle,  WriteZMode /* DX_ZWRITE_MASK 等 */ ,  TurnFlag );
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphFastToZBuffer( int x, int y, float ExRate, float Angle, int GrHandle, int WriteZMode /* DX_ZWRITE_MASK 等 */, int TurnFlag  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphFastToZBuffer( x,  y,  ExRate,  Angle,  GrHandle,  WriteZMode, TurnFlag  );
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphFast2ToZBuffer(  int x, int y, int cx, int cy, float ExtRate,                   float Angle, int GrHandle, int WriteZMode /* DX_ZWRITE_MASK 等 */ , int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphFast2ToZBuffer(   x,  y,  cx,  cy,  ExtRate,                    Angle,  GrHandle,  WriteZMode /* DX_ZWRITE_MASK 等 */ ,  TurnFlag );
	DXFUNC_END
	return Result ;
}
extern int DrawRotaGraphFast3ToZBuffer(  int x, int y, int cx, int cy, float ExtRateX, float ExtRateY, float Angle, int GrHandle, int WriteZMode /* DX_ZWRITE_MASK 等 */ , int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraphFast3ToZBuffer(   x,  y,  cx,  cy,  ExtRateX,  ExtRateY,  Angle,  GrHandle,  WriteZMode /* DX_ZWRITE_MASK 等 */ ,  TurnFlag );
	DXFUNC_END
	return Result ;
}
...
extern int DrawRotaGraph3D( float x, float y, float z, double ExRate, double Angle, int GrHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRotaGraph3D(  x,  y,  z,  ExRate,  Angle,  GrHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int DrawRota2Graph3D( float x, float y, float z, float cx, float cy, double ExtRateX, double ExtRateY, double Angle, int GrHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawRota2Graph3D(  x,  y,  z,  cx,  cy,  ExtRateX,  ExtRateY,  Angle,  GrHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int DrawBillboard3D( VECTOR Pos, float cx, float cy, float Size, float Angle, int GrHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawBillboard3D( Pos, cx, cy, Size, Angle,  GrHandle,  TransFlag,  TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int			DrawBillboard3DToShader( VECTOR Pos, float cx, float cy, float Size, float Angle, int GrHandle, int TransFlag, int TurnFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_DrawBillboard3DToShader( Pos, cx, cy, Size, Angle, GrHandle, TransFlag, TurnFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int LoadDivGraphToResource( int ResourceID, int AllNum, int XNum, int YNum, int XSize, int YSize, int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadDivGraphToResource( ResourceID, AllNum, XNum,  YNum,  XSize,  YSize, HandleBuf ) ;
	DXFUNC_END
	return Result ;
}
extern int LoadDivGraphFToResource( int ResourceID, int AllNum, int XNum, int YNum, float XSize, float YSize, int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadDivGraphFToResource( ResourceID, AllNum, XNum,  YNum,  XSize,  YSize, HandleBuf ) ;
	DXFUNC_END
	return Result ;
}
...
extern int LoadDivGraphToResource( const TCHAR *ResourceName, const TCHAR *ResourceType, int AllNum, int XNum, int YNum, int XSize, int YSize, int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadDivGraphToResource( ResourceName, ResourceType, AllNum, XNum,  YNum,  XSize,  YSize, HandleBuf ) ;
	DXFUNC_END
	return Result ;
}
extern int LoadDivGraphFToResource( const TCHAR *ResourceName, const TCHAR *ResourceType, int AllNum, int XNum, int YNum, float XSize, float YSize, int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadDivGraphFToResource( ResourceName, ResourceType, AllNum, XNum,  YNum,  XSize,  YSize, HandleBuf ) ;
	DXFUNC_END
	return Result ;
}
...
extern int SetDrawScreen_ID3D11RenderTargetView( const void *pID3D11RenderTargetView )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_SetDrawScreen_ID3D11RenderTargetView( pID3D11RenderTargetView ) ;
	DXFUNC_END
	return Result ;
}
...
extern int LoadDivGraph( const TCHAR *FileName, int AllNum, int XNum, int YNum, int XSize, int YSize, int *HandleBuf, int NotUse3DFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadDivGraph( FileName, AllNum,  XNum,  YNum,  XSize,  YSize, HandleBuf,  NotUse3DFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int LoadDivGraphF( const TCHAR *FileName, int AllNum, int XNum, int YNum, float XSize, float YSize, int *HandleBuf, int NotUse3DFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadDivGraphF( FileName, AllNum,  XNum,  YNum,  XSize,  YSize, HandleBuf,  NotUse3DFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int LoadDivBmpToGraph( const TCHAR *FileName, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, int TextureFlag, int ReverseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadDivBmpToGraph( FileName, AllNum,  XNum,  YNum,  SizeX,  SizeY,  HandleBuf,  TextureFlag,  ReverseFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int LoadDivBmpToGraphF( const TCHAR *FileName, int AllNum, int XNum, int YNum, float SizeX, float SizeY, int *HandleBuf, int TextureFlag, int ReverseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadDivBmpToGraphF( FileName, AllNum,  XNum,  YNum,  SizeX,  SizeY,  HandleBuf,  TextureFlag,  ReverseFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int LoadReverseDivGraph( const TCHAR *FileName, int AllNum, int XNum, int YNum, int XSize, int YSize, int *HandleBuf, int NotUse3DFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadReverseDivGraph( FileName, AllNum,  XNum,  YNum,  XSize,  YSize, HandleBuf,  NotUse3DFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int LoadReverseDivGraphF( const TCHAR *FileName, int AllNum, int XNum, int YNum, float XSize, float YSize, int *HandleBuf, int NotUse3DFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_LoadReverseDivGraphF( FileName, AllNum,  XNum,  YNum,  XSize,  YSize, HandleBuf,  NotUse3DFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int CreateDivGraphFromMem( const void *RGBFileImage, int RGBFileImageSize, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf,int TextureFlag , int ReverseFlag , const void *AlphaFileImage , int AlphaFileImageSize )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFromMem( RGBFileImage, RGBFileImageSize, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ,  AlphaFileImage , AlphaFileImageSize  ) ;
	DXFUNC_END
	return Result ;
}
extern int CreateDivGraphFFromMem( const void *RGBFileImage, int RGBFileImageSize, int AllNum, int XNum, int YNum, float SizeX, float SizeY, int *HandleBuf,int TextureFlag , int ReverseFlag , const void *AlphaFileImage , int AlphaFileImageSize )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFFromMem( RGBFileImage, RGBFileImageSize, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ,  AlphaFileImage , AlphaFileImageSize  ) ;
	DXFUNC_END
	return Result ;
}
extern int ReCreateDivGraphFromMem( const void *RGBFileImage, int RGBFileImageSize, int AllNum, int XNum, int YNum, int SizeX, int SizeY, const int *HandleBuf,int TextureFlag , int ReverseFlag , const void *AlphaFileImage , int AlphaFileImageSize  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFromMem( RGBFileImage, RGBFileImageSize, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ,  AlphaFileImage , AlphaFileImageSize  ) ;
	DXFUNC_END
	return Result ;
}
extern int ReCreateDivGraphFFromMem( const void *RGBFileImage, int RGBFileImageSize, int AllNum, int XNum, int YNum, float SizeX, float SizeY, const int *HandleBuf,int TextureFlag , int ReverseFlag , const void *AlphaFileImage , int AlphaFileImageSize  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFFromMem( RGBFileImage, RGBFileImageSize, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ,  AlphaFileImage , AlphaFileImageSize  ) ;
	DXFUNC_END
	return Result ;
}
...
extern int CreateDivGraphFromBmp( const BITMAPINFO *RGBBmpInfo, const void *RGBBmpImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf,int TextureFlag , int ReverseFlag , const BITMAPINFO *AlphaBmpInfo , const void *AlphaBmpImage  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFromBmp( RGBBmpInfo, RGBBmpImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag , AlphaBmpInfo ,  AlphaBmpImage  ) ;
	DXFUNC_END
	return Result ;
}
extern int CreateDivGraphFFromBmp( const BITMAPINFO *RGBBmpInfo, const void *RGBBmpImage, int AllNum, int XNum, int YNum, float SizeX, float SizeY, int *HandleBuf,int TextureFlag , int ReverseFlag , const BITMAPINFO *AlphaBmpInfo , const void *AlphaBmpImage  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFFromBmp( RGBBmpInfo, RGBBmpImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag , AlphaBmpInfo ,  AlphaBmpImage  ) ;
	DXFUNC_END
	return Result ;
}
extern int ReCreateDivGraphFromBmp( const BITMAPINFO *RGBBmpInfo, const void *RGBBmpImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, const int *HandleBuf,int TextureFlag , int ReverseFlag , const BITMAPINFO *AlphaBmpInfo , const void *AlphaBmpImage  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFromBmp( RGBBmpInfo, RGBBmpImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag , AlphaBmpInfo ,  AlphaBmpImage  ) ;
	DXFUNC_END
	return Result ;
}
extern int ReCreateDivGraphFFromBmp( const BITMAPINFO *RGBBmpInfo, const void *RGBBmpImage, int AllNum, int XNum, int YNum, float SizeX, float SizeY, const int *HandleBuf,int TextureFlag , int ReverseFlag , const BITMAPINFO *AlphaBmpInfo , const void *AlphaBmpImage  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFFromBmp( RGBBmpInfo, RGBBmpImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag , AlphaBmpInfo ,  AlphaBmpImage  ) ;
	DXFUNC_END
	return Result ;
}
...
extern int CreateDivGraphFromGraphImage( BASEIMAGE *RGBImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf,int TextureFlag , int ReverseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFromGraphImage( RGBImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int CreateDivGraphFFromGraphImage( BASEIMAGE *RGBImage, int AllNum, int XNum, int YNum, float SizeX, float SizeY, int *HandleBuf,int TextureFlag , int ReverseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFFromGraphImage( RGBImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int CreateDivGraphFFromGraphImage( BASEIMAGE *RGBImage, const BASEIMAGE *AlphaBaseImage, int AllNum, int XNum, int YNum, float SizeX, float SizeY, int *HandleBuf,int TextureFlag , int ReverseFlag  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFFromGraphImage( RGBImage, AlphaBaseImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int ReCreateDivGraphFromGraphImage( BASEIMAGE *RGBImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, const int *HandleBuf,int TextureFlag , int ReverseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFromGraphImage( RGBImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ) ;
	DXFUNC_END
	return Result ;
}
extern int ReCreateDivGraphFFromGraphImage( BASEIMAGE *RGBImage, int AllNum, int XNum, int YNum, float SizeX, float SizeY, const int *HandleBuf,int TextureFlag , int ReverseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFFromGraphImage( RGBImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int ReCreateDivGraphFFromGraphImage( BASEIMAGE *RGBImage, const BASEIMAGE *AlphaBaseImage, int AllNum, int XNum, int YNum, float SizeX, float SizeY, const int *HandleBuf,int TextureFlag , int ReverseFlag )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReCreateDivGraphFFromGraphImage( RGBImage, AlphaBaseImage, AllNum, XNum, YNum, SizeX, SizeY, HandleBuf,TextureFlag , ReverseFlag ) ;
	DXFUNC_END
	return Result ;
}
...
extern int CreateDivGraph( int Width, int Height, int Pitch, const void *GraphData, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, const void *AlphaData )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraph(  Width,  Height,  Pitch, GraphData,  AllNum,  XNum,  YNum,  SizeX,  SizeY, HandleBuf, AlphaData ) ;
	DXFUNC_END
	return Result ;
}
extern int CreateDivGraphF( int Width, int Height, int Pitch, const void *GraphData, int AllNum, int XNum, int YNum, float SizeX, float SizeY, int *HandleBuf, const void *AlphaData )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphF(  Width,  Height,  Pitch, GraphData,  AllNum,  XNum,  YNum,  SizeX,  SizeY, HandleBuf, AlphaData ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int		CreateDivGraphFromSoftImage( int SIHandle, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFromSoftImage(  SIHandle,  AllNum,  XNum,  YNum,  SizeX,  SizeY, HandleBuf ) ;
	DXFUNC_END
	return Result ;
}

extern	int		CreateDivGraphFFromSoftImage( int SIHandle, int AllNum, int XNum, int YNum, float SizeX, float SizeY, int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFFromSoftImage(  SIHandle,  AllNum,  XNum,  YNum,  SizeX,  SizeY, HandleBuf ) ;
	DXFUNC_END
	return Result ;
}
...
extern	int		CreateDivGraphFromBaseImage( BASEIMAGE *BaseImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFromBaseImage( BaseImage,  AllNum,  XNum,  YNum,  SizeX,  SizeY, HandleBuf );
	DXFUNC_END
	return Result ;
}
extern	int		CreateDivGraphFFromBaseImage( BASEIMAGE *BaseImage, int AllNum, int XNum, int YNum, float SizeX, float SizeY, int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_CreateDivGraphFFromBaseImage( BaseImage,  AllNum,  XNum,  YNum,  SizeX,  SizeY, HandleBuf );
	DXFUNC_END
	return Result ;
}
...
extern int ReloadDivGraph( const TCHAR *FileName, int AllNum, int XNum, int YNum, int XSize, int YSize, const int *HandleBuf, int ReverseFlag  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReloadDivGraph( FileName, AllNum,  XNum,  YNum,  XSize, YSize, HandleBuf,  ReverseFlag  ) ;
	DXFUNC_END
	return Result ;
}
extern int ReloadDivGraphF( const TCHAR *FileName, int AllNum, int XNum, int YNum, float XSize, float YSize, const int *HandleBuf, int ReverseFlag  )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReloadDivGraphF( FileName, AllNum,  XNum,  YNum,  XSize, YSize, HandleBuf,  ReverseFlag  ) ;
	DXFUNC_END
	return Result ;
}
...
extern int ReloadReverseDivGraph( const TCHAR *FileName, int AllNum, int XNum, int YNum, int XSize, int YSize, const int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReloadReverseDivGraph( FileName, AllNum,  XNum,  YNum,  XSize,  YSize, HandleBuf ) ;
	DXFUNC_END
	return Result ;
}
extern int ReloadReverseDivGraphF( const TCHAR *FileName, int AllNum, int XNum, int YNum, float XSize, float YSize, const int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_ReloadReverseDivGraphF( FileName, AllNum,  XNum,  YNum,  XSize,  YSize, HandleBuf ) ;
	DXFUNC_END
	return Result ;
}
...
extern int LoadDivMask( const TCHAR *FileName, int AllNum, int XNum, int YNum, int XSize, int YSize, int *HandleBuf )
{
	int Result ;
	DXFUNC_BEGIN
...
extern int MV1SetShapeRate( int MHandle, int ShapeIndex, float Rate )
{
	int Result ;
	DXFUNC_BEGIN
	Result = NS_MV1SetShapeRate(  MHandle,  ShapeIndex, Rate ) ;
	DXFUNC_END
	return Result ;
}
