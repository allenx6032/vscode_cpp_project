#include "DragonBones_JSONParser.h"
#include <fstream>
#include "DragonBones_DBDataUtil.h"
#include "json.h"
...
namespace DragonBones {
	...
	AnimationData* JSONParser::parseAnimationData(Json::Value animationValue, ArmatureData* armatureData, int framerate) {
		...
		animationData->tweenEasing = animationValue.get("tweenEasing", /*_Nan._Float*/0.0f).asFloat();
	...
	TransformFrame* JSONParser::parseTransformFrame(Json::Value frameValue, int framerate) {
		...
		frame->tweenEasing = frameValue.get("tweenEasing", /*_Nan._Float*/0.0f).asFloat();
