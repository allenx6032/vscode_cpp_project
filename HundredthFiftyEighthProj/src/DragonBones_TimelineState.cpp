#include "DragonBones_TimelineState.h"
#include <math.h>
#include "DragonBones_AnimationState.h"
#include "DragonBones_Animation.h"
#include "DragonBones_TransformUtil.h"
#include "DragonBones_AnimationData.h"
#include "DragonBones_Bone.h"
#include "DragonBones_TransformTimeline.h"
#include "DragonBones_TransformFrame.h"
...
namespace DragonBones {
	...
	int TimelineState::updateList(float progress){
		...
		if(isArrivedFrame)
		{
			...
			{
				updatef = &TimelineState::updateNothing;
				_tweenEasing = 0.0f;//_Nan._Float;
			}
			else if(nextFrame->displayIndex < 0 || !_animationState->tweenEnabled)
			{
				_tweenEasing = 0.0f;//_Nan._Float;
			}
			else if(_animationState->getClip()->tweenEasing == /*_Nan._Float*/0.0f)
			{
			...
			if(_tweenEasing == /*_Nan._Float*/0.0f)
			{
