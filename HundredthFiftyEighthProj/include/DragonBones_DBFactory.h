...
#include <string>
#include <ymath.h>
#include "DragonBones_EventDispatcher.h"
...
namespace DragonBones {
	...
	public:
		...
		Object* getTextureDisplay(std::string textureName, std::string textureAtlasName="", float pivotX=/*_Nan._Float*/0.0f, float pivotY=/*_Nan._Float*/0.0f);
