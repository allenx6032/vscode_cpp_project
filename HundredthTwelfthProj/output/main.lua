...
Vector._meta = {
  ...
  __eq = function(u,v)
    --assert( type(u) == "table" and type(v) == "table", "Vectors can only be equal to other vectors" )
...
opened = glfw.OpenWindow( 640, 480, 0, 0, 0, 0, 32, 0, glfw.WINDOW )
