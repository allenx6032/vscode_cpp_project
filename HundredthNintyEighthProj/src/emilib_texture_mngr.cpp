...
#include "emilib_texture_mngr.hpp"

#include <map>

#include <emilib_dir_watcher.hpp>
#include <emilib_file_system.hpp>
#include <emilib_gl_lib.hpp>
#include <emilib_irange.hpp>
#include <emilib_mem_map.hpp>
#include <emilib_pvr.hpp>
#include <emilib_thread_pool.hpp>
