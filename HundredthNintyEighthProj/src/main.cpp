...
#include <emilib_imgui_helpers.hpp>
#include <emilib_imgui_sdl.hpp>
#include <emilib_timer.hpp>
#include <emilib_loguru.hpp>

#ifdef OPENGL_REFERENCE_RENDERER
	// For gl path:
	#include <emilib_gl_lib_opengl.hpp>
	#include <emilib_gl_lib_sdl.hpp>
	#include <emilib_imgui_gl_lib.hpp>
