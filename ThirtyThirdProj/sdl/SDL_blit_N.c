...
static void BlitNtoNKey(SDL_BlitInfo *info)
{
    ...
    if (srcbpp == 4 && dstbpp == 4 && srcfmt->Rmask == dstfmt->Rmask && srcfmt->Gmask == dstfmt->Gmask && srcfmt->Bmask == dstfmt->Bmask) {
        ...
        if (dstfmt->Amask) {
            /* RGB->RGBA, SET_ALPHA */
            Uint32 mask = ((Uint32)srcfmt->alpha) << dstfmt->Ashift;
            while (height--) {
                /* *INDENT-OFF* */
                DUFFS_LOOP(
                {
    ...
    if (srcbpp == 3 && dstbpp == 3 && srcfmt->Gmask == 0x0000ff00 && dstfmt->Gmask == 0x0000ff00 &&
        ((srcfmt->Rmask == 0x00ff0000 && srcfmt->Bmask == 0x000000ff &&
          dstfmt->Rmask == 0x00ff0000 && dstfmt->Bmask == 0x000000ff) ||
         (srcfmt->Rmask == 0x000000ff && srcfmt->Bmask == 0x00ff0000 &&
          dstfmt->Rmask == 0x000000ff && dstfmt->Bmask == 0x00ff0000))) {
...
static void BlitNtoNKeyCopyAlpha(SDL_BlitInfo *info)
{
    ...
    if (srcbpp == 4 && dstbpp == 4) {
        ...
        if (srcfmt->Rmask == dstfmt->Rmask && srcfmt->Gmask == dstfmt->Gmask &&
            srcfmt->Bmask == dstfmt->Bmask && srcfmt->Amask == dstfmt->Amask) {
...
static const struct blit_table normal_blit_3[] = {
    ...
    {0x000000FF, 0x0000FF00, 0x00FF0000, 4, 0x000000FF, 0x0000FF00, 0x00FF0000,
     0, NULL, Blit_3or4_to_3or4__same_rgb,
#if HAVE_FAST_WRITE_INT8
        NO_ALPHA |
#endif
        SET_ALPHA},
    ...
    {0x000000FF, 0x0000FF00, 0x00FF0000, 4, 0x00FF0000, 0x0000FF00, 0x000000FF,
     0, NULL, Blit_3or4_to_3or4__inversed_rgb,
#if HAVE_FAST_WRITE_INT8
        NO_ALPHA |
#endif
        SET_ALPHA},
    ...
    {0x000000FF, 0x0000FF00, 0x00FF0000, 3, 0x00FF0000, 0x0000FF00, 0x000000FF,
     0, NULL, Blit_3or4_to_3or4__inversed_rgb, NO_ALPHA },
...
static const struct blit_table normal_blit_4[] = {
    ...
    { 0x00000000,0x00000000,0x00000000, 4, 0x00000000,0x00000000,0x00000000,
      BLIT_FEATURE_HAS_ALTIVEC | BLIT_FEATURE_ALTIVEC_DONT_USE_PREFETCH, NULL, ConvertAltivec32to32_noprefetch, NO_ALPHA | COPY_ALPHA | SET_ALPHA },
    /* has-altivec */
    { 0x00000000,0x00000000,0x00000000, 4, 0x00000000,0x00000000,0x00000000,
      BLIT_FEATURE_HAS_ALTIVEC, NULL, ConvertAltivec32to32_prefetch, NO_ALPHA | COPY_ALPHA | SET_ALPHA },
    /* has-altivec */
    ...
    {0x000000FF, 0x0000FF00, 0x00FF0000, 3, 0x000000FF, 0x0000FF00, 0x00FF0000,
     0, NULL, Blit_3or4_to_3or4__same_rgb, NO_ALPHA | SET_ALPHA},
    {0x00FF0000, 0x0000FF00, 0x000000FF, 3, 0x00FF0000, 0x0000FF00, 0x000000FF,
     0, NULL, Blit_3or4_to_3or4__same_rgb, NO_ALPHA | SET_ALPHA},
    /* 4->3 with inversed rgb triplet */
    {0x000000FF, 0x0000FF00, 0x00FF0000, 3, 0x00FF0000, 0x0000FF00, 0x000000FF,
     0, NULL, Blit_3or4_to_3or4__inversed_rgb, NO_ALPHA | SET_ALPHA},
    {0x00FF0000, 0x0000FF00, 0x000000FF, 3, 0x000000FF, 0x0000FF00, 0x00FF0000,
     0, NULL, Blit_3or4_to_3or4__inversed_rgb, NO_ALPHA | SET_ALPHA},
