...
#include "glfw_null_platform.h"
#define GLFW_EXPOSE_NATIVE_EGL
#define GLFW_EXPOSE_NATIVE_OSMESA

#if defined(_GLFW_WIN32)
 #include "glfw_win32_platform.h"
...
#include "glfw_null_joystick.h"

#if defined(_GLFW_WIN32)
 #include "glfw_win32_joystick.h"
#else
