...
void renderer_recompile_shader() {
  shader_compile("shaders/geometry.vs", "shaders/geometry.fs", NULL, &renderer_geometry_shader);
  shader_compile("shaders/lighting.vs", "shaders/lighting.fs", NULL, &renderer_lighting_shader);
  shader_compile("shaders/toon.vs", "shaders/toon.fs", NULL, &renderer_main_shader);
  shader_compile("shaders/shadow.vs", "shaders/shadow.fs", NULL, &renderer_shadow_shader);
  shader_compile("shaders/omni_shadow.vs", "shaders/omni_shadow.fs", "shaders/omni_shadow.gs", &renderer_omni_shadow_shader);
  shader_compile("shaders/debug.vs", "shaders/debug.fs", NULL, &renderer_debug_shader);
  shader_compile("shaders/skybox.vs", "shaders/skybox.fs", NULL, &renderer_skybox_shader);
  shader_compile("shaders/ssao.vs", "shaders/ssao.fs", NULL, &renderer_ssao_shader);
  shader_compile("shaders/ssao.vs", "shaders/blur.fs", NULL, &renderer_ssao_blur_shader);
  shader_compile("shaders/post.vs", "shaders/post.fs", NULL, &renderer_post_shader);
  shader_compile("shaders/particle.vs", "shaders/particle.fs", NULL, &renderer_particle_shader);
}
