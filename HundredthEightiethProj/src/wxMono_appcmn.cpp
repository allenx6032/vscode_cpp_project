...
#include "wx_evtloop.h"
#include "wx_msgout.h"
#include "wx_thread.h"
#include "wx_vidmode.h"
#include "wx_ptr_scpd.h"

#ifdef __WXDEBUG__
    #if wxUSE_STACKWALKER
        #include "wx_stackwalk.h"
    #endif // wxUSE_STACKWALKER
#endif // __WXDEBUG__

#if defined(__WXMSW__)
    #include  "wxMono_msw_private.h"  // includes windows.h for LOGFONT
#endif
...
void wxGUIAppTraitsBase::RemoveFromPendingDelete(wxObject *object)
{
    ...
    #include "wxMono_msw_gsockmsw.h"
#elif defined(__UNIX__) || defined(__DARWIN__) || defined(__OS2__)
    #include "wxMono_unix_gsockunx.h"
