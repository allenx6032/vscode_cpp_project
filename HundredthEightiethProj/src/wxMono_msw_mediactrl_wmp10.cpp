...
#include "wx_mediactrl.h"

#ifndef WX_PRECOMP
    #include "wx_log.h"
#endif

#include "wxMono_msw_private.h" // user info and wndproc setting/getting
#include "wxMono_msw_activex.h" // wxActiveXContainer - COM-specific stuff
