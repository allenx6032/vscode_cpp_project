...
#ifndef WX_PRECOMP
    #ifdef __WXMSW__
        #include "wxMono_msw_wrapwin.h" // For GetShort/LongPathName
    #endif
...
#include "wx_private_filename.h"
#include "wx_tokenzr.h"
#include "wx_config.h"          // for wxExpandEnvVars
#include "wx_dynlib.h"

#if defined(__WIN32__) && defined(__MINGW32__)
    #include "wxMono_msw_gccpriv.h"
#endif
