...
#include "wx_wxprec.h"
    ...
    #include "wx_log.h"
        ...
        #include "wx_textctrl.h"    // for wxTE_PASSWORD
        #if wxUSE_ACCEL
...
#include "wx_process.h"
#include "wx_txtstrm.h"
#include "wx_uri.h"
#include "wx_mimetype.h"
#include "wx_config.h"

#if defined(__WXWINCE__) && wxUSE_DATETIME
#include "wx_datetime.h"
#endif
...
#if wxUSE_GUI
    #include "wx_colordlg.h"
    #include "wx_fontdlg.h"
...
#include "wx_private_browserhack28.h"
