...
#ifndef WX_PRECOMP
    #include "wxMono_msw_wrapcctl.h" // include <commctrl.h> "properly"
    #include "wx_frame.h"
    #include "wx_utils.h"
    #include "wx_intl.h"
    #include "wx_log.h"
...
IMPLEMENT_DYNAMIC_CLASS_XTI(wxMenu, wxEvtHandler,"wx_menu.h")
...
IMPLEMENT_DYNAMIC_CLASS_XTI_CALLBACK(wxMenuBar, wxWindow ,"wx_menu.h",wxMenuBarStreamingCallback)

IMPLEMENT_DYNAMIC_CLASS_XTI(wxMenuInfo, wxObject , "wx_menu.h" )
