...
#error wxGenericFileDialog currently only supports Unix, win32 and DOS
    ...
    #include "wx_sizer.h"
    #include "wx_filedlg.h"     // wxFD_OPEN, wxFD_SAVE...
#endif
...
#include "wx_filefn.h"
#include "wx_file.h"        // for wxS_IXXX constants only
#include "wxMono_generic_filedlgg.h"
#include "wxMono_generic_dirctrlg.h" // for wxFileIconsTable
