...
#include "wx_toplevel.h"      // the base class
...
// include the real class declaration
    ...
    #include "wxMono_univ_frame.h"
#else // !__WXUNIVERSAL__
    #if defined(__WXPALMOS__)
        #include "wxMono_palmos_frame.h"
    #elif defined(__WXMSW__)
        #include "wxMono_msw_frame.h"
    #elif defined(__WXGTK20__)
        #include "wxMono_gtk_frame.h"
    #elif defined(__WXGTK__)
        #include "wxMono_gtk1_frame.h"
    #elif defined(__WXMOTIF__)
        #include "wxMono_motif_frame.h"
    #elif defined(__WXMAC__)
        #include "wxMono_mac_frame.h"
    #elif defined(__WXCOCOA__)
        #include "wxMono_cocoa_frame.h"
    #elif defined(__WXPM__)
        #include "wxMono_os2_frame.h"
    #endif
#endif
