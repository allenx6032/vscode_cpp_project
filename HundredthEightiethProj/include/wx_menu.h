...
#include "wx_list.h"        // for "template" list classes
#include "wx_window.h"      // base class for wxMenuBar
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_univ_menu.h"
#elif defined(__WXPALMOS__)
    #include "wxMono_palmos_menu.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_menu.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_menu.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_menu.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_menu.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_menu.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_menu.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_menu.h"
#endif
