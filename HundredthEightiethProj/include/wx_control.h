...
#include "wx_window.h"      // base class
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_univ_control.h"
#elif defined(__WXPALMOS__)
    #include "wxMono_palmos_control.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_control.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_control.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_control.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_control.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_control.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_control.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_control.h"
#endif
