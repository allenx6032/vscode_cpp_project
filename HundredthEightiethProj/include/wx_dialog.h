...
private:
    ...
    #include "wxMono_univ_dialog.h"
#else
    #if defined(__WXPALMOS__)
        #include "wxMono_palmos_dialog.h"
    #elif defined(__WXMSW__)
        #include "wxMono_msw_dialog.h"
    #elif defined(__WXMOTIF__)
        #include "wxMono_motif_dialog.h"
    #elif defined(__WXGTK20__)
        #include "wxMono_gtk_dialog.h"
    #elif defined(__WXGTK__)
        #include "wxMono_gtk1_dialog.h"
    #elif defined(__WXMAC__)
        #include "wxMono_mac_dialog.h"
    #elif defined(__WXCOCOA__)
        #include "wxMono_cocoa_dialog.h"
    #elif defined(__WXPM__)
        #include "wxMono_os2_dialog.h"
    #endif
#endif
