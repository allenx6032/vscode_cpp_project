...
#include "wx_ctrlsub.h"         // base class
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_univ_listbox.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_listbox.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_listbox.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_listbox.h"
#elif defined(__WXGTK__)
  #include "wxMono_gtk1_listbox.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_listbox.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_listbox.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_listbox.h"
#endif
