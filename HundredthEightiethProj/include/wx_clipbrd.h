...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_msw_clipbrd.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_clipbrd.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_clipbrd.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_clipbrd.h"
#elif defined(__WXX11__)
    #include "wxMono_x11_clipbrd.h"
#elif defined(__WXMGL__)
    #include "wxMono_mgl_clipbrd.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_clipbrd.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_clipbrd.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_clipbrd.h"
#endif
