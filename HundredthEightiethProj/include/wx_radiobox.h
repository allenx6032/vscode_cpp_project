...
private:
    ...
    #include "wxMono_univ_radiobox.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_radiobox.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_radiobox.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_radiobox.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_radiobox.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_radiobox.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_radiobox.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_radiobox.h"
#elif defined(__WXPALMOS__)
    #include "wxMono_palmos_radiobox.h"
#endif
