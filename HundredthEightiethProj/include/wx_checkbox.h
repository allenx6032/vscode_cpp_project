...
private:
    ...
    #include "wxMono_univ_checkbox.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_checkbox.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_checkbox.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_checkbox.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_checkbox.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_checkbox.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_checkbox.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_checkbox.h"
#elif defined(__WXPALMOS__)
    #include "wxMono_palmos_checkbox.h"
#endif
