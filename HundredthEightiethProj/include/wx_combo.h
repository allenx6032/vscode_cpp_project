...
#include "wx_renderer.h" // this is needed for wxCONTROL_XXX flags
#include "wx_bitmap.h" // wxBitmap used by-value
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_msw_combo.h"
#endif

// Any ports may need generic as an alternative
#include "wxMono_generic_combo.h"
