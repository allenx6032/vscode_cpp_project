...
// include the real class declaration
    ...
    #include "wxMono_msw_popupwin.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_popupwin.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_popupwin.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_popupwin.h"
#elif defined(__WXX11__)
    #include "wxMono_x11_popupwin.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_popupwin.h"
#elif defined(__WXMGL__)
    #include "wxMono_mgl_popupwin.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_popupwin.h"
#else
