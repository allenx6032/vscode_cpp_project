...
#include "wx_string.h"
#include "wx_gdicmn.h"  // for wxBitmapType
#include "wx_colour.h"
...
protected:
    ...
    #include "wxMono_palmos_bitmap.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_bitmap.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_x11_bitmap.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_bitmap.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_bitmap.h"
#elif defined(__WXX11__)
    #include "wxMono_x11_bitmap.h"
#elif defined(__WXMGL__)
    #include "wxMono_mgl_bitmap.h"
#elif defined(__WXDFB__)
    #include "wxMono_dfb_bitmap.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_bitmap.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_bitmap.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_bitmap.h"
#endif
