...
protected:
    ...
    #include "wxMono_univ_gauge.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_gauge95.h"
    #define wxGauge wxGauge95
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_gauge.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_gauge.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_gauge.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_gauge.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_gauge.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_gauge.h"
#endif
