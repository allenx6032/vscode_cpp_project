...
#include "wx_event.h"       // for the base class
#include "wx_build.h"
#include "wx_init.h"        // we must declare wxEntry()
...
// ----------------------------------------------------------------------------
        ...
        #include "wxMono_palmos_app.h"
    #elif defined(__WXMSW__)
        #include "wxMono_msw_app.h"
    #elif defined(__WXMOTIF__)
        #include "wxMono_motif_app.h"
    #elif defined(__WXMGL__)
        #include "wxMono_mgl_app.h"
    #elif defined(__WXDFB__)
        #include "wxMono_dfb_app.h"
    #elif defined(__WXGTK20__)
        #include "wxMono_gtk_app.h"
    #elif defined(__WXGTK__)
        #include "wxMono_gtk1_app.h"
    #elif defined(__WXX11__)
        #include "wxMono_x11_app.h"
    #elif defined(__WXMAC__)
        #include "wxMono_mac_app.h"
    #elif defined(__WXCOCOA__)
        #include "wxMono_cocoa_app.h"
    #elif defined(__WXPM__)
        #include "wxMono_os2_app.h"
    #endif
#else // !GUI
