...
#include "wx_event.h"           // the base class

#include "wx_list.h"            // defines wxWindowList

#include "wx_cursor.h"          // we have member variables of these classes
#include "wx_font.h"            // so we can't do without them
#include "wx_colour.h"
#include "wx_region.h"
#include "wx_utils.h"
#include "wx_intl.h"

#include "wx_validate.h"        // for wxDefaultValidator (always include it)
...
// include the declaration of the platform-specific class
    ...
    #endif // wxUniv/!wxUniv
    #include "wxMono_palmos_window.h"
    ...
    #endif // wxUniv/!wxUniv
    #include "wxMono_msw_window.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_window.h"
    ...
    #endif // wxUniv
    #include "wxMono_x11_window.h"
#elif defined(__WXMGL__)
    #define wxWindowNative wxWindowMGL
    #include "wxMono_mgl_window.h"
#elif defined(__WXDFB__)
    #define wxWindowNative wxWindowDFB
    #include "wxMono_dfb_window.h"
