...
#if defined(__WXPALMOS__)
    #include "wxMono_palmos_region.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_region.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_region.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_region.h"
#elif defined(__WXMOTIF__) || defined(__WXX11__)
    #include "wxMono_x11_region.h"
#elif defined(__WXMGL__)
    #include "wxMono_mgl_region.h"
#elif defined(__WXDFB__)
    #include "wxMono_dfb_region.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_region.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_region.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_region.h"
#endif
