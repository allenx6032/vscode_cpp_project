...
#include "wx_defs.h" // headers should include this before first wxUSE_XXX check

#if wxUSE_LISTCTRL

#include "wx_listbase.h"
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_msw_listctrl.h"
#elif defined(__WXMAC__) && !defined(__WXUNIVERSAL__)
    #include "wxMono_mac_listctrl.h"
#else
    #include "wxMono_generic_listctrl.h"
#endif
