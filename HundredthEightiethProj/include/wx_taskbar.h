...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_palmos_taskbar.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_taskbar.h"
#elif defined(__WXGTK__) || defined(__WXX11__) || defined(__WXMOTIF__)
    #include "wxMono_unix_taskbarx11.h"
#elif defined (__WXMAC__) && defined(__WXMAC_OSX__)
    #include "wxMono_mac_taskbarosx.h"
#elif defined (__WXCOCOA__)
    #include "wxMono_cocoa_taskbar.h"
#endif
