...
#include "wx_defs.h"            // for wxUSE_FONTDLG

#if wxUSE_FONTDLG

#include "wx_dialog.h"          // the base class
#include "wx_cmndata.h"         // wxFontData
...
#define USE_NATIVE_FONT_DIALOG_FOR_MACOSX 0
    ...
    #include "wxMono_generic_fontdlgg.h"
    #define wxFontDialog wxGenericFontDialog
#elif defined(__WXMSW__)
    #include "wxMono_msw_fontdlg.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_fontdlg.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_fontdlg.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_fontdlg.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_fontdlg.h"
#endif
