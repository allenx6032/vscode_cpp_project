...
#include "wxMono_generic_filedlgg.h"
#elif defined(__WXMSW__)
#include "wxMono_msw_filedlg.h"
#elif defined(__WXMOTIF__)
#include "wxMono_motif_filedlg.h"
#elif defined(__WXGTK24__)
#include "wxMono_gtk_filedlg.h"     // GTK+ > 2.4 has native version
#elif defined(__WXGTK20__)
#define wxUSE_GENERIC_FILEDIALOG
#include "wxMono_generic_filedlgg.h"
#elif defined(__WXGTK__)
#include "wxMono_gtk1_filedlg.h"
#elif defined(__WXMAC__)
#include "wxMono_mac_filedlg.h"
#elif defined(__WXCOCOA__)
#include "wxMono_cocoa_filedlg.h"
#elif defined(__WXPM__)
#include "wxMono_os2_filedlg.h"
#endif
