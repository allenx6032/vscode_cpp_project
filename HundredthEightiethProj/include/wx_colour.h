...
protected:
    ...
    #include "wxMono_generic_colour.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_colour.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_colour.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_colour.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_colour.h"
#elif defined(__WXMGL__)
    #include "wxMono_generic_colour.h"
#elif defined(__WXDFB__)
    #include "wxMono_generic_colour.h"
#elif defined(__WXX11__)
    #include "wxMono_x11_colour.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_colour.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_colour.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_colour.h"
#endif
