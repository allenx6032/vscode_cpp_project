...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_univ_slider.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_slider95.h"
    #if WXWIN_COMPATIBILITY_2_4
         #define wxSlider95 wxSlider
    #endif
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_slider.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_slider.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_slider.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_slider.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_slider.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_slider.h"
#elif defined(__WXPALMOS__)
    #include "wxMono_palmos_slider.h"
#endif
