...
// ABX: check __WIN32__ instead of __WXMSW__ for the same MSWBase in any Win32 port
    ...
    #include "wxMono_palmos_apptbase.h"
#elif defined(__WIN32__)
    #include "wxMono_msw_apptbase.h"
#elif defined(__UNIX__) && !defined(__EMX__)
    #include "wxMono_unix_apptbase.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_apptbase.h"
#elif defined(__OS2__)
    #include "wxMono_os2_apptbase.h"
...
// ABX: check __WIN32__ instead of __WXMSW__ for the same MSWBase in any Win32 port
#if defined(__WXPALMOS__)
    #include "wxMono_palmos_apptrait.h"
#elif defined(__WIN32__)
    #include "wxMono_msw_apptrait.h"
#elif defined(__OS2__)
    #include "wxMono_os2_apptrait.h"
#elif defined(__UNIX__)
    #include "wxMono_unix_apptrait.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_apptrait.h"
#elif defined(__DOS__)
    #include "wxMono_msdos_apptrait.h"
#else
    #if wxUSE_GUI
