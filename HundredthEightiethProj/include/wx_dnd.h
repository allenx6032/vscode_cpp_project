...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_msw_dropsrc.h"
    #include "wxMono_msw_droptgt.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_dnd.h"
#elif defined(__WXX11__)
    #include "wxMono_x11_dnd.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_dnd.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_dnd.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_dnd.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_dnd.h"
#endif
