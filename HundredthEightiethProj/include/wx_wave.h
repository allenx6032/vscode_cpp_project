...
#include "wx_defs.h"
    ...
    #pragma message "wx_wave.h header is deprecated, use wx/sound.h and wxSound"
#elif defined(__WATCOMC__) || defined(__VISUALC__)
    #pragma message ("wx_wave.h header is deprecated, use wx/sound.h and wxSound")
#else
    #warning "wx_wave.h header is deprecated, use wx/sound.h and wxSound"
#endif
    #include "wx_sound.h"
    // wxSound used to be called wxWave before wxWidgets 2.5.1:
    typedef wxSound wxWave;
#else
    #error "wx_wave.h is only available in compatibility mode"
#endif
