...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_univ_notebook.h"
#elif defined(__WXMSW__)
    #include  "wxMono_msw_notebook.h"
#elif defined(__WXMOTIF__)
    #include  "wxMono_generic_notebook.h"
#elif defined(__WXGTK20__)
    #include  "wxMono_gtk_notebook.h"
#elif defined(__WXGTK__)
    #include  "wxMono_gtk1_notebook.h"
#elif defined(__WXMAC__)
    #include  "wxMono_mac_notebook.h"
#elif defined(__WXCOCOA__)
    #include  "wxMono_cocoa_notebook.h"
#elif defined(__WXPM__)
    #include  "wxMono_os2_notebook.h"
#endif
