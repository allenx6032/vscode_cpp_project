...
#include "wx_spinbutt.h"        // should make wxSpinEvent visible to the app
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_generic_spinctlg.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_spinctrl.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_spinctrl.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_spinctrl.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_spinctrl.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_generic_spinctlg.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_spinctrl.h"
