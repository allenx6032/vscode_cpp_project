...
// Universal and non-port related switches with need for generic implementation
    ...
    #include "wxMono_generic_dirdlgg.h"
    ...
    #include "wxMono_generic_dirdlgg.h"     // MS PocketPC or MS Smartphone
    #define wxDirDialog wxGenericDirDialog
#elif defined(__WXMSW__)
    #include "wxMono_msw_dirdlg.h"  // Native MSW
#elif defined(__WXGTK24__)
    #include "wxMono_gtk_dirdlg.h"  // Native GTK for gtk2.4
#elif defined(__WXGTK__)
    #include "wxMono_generic_dirdlgg.h"
    #define wxDirDialog wxGenericDirDialog
#elif defined(__WXMAC__)
    #include "wxMono_mac_dirdlg.h"      // Native Mac
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_dirdlg.h"    // Native Cocoa
#elif defined(__WXMOTIF__) || \
      defined(__WXX11__)   || \
      defined(__WXMGL__)   || \
      defined(__WXCOCOA__) || \
      defined(__WXPM__)
    #include "wxMono_generic_dirdlgg.h"     // Other ports use generic implementation
    #define wxDirDialog wxGenericDirDialog
#endif
