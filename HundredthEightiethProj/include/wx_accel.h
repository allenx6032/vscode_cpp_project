...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_generic_accel.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_accel.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_accel.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_accel.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_accel.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_accel.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_generic_accel.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_accel.h"
#endif
