...
#include "wx_object.h"          // the base class

#include "wx_intl.h"            // for wxLayoutDirection
#include "wx_cursor.h"          // we have member variables of these classes
#include "wx_font.h"            // so we can't do without them
#include "wx_colour.h"
#include "wx_bitmap.h"          // for wxNullBitmap
#include "wx_brush.h"
#include "wx_pen.h"
#include "wx_palette.h"
#include "wx_list.h"            // we use wxList in inline functions
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_palmos_dc.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_dc.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_dc.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_dc.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_dc.h"
#elif defined(__WXX11__)
    #include "wxMono_x11_dc.h"
#elif defined(__WXMGL__)
    #include "wxMono_mgl_dc.h"
#elif defined(__WXDFB__)
    #include "wxMono_dfb_dc.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_dc.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_dc.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_dc.h"
#endif

#if wxUSE_GRAPHICS_CONTEXT
    #include "wx_dcgraph.h"
#endif
