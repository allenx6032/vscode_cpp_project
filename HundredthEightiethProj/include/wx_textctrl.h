...
#include "wx_control.h"         // the base class
#include "wx_dynarray.h"        // wxArrayInt
#include "wx_gdicmn.h"          // wxPoint
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_x11_textctrl.h"
#elif defined(__WXUNIVERSAL__)
    #include "wxMono_univ_textctrl.h"
#elif defined(__SMARTPHONE__) && defined(__WXWINCE__)
    #include "wxMono_msw_textctrlce.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_textctrl.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_textctrl.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_textctrl.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_textctrl.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_textctrl.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_textctrl.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_textctrl.h"
#endif
