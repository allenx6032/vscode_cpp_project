...
*/
    ...
    #include "wxMono_msw_dataform.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_dataform.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_dataform.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_dataform.h"
#elif defined(__WXX11__)
    #include "wxMono_x11_dataform.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_dataform.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_dataform.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_dataform.h"
#endif
...
#if defined(__WXMSW__)
    #include "wxMono_msw_dataobj.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_dataobj.h"
#elif defined(__WXX11__)
    #include "wxMono_x11_dataobj.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_dataobj.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_dataobj.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_dataobj.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_dataobj.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_dataobj.h"
#endif
...
#if defined(__WXMSW__)
    #include "wxMono_msw_dataobj2.h"

    // wxURLDataObject defined in msw/ole/dataobj2.h
#else // !__WXMSW__
    #if defined(__WXGTK20__)
        #include "wxMono_gtk_dataobj2.h"
    #elif defined(__WXGTK__)
        #include "wxMono_gtk1_dataobj2.h"
    #elif defined(__WXX11__)
        #include "wxMono_x11_dataobj2.h"
    #elif defined(__WXMOTIF__)
        #include "wxMono_motif_dataobj2.h"
    #elif defined(__WXMAC__)
        #include "wxMono_mac_dataobj2.h"
    #elif defined(__WXCOCOA__)
        #include "wxMono_cocoa_dataobj2.h"
    #elif defined(__WXPM__)
        #include "wxMono_os2_dataobj2.h"
    #endif
