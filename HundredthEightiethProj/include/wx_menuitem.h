...
#include "wx_object.h"  // base class
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_univ_menuitem.h"
#elif defined(__WXPALMOS__)
    #include "wxMono_palmos_menuitem.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_menuitem.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_menuitem.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_menuitem.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_menuitem.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_menuitem.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_menuitem.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_menuitem.h"
#endif
