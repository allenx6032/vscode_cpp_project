...
#include "wx_defs.h"        // for wxDEFAULT &c
#include "wx_fontenc.h"     // the font encoding constants
#include "wx_gdiobj.h"      // the base class
...
// include the real class declaration
    ...
    #include "wxMono_palmos_font.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_font.h"
#elif defined(__WXMOTIF__)
    #include "wxMono_motif_font.h"
#elif defined(__WXGTK20__)
    #include "wxMono_gtk_font.h"
#elif defined(__WXGTK__)
    #include "wxMono_gtk1_font.h"
#elif defined(__WXX11__)
    #include "wxMono_x11_font.h"
#elif defined(__WXMGL__)
    #include "wxMono_mgl_font.h"
#elif defined(__WXDFB__)
    #include "wxMono_dfb_font.h"
#elif defined(__WXMAC__)
    #include "wxMono_mac_font.h"
#elif defined(__WXCOCOA__)
    #include "wxMono_cocoa_font.h"
#elif defined(__WXPM__)
    #include "wxMono_os2_font.h"
#endif
