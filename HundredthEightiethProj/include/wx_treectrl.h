...
#include "wx_treebase.h"
#include "wx_textctrl.h" // wxTextCtrl::ms_classinfo used through CLASSINFO macro
...
// ----------------------------------------------------------------------------
    ...
    #include "wxMono_generic_treectlg.h"
#elif defined(__WXPALMOS__)
    #include "wxMono_palmos_treectrl.h"
#elif defined(__WXMSW__)
    #include "wxMono_msw_treectrl.h"
