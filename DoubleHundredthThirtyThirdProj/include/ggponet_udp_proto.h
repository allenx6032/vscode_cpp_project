...
#include "ggponet_poll.h"
#include "ggponet_udp.h"
#include "ggponet_udp_msg.h"
#include "ggponet_game_input.h"
#include "ggponet_timesync.h"
#include "ggponet.h"
#include "ggponet_ring_buffer.h"
...
public:
   ...
   struct Event {
      ...
      //  Event(Type t = Type::Unknown) : type(t) { }
      // UdpProtocol::Event(Type t){ 
      //    this->type = t;
      // }
   };
