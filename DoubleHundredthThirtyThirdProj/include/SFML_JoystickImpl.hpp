...
struct JoystickState
{
    ...
    #include <SFML_Win32JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_LINUX)

    #include <SFML_UnixJoystickImpl.hpp>

#elif defined(SFML_SYSTEM_FREEBSD)

    #include <SFML_FreeBSDJoystickImpl.hpp>

#elif defined(SFML_SYSTEM_OPENBSD)

    #include <SFML_OpenBSDJoystickImpl.hpp>

#elif defined(SFML_SYSTEM_NETBSD)

    #include <SFML_NetBSDJoystickImpl.hpp>

#elif defined(SFML_SYSTEM_MACOS)

    #include <SFML_OSXJoystickImpl.hpp>

#elif defined(SFML_SYSTEM_IOS)

    #include <SFML_iOSJoystickImpl.hpp>

#elif defined(SFML_SYSTEM_ANDROID)

    #include <SFML_AndroidJoystickImpl.hpp>
