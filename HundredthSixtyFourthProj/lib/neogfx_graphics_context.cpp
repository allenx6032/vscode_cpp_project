...
#include FT_BITMAP_H
#include <neogfx_i_surface.hpp>
#include <neogfx_i_texture.hpp>
#include <neogfx_i_widget.hpp>
#include <neogfx_text_category_map.hpp>
...
namespace neogfx
{
	...
	{
		iNativeGraphicsContext->enqueue(graphics_operation::draw_glyph{ to_device_units(aPoint) + iOrigin, aGlyph, aFont, aColour });
