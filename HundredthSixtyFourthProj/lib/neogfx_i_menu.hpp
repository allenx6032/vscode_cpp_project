...
namespace neogfx
{
	...
	public:
		...
		virtual void remove_item_at(item_index aItemIndex) = 0;
		...
		virtual void select_item_at(item_index aItemIndex, bool aSelectAnySubMenuItem = false) = 0;
