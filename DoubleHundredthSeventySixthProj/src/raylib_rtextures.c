...
#include "raylib_rutils.h"              // Required for: TRACELOG()
#include "raylib_rlgl.h"               // OpenGL abstraction layer to multiple versions
...
// Image fileformats not supported by default
    ...
    #include "raylib_stb_image.h"         // Required for: stbi_load_from_file()
    ...
    #include "raylib_rl_gputex.h"         // Required for: rl_load_xxx_from_memory()
    ...
    #include "raylib_stb_image_write.h"   // Required for: stbi_write_*()
#endif

#if defined(SUPPORT_IMAGE_GENERATION)
    #define STB_PERLIN_IMPLEMENTATION
    #include "raylib_stb_perlin.h"        // Required for: stb_perlin_fbm_noise3
#endif
...
#include "raylib_stb_image_resize2.h"     // Required for: stbir_resize_uint8_linear() [ImageResize()]
