...
#include "love_lullady_FLACDecoder.h"
...
namespace lullaby
{
	...
	{
		return Stream::seek_absolute((int)(s*1000.0f));
	}

	bool FLACDecoder::rewind()
	{
		return Stream::seek_absolute(0);
	}
	...
	{
		return Stream::get_channels();
	}

	int FLACDecoder::getBits() const
	{
		return Stream::get_bits_per_sample();
	}
