 ...
 * Converters.
 */
#include "iconv_converters.h"

/*
 * Transliteration tables.
 */
#include "iconv_cjk_variants.h"
#include "iconv_translit.h"
...
#define DEFENCODING(xxx_names,xxx,xxx_ifuncs1,xxx_ifuncs2,xxx_ofuncs1,xxx_ofuncs2) \
  ei_##xxx ,
#include "iconv_encodings.def"
#ifdef USE_AIX
# include "iconv_encodings_aix.def"
#endif
#ifdef USE_OSF1
# include "iconv_encodings_osf1.def"
#endif
#ifdef USE_DOS
# include "iconv_encodings_dos.def"
#endif
#ifdef USE_ZOS
# include "iconv_encodings_zos.def"
#endif
#ifdef USE_EXTRA
# include "iconv_encodings_extra.def"
#endif
#include "iconv_encodings_local.def"
#undef DEFENCODING
ei_for_broken_compilers_that_dont_like_trailing_commas
};
#include "iconv_flags.h"
 ...
 */
#if defined _AIX
# include "iconv_aliases_sysaix.h"
#elif defined hpux || defined __hpux
# include "iconv_aliases_syshpux.h"
#elif defined __osf__
# include "iconv_aliases_sysosf1.h"
#elif defined __sun
# include "iconv_aliases_syssolaris.h"
#else
# include "iconv_aliases.h"
#endif
...
#if defined _AIX
# include "iconv_canonical_sysaix.h"
#elif defined hpux || defined __hpux
# include "iconv_canonical_syshpux.h"
#elif defined __osf__
# include "iconv_canonical_sysosf1.h"
#elif defined __sun
# include "iconv_canonical_syssolaris.h"
#else
# include "iconv_canonical.h"
#endif
#ifdef USE_AIX
# if defined _AIX
#  include "iconv_canonical_aix_sysaix.h"
# else
#  include "iconv_canonical_aix.h"
# endif
#endif
#ifdef USE_OSF1
# if defined __osf__
#  include "iconv_canonical_osf1_sysosf1.h"
# else
#  include "iconv_canonical_osf1.h"
# endif
#endif
#ifdef USE_DOS
# include "iconv_canonical_dos.h"
#endif
#ifdef USE_ZOS
# include "iconv_canonical_zos.h"
#endif
#ifdef USE_EXTRA
# include "iconv_canonical_extra.h"
#endif
#if defined _AIX
# include "iconv_canonical_local_sysaix.h"
#elif defined hpux || defined __hpux
# include "iconv_canonical_local_syshpux.h"
#elif defined __osf__
# include "iconv_canonical_local_sysosf1.h"
#elif defined __sun
# include "iconv_canonical_local_syssolaris.h"
#else
# include "iconv_canonical_local.h"
#endif
};
