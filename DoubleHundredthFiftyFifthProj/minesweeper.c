...
int main(int argc, char *argv[]) {
    ...
    ye_add_camera_component(cam,999, (SDL_Rect){0, 0, 2560, 1440});
    ...
    ye_add_transform_component(splash,  1920, 1080);
    // ye_temp_add_image_renderer_component(splash, ye_get_resource_static("images/studiozoogies.png"));
    ye_add_image_renderer_component(splash, 999, "images/studiozoogies.png");

    // playSound(ye_get_resource_static("sfx/boot.mp3"),-1,0); // play startup sound
    ye_play_sound("sfx/boot.mp3",-1,0); // play startup sound
    ...
    ye_destroy_entity(ye_get_entity_by_name("camera"));

    // ye_load_scene(ye_get_resource_static("scenes/main.yoyo"));
    ye_load_scene("scenes/main.yoyo");
