...
extern	int		LoadTiffImage( STREAMDATA *Src, BASEIMAGE *BaseImage ) ;										// ＴＩＦＦ画像の読みこみ
#endif
#ifndef DX_NON_PNGREAD
extern	int		LoadPngImage( STREAMDATA *Src, BASEIMAGE *BaseImage ) ;											// ＰＮＧ画像の読みこみ
...
extern	int		LoadJpegImage( STREAMDATA *Src, BASEIMAGE *BaseImage ) ;										// ＪＰＥＧ画像の読みこみ (実体は DxUseCLib.cpp の中)
#ifndef DX_NON_SAVEFUNCTION
...
extern const D_IDirect3DSurface9 *TheoraDecode_GetYUVImage( DWORD_PTR Handle ) ;													// 一時バッファの YUV フォーマットのサーフェスを得る
