...
struct GRAPHFILTER_DRAWPARAMTEMP_DIRECT3D11
{
	D_ID3D11Texture2D *				TargetTexture[ DX_RENDERTARGET_COUNT ] ;
	D_ID3D11ShaderResourceView *	TargetTextureSRV[ DX_RENDERTARGET_COUNT ] ;
	D_ID3D11RenderTargetView *		TargetTextureRTV[ DX_RENDERTARGET_COUNT ] ;

	D_ID3D11Texture2D *				DepthStencilTexture ;
	D_ID3D11DepthStencilView *		DepthStencilTextureDSV ;
...
struct GRAPHFILTER_SHADERPARAMTEMP_DIRECT3D11
{
