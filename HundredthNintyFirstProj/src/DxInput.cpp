...
START:
	if( DInputData.NoUseDirectInputFlag == FALSE )
	{
		...
		DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x49\x00\x6e\x00\x70\x00\x75\x00\x74\x00\xa2\x95\xc2\x4f\x1d\x52\x1f\x67\x16\x53\xe6\x51\x06\x74\x0a\x00\x00"/*@ L"DirectInput関係初期化処理\n" @*/ ) ;
		DXST_ERRORLOG_TABADD ;

		// ＸＩｎｐｕｔを使用しないフラグが立っていなかったらＸＩｎｐｕｔのＤＬＬを読み込む
		if( DInputData.NoUseXInputFlag == FALSE )
		{
			DXST_ERRORLOG_ADDUTF16LE( "\x58\x00\x49\x00\x6e\x00\x70\x00\x75\x00\x74\x00\x20\x00\x44\x00\x4c\x00\x4c\x00\x20\x00\x6e\x30\xad\x8a\x7f\x30\xbc\x8f\x7f\x30\x2d\x4e\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"XInput DLL の読み込み中... " @*/ ) ;
			...
			if( DInputData.XInputDLL == NULL )
			{
				DXST_ERRORLOG_ADDUTF16LE( "\x31\x59\x57\x65\x01\x30\x58\x00\x49\x00\x6e\x00\x70\x00\x75\x00\x74\x00\x6f\x30\x7f\x4f\x28\x75\x57\x30\x7e\x30\x5b\x30\x93\x30\x0a\x00\x00"/*@ L"失敗、XInputは使用しません\n" @*/ ) ;
			}
			else
			{
		...
		DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x49\x00\x6e\x00\x70\x00\x75\x00\x74\x00\x37\x00\x20\x00\x6e\x30\xd6\x53\x97\x5f\x2d\x4e\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"DirectInput7 の取得中... " @*/ ) ;
		...
		if( !FAILED( hr ) )
		{
			DXST_ERRORLOG_ADDUTF16LE( "\x10\x62\x9f\x52\x0a\x00\x00"/*@ L"成功\n" @*/ ) ;
			DXST_ERRORLOG_TABADD ;
			DXST_ERRORLOG_ADDUTF16LE( "\x15\x5f\x4d\x30\x9a\x7d\x4d\x30\x1d\x52\x1f\x67\x16\x53\xe6\x51\x06\x74\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"引き続き初期化処理... " @*/ ) ;
			hr = DInputData.DirectInputObject->Initialize( WinAPIData.Win32Func.GetModuleHandleWFunc( NULL ), 0x700 ) ;
			if( FAILED( hr ) ) 
			{
				DXST_ERRORLOG_ADDUTF16LE( "\x1d\x52\x1f\x67\x16\x53\x6b\x30\x31\x59\x57\x65\x02\x30\x00"/*@ L"初期化に失敗。" @*/ ) ;
				DInputData.DirectInputObject->Release() ;
				DInputData.DirectInputObject = NULL ;
				goto ER1;
			}
			DXST_ERRORLOG_ADDUTF16LE( "\x1d\x52\x1f\x67\x16\x53\x10\x62\x9f\x52\x0a\x00\x00"/*@ L"初期化成功\n" @*/ ) ;
			DXST_ERRORLOG_TABSUB ;
		}
		else
		{
			DXST_ERRORLOG_ADDUTF16LE( "\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x02\x30\x0a\x00\x00"/*@ L"取得に失敗。\n" @*/ ) ;
			DXST_ERRORLOGFMT_ADDUTF16LE(( "\xa8\x30\xe9\x30\xfc\x30\xb3\x30\xfc\x30\xc9\x30\x20\x00\x30\x00\x78\x00\x25\x00\x78\x00\x0a\x00\x00"/*@ L"エラーコード 0x%x\n" @*/, hr ));
ER1:
			DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x49\x00\x6e\x00\x70\x00\x75\x00\x74\x00\x38\x00\x20\x00\x6e\x30\xd6\x53\x97\x5f\x92\x30\x66\x8a\x7f\x30\x7e\x30\x59\x30\x2e\x00\x2e\x00\x2e\x00\x00"/*@ L"DirectInput8 の取得を試みます..." @*/ ) ;
			...
			{
				DXST_ERRORLOG_ADDUTF16LE( "\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x02\x30\x00"/*@ L"取得に失敗。" @*/ ) ;
ER2:
				DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x49\x00\x6e\x00\x70\x00\x75\x00\x74\x00\x20\x00\x92\x30\x7f\x4f\x28\x75\x57\x30\x7e\x30\x5b\x30\x93\x30\x02\x30\x0a\x00\x00"/*@ L"DirectInput を使用しません。\n" @*/ ) ;
				DXST_ERRORLOG_TABSUB ;
...
//				return -1 ;
		...
		{
			// マウスデバイスを作成する
			DXST_ERRORLOG_ADDUTF16LE( "\xde\x30\xa6\x30\xb9\x30\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x6e\x30\x1d\x52\x1f\x67\x16\x53\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"マウスデバイスの初期化... " @*/ ) ; 
...
MOUSEDEVICEINITEND:
			...
			{
				DXST_ERRORLOG_ADDUTF16LE( "\xde\x30\xa6\x30\xb9\x30\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x6e\x30\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"マウスデバイスの取得に失敗しました\n" @*/ ) ; 
			}
		...
		if( DInputData.KeyboardNotDirectInputFlag == FALSE )
		{
			...
			// キーボードデバイスを作成する
			DXST_ERRORLOG_ADDUTF16LE( "\xad\x30\xfc\x30\xdc\x30\xfc\x30\xc9\x30\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x6e\x30\x1d\x52\x1f\x67\x16\x53\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"キーボードデバイスの初期化... " @*/ ) ; 
			if( DInputData.UseDirectInput8Flag == TRUE )
			{
	...
	//		hr = DInputData.KeyboardDeviceObject->SetCooperativeLevel( NS_GetMainWindowHandle(), D_DISCL_NONEXCLUSIVE | D_DISCL_FOREGROUND ) ;
			...
			// バッファを設定してみる
			{
				...
				{
					DXST_ERRORLOG_ADDUTF16LE( "\xad\x30\xfc\x30\xdc\x30\xfc\x30\xc9\x30\x6e\x30\xd7\x30\xed\x30\xd1\x30\xc6\x30\xa3\x30\x2d\x8a\x9a\x5b\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"キーボードのプロパティ設定に失敗しました\n" @*/ ) ;
				}
			}
			...
			{
				DXST_ERRORLOG_ADDUTF16LE( "\xad\x30\xfc\x30\xdc\x30\xfc\x30\xc9\x30\xa4\x30\xd9\x30\xf3\x30\xc8\x30\x6e\x30\xbb\x30\xc3\x30\xc8\x30\xa2\x30\xc3\x30\xd7\x30\x4c\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"キーボードイベントのセットアップが失敗しました\n" @*/ ) ;
				NowInitialize = FALSE ;
				return -1 ;
			}
		...
		DXST_ERRORLOG_TABSUB ;
		DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x49\x00\x6e\x00\x70\x00\x75\x00\x74\x00\x20\x00\xa2\x95\x23\x90\x6e\x30\x1d\x52\x1f\x67\x16\x53\x6f\x30\x63\x6b\x38\x5e\x6b\x30\x42\x7d\x86\x4e\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DirectInput 関連の初期化は正常に終了しました\n" @*/ ) ;
	}
	else
	{
...
//			if( WinAPIData.Win32Func.joyGetPosExFunc( i, &joyex ) != JOYERR_NOERROR ) break ;
		...
		DXST_ERRORLOGFMT_ADDUTF16LE(( "\xd1\x30\xc3\x30\xc9\x30\x6e\x30\x70\x65\x6f\x30\x20\x00\x25\x00\x64\x00\x20\x00\x0b\x50\x67\x30\x59\x30\x0a\x00\x00"/*@ L"パッドの数は %d 個です\n" @*/, i ));

		DXST_ERRORLOG_TABSUB ;
		DInputData.DirectInputObject = (D_IDirectInput7 *)(DWORD_PTR)0xffffffff ;
		DXST_ERRORLOG_ADDUTF16LE( "\x65\x51\x9b\x52\xa2\x95\x23\x90\x6e\x30\x1d\x52\x1f\x67\x16\x53\x92\x30\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"入力関連の初期化をしました\n" @*/ ) ;
	}
...
extern int TerminateDirectInput( void )
{
	...
	{
		// DirectInput を使用した場合
		DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x49\x00\x6e\x00\x70\x00\x75\x00\x74\x00\x20\x00\xa2\x95\x23\x90\x6e\x30\x42\x7d\x86\x4e\xe6\x51\x06\x74\x2e\x00\x2e\x00\x2e\x00\x20\x00\x8c\x5b\x86\x4e\x0a\x00\x00"/*@ L"DirectInput 関連の終了処理... 完了\n" @*/ ) ;
	...
	else
	{
		...
		DXST_ERRORLOG_ADDUTF16LE( "\x65\x51\x9b\x52\xa2\x95\x23\x90\x6e\x30\x42\x7d\x86\x4e\xe6\x51\x06\x74\x2e\x00\x2e\x00\x2e\x00\x20\x00\x8c\x5b\x86\x4e\x0a\x00\x00"/*@ L"入力関連の終了処理... 完了\n" @*/ ) ;
...
extern int SetupJoypad( void )
{
	...
	// ジョイパッドデバイスを初期化する
	DXST_ERRORLOG_ADDUTF16LE( "\xb8\x30\xe7\x30\xa4\x30\xd1\x30\xc3\x30\xc9\x30\x6e\x30\x1d\x52\x1f\x67\x16\x53\x2e\x00\x2e\x00\x2e\x00\x20\x00\x0a\x00\x00"/*@ L"ジョイパッドの初期化... \n" @*/ ) ;
...
BOOL FAR PASCAL EnumJoypadProc( const D_DIDEVICEINSTANCEW *pdinst , LPVOID /*pvRef*/ )
{
	...
	if( hr != D_DI_OK )
	{
		DXST_ERRORLOG_ADDUTF16LE( "\x65\x51\x9b\x52\xc5\x88\x6e\x7f\x6e\x30\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"入力装置の取得に失敗しました\n" @*/ ) ;
		return D_DIENUM_CONTINUE ;
	}
	...
	// 情報表示
	{
		...
		DXST_ERRORLOG_ADDUTF16LE( "\x65\x51\x9b\x52\xc5\x88\x6e\x7f\x92\x30\x8b\x89\x64\x30\x51\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"入力装置を見つけました\n" @*/ ) ;
...
//	hr = Joypad->SetCooperativeLevel( NS_GetMainWindowHandle(), D_DISCL_BACKGROUND | D_DISCL_NONEXCLUSIVE ) ;
	...
	{
//		Joypad->Release() ;
		DXST_ERRORLOG_ADDUTF16LE( "\xb8\x30\xe7\x30\xa4\x30\xd1\x30\xc3\x30\xc9\x30\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x6e\x30\x54\x53\xbf\x8a\xec\x30\xd9\x30\xeb\x30\x6e\x30\x2d\x8a\x9a\x5b\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"ジョイパッドデバイスの協調レベルの設定に失敗しました\n" @*/ ) ;
//		return D_DIENUM_CONTINUE ;
	}
	...
	{
//		Joypad->Release() ;
		DXST_ERRORLOG_ADDUTF16LE( "\xb8\x30\xe7\x30\xa4\x30\xd1\x30\xc3\x30\xc9\x30\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x6e\x30\x38\xff\xf8\x8e\xa2\x95\xc2\x4f\x6e\x30\x2d\x8a\x9a\x5b\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"ジョイパッドデバイスのＸ軸関係の設定に失敗しました\n" @*/ ) ;
//		return D_DIENUM_CONTINUE ;
	}
	...
	{
//		Joypad->Release() ;
		DXST_ERRORLOG_ADDUTF16LE( "\xb8\x30\xe7\x30\xa4\x30\xd1\x30\xc3\x30\xc9\x30\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x6e\x30\x39\xff\xf8\x8e\xa2\x95\xc2\x4f\x6e\x30\x2d\x8a\x9a\x5b\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"ジョイパッドデバイスのＹ軸関係の設定に失敗しました\n" @*/ ) ;
//		return D_DIENUM_CONTINUE ;
	}
	...
	{
//		Joypad->Release() ;
		DXST_ERRORLOG_ADDUTF16LE( "\xb8\x30\xe7\x30\xa4\x30\xd1\x30\xc3\x30\xc9\x30\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x6e\x30\x38\xff\xf8\x8e\x6e\x30\x21\x71\xb9\x52\xbe\x30\xfc\x30\xf3\x30\x6e\x30\x2d\x8a\x9a\x5b\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"ジョイパッドデバイスのＸ軸の無効ゾーンの設定に失敗しました\n" @*/ ) ;
//		return D_DIENUM_CONTINUE ;
	}
	...
	{
//		Joypad->Release() ;
		DXST_ERRORLOG_ADDUTF16LE( "\xb8\x30\xe7\x30\xa4\x30\xd1\x30\xc3\x30\xc9\x30\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x6e\x30\x39\xff\xf8\x8e\x6e\x30\x21\x71\xb9\x52\xbe\x30\xfc\x30\xf3\x30\x6e\x30\x2d\x8a\x9a\x5b\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"ジョイパッドデバイスのＹ軸の無効ゾーンの設定に失敗しました\n" @*/ ) ;
//		return D_DIENUM_CONTINUE ;
	}
		...
		// 右側モーター用(手元のパッドでは何故か GUID_SINE エフェクトは右モーターになってた)
		{
			...
			if( DInputData.NoUseVibrationFlag == FALSE )
			{
				Joypad->CreateEffect(
								 ...
								 &diEffect,      // データの場所
								 &pad->Effect[ DINPUTPAD_MOTOR_RIGHT ].DIEffect,  // インターフェイス ポインタを置く場所
								 NULL ) ;          // 集合化なし
			}
		}
		...
		// 左側モーター設定(手元のパッドでは何故か GUID_CONSTANTFORCE エフェクトは右モーターになってた)
		{
			...
			if( DInputData.NoUseVibrationFlag == FALSE )
			{
				hr = Joypad->CreateEffect(
								 ...
								 &eff,					// データの場所
								 &pad->Effect[ DINPUTPAD_MOTOR_LEFT ].DIEffect,  // インターフェイス ポインタを置く場所
								 NULL					// 集合化なし
				) ;
				if( hr != D_DI_OK )
				{
					DXST_ERRORLOG_ADDUTF16LE(( "\x68\x54\x1f\x67\x84\x76\xa8\x30\xd5\x30\xa7\x30\xaf\x30\xc8\x30\x6e\x30\x5c\x4f\x10\x62\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x02\x30\x0a\x00\x00"/*@ L"周期的エフェクトの作成に失敗しました。\n" @*/ )) ;
				}
			}
		}
...
//		pad->EffectPlayStateRight	= FALSE ;
	...
	if( hr != D_DI_POLLEDDEVICE && hr != D_DI_OK )
	{
		DXST_ERRORLOG_ADDUTF16LE( "\xb8\x30\xe7\x30\xa4\x30\xd1\x30\xc3\x30\xc9\x30\xa4\x30\xd9\x30\xf3\x30\xc8\x30\x6e\x30\xbb\x30\xc3\x30\xc8\x30\xa2\x30\xc3\x30\xd7\x30\x4c\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"ジョイパッドイベントのセットアップが失敗しました\n" @*/ ) ;
		return D_DIENUM_CONTINUE ;
	}
	...
	DXST_ERRORLOG_ADDUTF16LE( "\xb8\x30\xe7\x30\xa4\x30\xd1\x30\xc3\x30\xc9\x30\x6e\x30\xfd\x8f\xa0\x52\x6f\x30\x63\x6b\x38\x5e\x6b\x30\x42\x7d\x86\x4e\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"ジョイパッドの追加は正常に終了しました\n" @*/ ) ;
...
extern int NS_SetKeyExclusiveCooperativeLevelFlag( int Flag )
{
	...
	if( hr != D_DI_OK )
	{
		...
		if( hr != D_DI_OK )
		{
			DXST_ERRORLOG_ADDUTF16LE( "\xad\x30\xfc\x30\xdc\x30\xfc\x30\xc9\x30\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x6e\x30\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x00"/*@ L"キーボードデバイスの取得に失敗しました" @*/ ) ;
			return -1 ;
		}
	}
...
//		if( num != 0 ) DXST_ERRORLOGFMT_ADDW(( L"押されたか離されたかしたキー:0x%x  0x%x \n", data[0].dwOfs, data[0].dwData & 0xff )) ;
	}
