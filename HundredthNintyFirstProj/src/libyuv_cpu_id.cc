...
#include "libyuv_basic_types.h"  // For CPU_X86
...
#if (_MSC_FULL_VER >= 160040219) && (USING_VC6RT != 1)
...
int GetXCR0() {
  uint32 xcr0 = 0u;
#if (defined(_MSC_VER) && !defined(__clang__)) && (_MSC_FULL_VER >= 160040219) && (USING_VC6RT != 1)
