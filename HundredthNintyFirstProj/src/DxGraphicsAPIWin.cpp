...
extern int DirectDraw7_Create( void )
{
	...
	if( !FAILED( hr ) )
	{
		...
		if( FAILED( hr ) ) 
		{
			DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x44\x00\x72\x00\x61\x00\x77\x00\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x6e\x30\x1d\x52\x1f\x67\x16\x53\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DirectDrawオブジェクトの初期化に失敗しました\n" @*/ );
			GAPIWin.DirectDraw7Object->Release() ;
			return -1 ;
		}
		DXST_ERRORLOG_ADDUTF16LE( "\x1d\x52\x1f\x67\x16\x53\x6b\x30\x10\x62\x9f\x52\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"初期化に成功しました\n" @*/ ) ;
	}
	else
	{
		DXST_ERRORLOG_ADDUTF16LE( "\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x6e\x30\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"オブジェクトの取得に失敗しました\n" @*/ ) ;
		return -1 ;
	}
...
extern void Direct3D11_DumpObject( void )
{
	...
	DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x33\x00\x44\x00\x31\x00\x31\x00\x20\x00\x6e\x30\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x70\x65\x92\x30\xfa\x51\x9b\x52\x0a\x00\x00"/*@ L"Direct3D11 のオブジェクト数を出力\n" @*/ ) ;
	...
	DXST_ERRORLOGFMT_ADDUTF16LE(( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x33\x00\x44\x00\x31\x00\x31\x00\x20\x00\x6e\x30\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x08\x54\x08\x8a\x70\x65\x20\x00\x3a\x00\x20\x00\x25\x00\x64\x00\x00"/*@ L"Direct3D11 のオブジェクト合計数 : %d" @*/, TotalNum )) ;
}
...
{
	DXST_ERRORLOG_ADDUTF16LE( "\x64\x00\x78\x00\x67\x00\x69\x00\x2e\x00\x64\x00\x6c\x00\x6c\x00\x20\x00\x6e\x30\xad\x8a\x7f\x30\xbc\x8f\x7f\x30\x2e\x00\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"dxgi.dll の読み込み.... " @*/ ) ;
	...
	if( GAPIWin.DXGIDLL == NULL )
	{
		...
		return DXST_ERRORLOG_ADDUTF16LE( "\x31\x59\x57\x65\x0a\x00\x00"/*@ L"失敗\n" @*/ ) ;
	}
...
extern int DXGI_FreeDLL( void )
{
	...
	if( GAPIWin.DXGIDLL )
	{
		DXST_ERRORLOG_ADDUTF16LE( "\x64\x00\x78\x00\x67\x00\x69\x00\x2e\x00\x64\x00\x6c\x00\x6c\x00\x20\x00\x6e\x30\xe3\x89\x3e\x65\x20\x00\x31\x00\x0a\x00\x00"/*@ L"dxgi.dll の解放 1\n" @*/ ) ;
...
{
	DXST_ERRORLOG_ADDUTF16LE( "\x64\x00\x33\x00\x64\x00\x31\x00\x31\x00\x2e\x00\x64\x00\x6c\x00\x6c\x00\x20\x00\x6e\x30\xad\x8a\x7f\x30\xbc\x8f\x7f\x30\x2e\x00\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"d3d11.dll の読み込み.... " @*/ ) ;
...
extern int Direct3D11_FreeDLL( void )
{
	...
	{
		DXST_ERRORLOG_ADDUTF16LE( "\x64\x00\x33\x00\x64\x00\x31\x00\x31\x00\x2e\x00\x64\x00\x6c\x00\x6c\x00\x20\x00\x6e\x30\xe3\x89\x3e\x65\x20\x00\x31\x00\x0a\x00\x00"/*@ L"d3d11.dll の解放 1\n" @*/ ) ;
		FreeLibrary( GAPIWin.Direct3D11DLL ) ;
		GAPIWin.Direct3D11DLL = NULL ;
	}
...
{
	LPD_CREATEDXGIFACTORY D_CreateDXGIFactoryFunction ;
	...
	DXST_ERRORLOG_ADDUTF16LE( "\x49\x00\x44\x00\x58\x00\x47\x00\x49\x00\x46\x00\x61\x00\x63\x00\x74\x00\x6f\x00\x72\x00\x79\x00\x20\x00\x92\x30\x5c\x4f\x10\x62\x57\x30\x7e\x30\x59\x30\x2e\x00\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"IDXGIFactory を作成します.... " @*/ ) ;
...
extern int D3D11_CreateDevice( void )
{
	...
	DXST_ERRORLOG_ADDUTF16LE( "\x49\x00\x44\x00\x58\x00\x47\x00\x49\x00\x41\x00\x64\x00\x61\x00\x70\x00\x74\x00\x65\x00\x72\x00\x20\x00\x92\x30\xd6\x53\x97\x5f\x57\x30\x7e\x30\x59\x30\x2e\x00\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"IDXGIAdapter を取得します.... " @*/ ) ;
...
//			FeatureLevels[ 2 ] = D_D3D_FEATURE_LEVEL_10_0 ;
		...
		DXST_ERRORLOG_ADDUTF16LE( "\x49\x00\x44\x00\x33\x00\x44\x00\x31\x00\x31\x00\x44\x00\x65\x00\x76\x00\x69\x00\x63\x00\x65\x00\x20\x00\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x92\x30\xd6\x53\x97\x5f\x57\x30\x7e\x30\x59\x30\x2e\x00\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"ID3D11Device オブジェクトを取得します.... " @*/ ) ;
...
//			D_D3D_DRIVER_TYPE_HARDWARE,				// D_D3D_DRIVER_TYPE                DriverType,
			...
			D_D3D11_CREATE_DEVICE_SINGLETHREADED,	// UINT                             Flags,
	...
	DXST_ERRORLOG_ADDUTF16LE( "\x49\x00\x44\x00\x58\x00\x47\x00\x49\x00\x44\x00\x65\x00\x76\x00\x69\x00\x63\x00\x65\x00\x31\x00\x20\x00\x92\x30\xd6\x53\x97\x5f\x57\x30\x7e\x30\x59\x30\x2e\x00\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"IDXGIDevice1 を取得します.... " @*/ ) ;
...
extern int Direct3D9_Create( void )
{
	...
	{
		DXST_ERRORLOG_ADDUTF16LE( "\x49\x00\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x33\x00\x44\x00\x39\x00\x45\x00\x78\x00\x20\x00\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x92\x30\xd6\x53\x97\x5f\x57\x30\x7e\x30\x59\x30\x2e\x00\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"IDirect3D9Ex オブジェクトを取得します.... " @*/ ) ;
	...
	{
		DXST_ERRORLOG_ADDUTF16LE( "\x49\x00\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x33\x00\x44\x00\x39\x00\x20\x00\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x92\x30\xd6\x53\x97\x5f\x57\x30\x7e\x30\x59\x30\x2e\x00\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"IDirect3D9 オブジェクトを取得します.... " @*/ ) ;
		...
		if( GAPIWin.Direct3D9Object == NULL )
		{
			return DXST_ERRORLOG_ADDUTF16LE( "\x49\x00\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x33\x00\x44\x00\x39\x00\x20\x00\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x6e\x30\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"IDirect3D9 オブジェクトの取得に失敗しました\n" @*/ ) ;
		}
	}
...
extern int Direct3D9_LoadDLL( void )
{
	...
	{
		return DXST_ERRORLOG_ADDUTF16LE( "\x64\x00\x33\x00\x64\x00\x39\x00\x2e\x00\x64\x00\x6c\x00\x6c\x00\x20\x00\x6e\x30\xad\x8a\x7f\x30\xbc\x8f\x7f\x30\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"d3d9.dll の読み込みに失敗しました\n" @*/ ) ;
	}
...
extern int Direct3D9_FreeDLL( void )
{
	...
	{
		DXST_ERRORLOG_ADDUTF16LE( "\x64\x00\x33\x00\x64\x00\x39\x00\x2e\x00\x64\x00\x6c\x00\x6c\x00\x20\x00\x6e\x30\xe3\x89\x3e\x65\x20\x00\x31\x00\x0a\x00\x00"/*@ L"d3d9.dll の解放 1\n" @*/ ) ;
...
extern int Direct3D9_CreateDevice( void )
{
	...
	if( NS_GetWindowModeFlag() == TRUE )
	{
		...
		param.Windowed         = TRUE ;
		param.SwapEffect       = ( D_D3DMULTISAMPLE_TYPE )GRAWIN.Setting.FSAAMultiSampleCount == D_D3DMULTISAMPLE_NONE ? D_D3DSWAPEFFECT_COPY : D_D3DSWAPEFFECT_DISCARD ;
	...
	else
	{
		...
		default :
			DXST_ERRORLOG_ADDUTF16LE( "\x5e\x97\xfe\x5b\xdc\x5f\x6e\x30\xd0\x30\xc3\x30\xaf\x30\xd0\x30\xc3\x30\xd5\x30\xa1\x30\xfc\x30\xd3\x30\xc3\x30\xc8\x30\xf1\x6d\xa6\x5e\x4c\x30\x07\x63\x9a\x5b\x55\x30\x8c\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"非対応のバックバッファービット深度が指定されました\n" @*/ ) ;
			goto ERR ;
		}
		param.BackBufferCount            = 1 ;
...
//		param.SwapEffect                 = ( D_D3DMULTISAMPLE_TYPE )GRAWIN.Setting.FSAAMultiSampleCount == D_D3DMULTISAMPLE_NONE ? D_D3DSWAPEFFECT_COPY : D_D3DSWAPEFFECT_DISCARD ;
	...
	param.MultiSampleType    = ( D_D3DMULTISAMPLE_TYPE )GRAWIN.Setting.FSAAMultiSampleCount ;
	param.MultiSampleQuality = ( DWORD )GRAWIN.Setting.FSAAMultiSampleQuality ;
...
//	param.PresentationInterval   = GSYS.Screen.PreSetWaitVSyncFlag ? D_D3DPRESENT_INTERVAL_ONE       : D_D3DPRESENT_INTERVAL_IMMEDIATE ;
	...
	param.Flags                  = ( DWORD )( ( D_D3DMULTISAMPLE_TYPE )GRAWIN.Setting.FSAAMultiSampleCount == D_D3DMULTISAMPLE_NONE ? D_D3DPRESENTFLAG_LOCKABLE_BACKBUFFER/* D_D3DPRESENTFLAG_DEVICECLIP */ : 0 ) ;

	// FSAAの設定値を調べる
	if( GRAWIN.Setting.FSAAMultiSampleCount != 0 )
	{
		param.MultiSampleType                 = ( D_D3DMULTISAMPLE_TYPE )GRAWIN.Setting.FSAAMultiSampleCount ;
		param.MultiSampleQuality              = ( DWORD )GRAWIN.Setting.FSAAMultiSampleQuality ;
		Direct3D9_CheckMultiSampleParam( param.BackBufferFormat, &param.MultiSampleType, &param.MultiSampleQuality, FALSE ) ;
		GRAWIN.Setting.FSAAMultiSampleCount   = param.MultiSampleType ;
		GRAWIN.Setting.FSAAMultiSampleQuality = ( int )param.MultiSampleQuality ;
	}
	else
	{
...
//			D_D3DCREATE_MIXED_VERTEXPROCESSING
			( DWORD )( 
			  ...
			  ( GD3D9.Setting.UseMultiThread            ? D_D3DCREATE_MULTITHREADED          : 0                                     ) ),
			&param,
...
NOTUSEHARDWARE_VERTEXPROCESSINGEX:
			...
			if( FAILED( hr ) )
			{
				...
				DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x33\x00\x44\x00\x44\x00\x65\x00\x76\x00\x69\x00\x63\x00\x65\x00\x39\x00\x45\x00\x78\x00\x20\x00\x6e\x30\x5c\x4f\x10\x62\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"Direct3DDevice9Ex の作成に失敗しました\n" @*/ ) ;
				ErrorRet = -2 ;
				goto ERR ;
			}
			else
			{
				DXST_ERRORLOG_ADDUTF16LE( "\xbd\x30\xd5\x30\xc8\x30\xa6\x30\xa8\x30\xa2\x30\x02\x98\xb9\x70\x14\x6f\x97\x7b\x92\x30\x7f\x4f\x28\x75\x57\x30\x7e\x30\x59\x30\x0a\x00\x00"/*@ L"ソフトウエア頂点演算を使用します\n" @*/ ) ;
			}
		}
		else
		{
			DXST_ERRORLOG_ADDUTF16LE( "\xcf\x30\xfc\x30\xc9\x30\xa6\x30\xa8\x30\xa2\x30\x02\x98\xb9\x70\x14\x6f\x97\x7b\x92\x30\x7f\x4f\x28\x75\x57\x30\x7e\x30\x59\x30\x0a\x00\x00"/*@ L"ハードウエア頂点演算を使用します\n" @*/ ) ;
		}
...
NOTUSEHARDWARE_VERTEXPROCESSING:
			...
			if( FAILED( hr ) )
			{
				DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x33\x00\x44\x00\x44\x00\x65\x00\x76\x00\x69\x00\x63\x00\x65\x00\x39\x00\x20\x00\x6e\x30\x5c\x4f\x10\x62\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"Direct3DDevice9 の作成に失敗しました\n" @*/ ) ;
				goto ERR ;
			}
			else
			{
...
extern int Direct3DDevice9_Release( void )
{
	...
	{
		DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x33\x00\x44\x00\x44\x00\x65\x00\x76\x00\x69\x00\x63\x00\x65\x00\x39\x00\x20\x00\x6e\x30\xe3\x89\x3e\x65\x20\x00\x32\x00\x0a\x00\x00"/*@ L"Direct3DDevice9 の解放 2\n" @*/ ) ;
...
//		BltTempPrimaryToPrimary();
		SetTimer( NS_GetMainWindowHandle(), SCREENFLIPTIMER_ID, 32, (TIMERPROC)ScreenFlipTimerProc );
	}
}
...
//		DXST_ERRORLOGFMT_ADDW(( L"パラメータ StretchType( %d ) SrcRect( %d, %d, %d, %d ), DestRect( %d, %d, %d, %d )",
//			StretchType,
	...
	else
	{
		...
		if( GD3D9.Device.Screen.SubBackBufferSurface != NULL )
		{
			...
			if( GSYS.Screen.ValidGraphDisplayArea )
			{
				...
				RectClipping( &SubBackBufferSrcRect, &ClipRect ) ;
