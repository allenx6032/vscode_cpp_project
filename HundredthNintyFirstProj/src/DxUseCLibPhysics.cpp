...
)
{
	...
	for( i = 0 ; i < MLPhysicsInfo->PmdPhysicsJointNum ; i ++, JointInfo ++ )
	{
		...
		// ジョイントの初期化
		JointSetupInfo.RigidBodyA = ( ( BULLET_RIGIDBODY_INFO * )MLPhysicsInfo->PmdPhysicsInfoDim[ PmdPJoint->RigidBodyA ].BulletInfo )->btRigdBody ;
		JointSetupInfo.RigidBodyB = ( ( BULLET_RIGIDBODY_INFO * )MLPhysicsInfo->PmdPhysicsInfoDim[ PmdPJoint->RigidBodyB ].BulletInfo )->btRigdBody ;
...
)
{
	...
	return PhysicsInfo->RigidBodyType == 0 || PhysicsInfo->NoCopyToBone ;
}
...
)
{
	...
	for( i = 0 ; i < MLPhysicsInfo->PmxPhysicsJointNum ; i ++, JointInfo ++ )
	{
		...
		// ジョイントの初期化
		JointSetupInfo.RigidBodyA = ( ( BULLET_RIGIDBODY_INFO * )MLPhysicsInfo->PmxPhysicsInfoDim[ PmxPJoint->RigidBodyAIndex ].BulletInfo )->btRigdBody ;
		JointSetupInfo.RigidBodyB = ( ( BULLET_RIGIDBODY_INFO * )MLPhysicsInfo->PmxPhysicsInfoDim[ PmxPJoint->RigidBodyBIndex ].BulletInfo )->btRigdBody ;
...
)
{
	...
	return PhysicsInfo->Base->RigidBodyType == 0 || PhysicsInfo->NoCopyToBone ;
}
