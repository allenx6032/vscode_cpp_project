...
INITSTART:
	...
	case DX_MIDIMODE_MCI :
		if( DSOUND.EnableXAudioFlag )
		{
			...
			DXST_ERRORLOG_ADDUTF16LE( "\x58\x00\x41\x00\x75\x00\x64\x00\x69\x00\x6f\x00\x32\x00\x20\x00\x6e\x30\x1d\x52\x1f\x67\x16\x53\x92\x30\x4c\x88\x44\x30\x7e\x30\x59\x30\x0a\x00\x00"/*@ L"XAudio2 の初期化を行います\n" @*/ ) ;
			...
			{
				DXST_ERRORLOG_ADDUTF16LE( "\x58\x00\x41\x00\x75\x00\x64\x00\x69\x00\x6f\x00\x32\x00\x5f\x00\x38\x00\x2e\x00\x64\x00\x6c\x00\x6c\x00\x20\x00\x92\x30\x7f\x4f\x28\x75\x57\x30\x7e\x30\x59\x30\x0a\x00\x00"/*@ L"XAudio2_8.dll を使用します\n" @*/ ) ;
				...
				DXST_ERRORLOG_ADDUTF16LE( ""/*@ L"XAudio2 インターフェースの取得と初期化を行います....  " @*/ ) ;

				hr = DSOUND.XAudio2CreateFunc( &DSOUND.XAudio2_8Object, 0, D_XAUDIO2_DEFAULT_PROCESSOR ) ;
				if( FAILED( hr ) )
				{
					DXST_ERRORLOG_ADDUTF16LE( "\x1d\x52\x1f\x67\x16\x53\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"初期化に失敗しました\n" @*/ ) ;
					DXST_ERRORLOGFMT_ADDA(( "\x83\x47\x83\x89\x81\x5b\x83\x52\x81\x5b\x83\x68 %x"/*@ "エラーコード %x" @*/, hr )) ;
				...
				DXST_ERRORLOG_ADDUTF16LE( "\x10\x62\x9f\x52\x20\x00\x56\x00\x65\x00\x72\x00\x32\x00\x2e\x00\x38\x00\x0a\x00\x00"/*@ L"成功 Ver2.8\n" @*/ ) ;
			...
			{
				DXST_ERRORLOG_ADDUTF16LE( "\x58\x00\x41\x00\x75\x00\x64\x00\x69\x00\x6f\x00\x32\x00\x20\x00\xa4\x30\xf3\x30\xbf\x30\xfc\x30\xd5\x30\xa7\x30\xfc\x30\xb9\x30\x6e\x30\xd6\x53\x97\x5f\x92\x30\x4c\x88\x44\x30\x7e\x30\x59\x30\x2e\x00\x2e\x00\x2e\x00\x2e\x00\x20\x00\x20\x00\x00"/*@ L"XAudio2 インターフェースの取得を行います....  " @*/ ) ;
				...
				{
					DXST_ERRORLOGFMT_ADDUTF16LE(( "\x10\x62\x9f\x52\x20\x00\x56\x00\x65\x00\x72\x00\x32\x00\x2e\x00\x25\x00\x64\x00\x0a\x00\x00"/*@ L"成功 Ver2.%d\n" @*/, 7 - i )) ;
					DXST_ERRORLOG_ADDUTF16LE(( "\x15\x5f\x4d\x30\x9a\x7d\x4d\x30\xa4\x30\xf3\x30\xbf\x30\xfc\x30\xd5\x30\xa7\x30\xfc\x30\xb9\x30\x6e\x30\x1d\x52\x1f\x67\x16\x53\xe6\x51\x06\x74\x2e\x00\x2e\x00\x2e\x00\x20\x00\x20\x00\x00"/*@ L"引き続きインターフェースの初期化処理...  " @*/ )) ;
					...
					DXST_ERRORLOG_ADDUTF16LE( "\x58\x00\x33\x00\x44\x00\x41\x00\x75\x00\x64\x00\x69\x00\x6f\x00\x2e\x00\x44\x00\x4c\x00\x4c\x00\x20\x00\x6e\x30\xad\x8a\x7f\x30\xbc\x8f\x7f\x30\x2d\x4e\x2e\x00\x2e\x00\x2e\x00\x20\x00\x00"/*@ L"X3DAudio.DLL の読み込み中... " @*/ ) ;
					...
					if( DSOUND.X3DAudioDLL == NULL )
					{
						DXST_ERRORLOG_ADDUTF16LE( "\x31\x59\x57\x65\x01\x30\x58\x00\x33\x00\x44\x00\x41\x00\x75\x00\x64\x00\x69\x00\x6f\x00\x01\x30\x58\x00\x41\x00\x75\x00\x64\x00\x69\x00\x6f\x00\x32\x00\x6f\x30\x7f\x4f\x28\x75\x57\x30\x7e\x30\x5b\x30\x93\x30\x0a\x00\x00"/*@ L"失敗、X3DAudio、XAudio2は使用しません\n" @*/ ) ;
						DSOUND.XAudio2Object->Release() ;
						DSOUND.XAudio2Object = NULL ;
				...
				{
					DSOUND.XAudio2Object = NULL ;
					DXST_ERRORLOG_ADDUTF16LE( "\x58\x00\x41\x00\x75\x00\x64\x00\x69\x00\x6f\x00\x32\x00\xa4\x30\xf3\x30\xbf\x30\xfc\x30\xd5\x30\xa7\x30\xfc\x30\xb9\x30\x6e\x30\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"XAudio2インターフェースの取得に失敗しました\n" @*/ ) ;
		...
		{
			DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x53\x00\x6f\x00\x75\x00\x6e\x00\x64\x00\x20\x00\x6e\x30\x1d\x52\x1f\x67\x16\x53\x92\x30\x4c\x88\x44\x30\x7e\x30\x59\x30\x0a\x00\x00"/*@ L"DirectSound の初期化を行います\n" @*/ ) ;
			...
			{
				DSOUND.DirectSoundObject = NULL ;
				DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x53\x00\x6f\x00\x75\x00\x6e\x00\x64\x00\xa4\x30\xf3\x30\xbf\x30\xfc\x30\xd5\x30\xa7\x30\xfc\x30\xb9\x30\x6e\x30\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DirectSoundインターフェースの取得に失敗しました\n" @*/ ) ;
				return -1 ;
			}
	/*
			DXST_ERRORLOG_ADDUTF16LE( L"DirectSound の初期化を行います\n" ) ; 
			hr = DirectSoundCreate( NULL , &DSOUND.DirectSoundObject , NULL ) ;
			if( hr != D_DS_OK )
			{
				DSOUND.DirectSoundObject = NULL ;
				DXST_ERRORLOG_ADDUTF16LE( L"DirectSoundの初期化に失敗しました\n" ) ;
				return -1 ;
			}
	*/
			...
			if( hr != D_DS_OK )
			{
				DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x53\x00\x6f\x00\x75\x00\x6e\x00\x64\x00\x6e\x30\x54\x53\xbf\x8a\xec\x30\xd9\x30\xeb\x30\x6e\x30\x2d\x8a\x9a\x5b\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DirectSoundの協調レベルの設定に失敗しました\n" @*/ ) ;
				DSOUND.DirectSoundObject->Release() ;
				DSOUND.DirectSoundObject = NULL ;
				return -1 ;
			}
	...
	case DX_MIDIMODE_DM :
		...
		// ＤｉｒｅｃｔＭｕｓｉｃによる再生の場合の処理
		{
			...
			DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x53\x00\x6f\x00\x75\x00\x6e\x00\x64\x00\x38\x00\x20\x00\x6e\x30\x1d\x52\x1f\x67\x16\x53\x92\x30\x4c\x88\x44\x30\x7e\x30\x59\x30\x0a\x00\x00"/*@ L"DirectSound8 の初期化を行います\n" @*/ ) ; 
...
//											CLSCTX_INPROC , IID_IDirectMusicLoader8 , ( void ** )&DSOUND.DirectMusicLoaderObject ) ) )
											...
											CLSCTX_INPROC , IID_IDIRECTMUSICLOADER8 , ( void ** )&DSOUND.DirectMusicLoaderObject ) ) )
			{
				...
				DXST_ERRORLOG_ADDUTF16LE( "\x4d\x52\xd0\x30\xfc\x30\xb8\x30\xe7\x30\xf3\x30\x67\x30\x6e\x30\x1d\x52\x1f\x67\x16\x53\xe6\x51\x06\x74\x6b\x30\xfb\x79\x8a\x30\x7e\x30\x59\x30\x0a\x00\x00"/*@ L"前バージョンでの初期化処理に移ります\n" @*/ ) ;
...
//											CLSCTX_INPROC , IID_IDirectMusicPerformance8 , ( void ** )&DSOUND.DirectMusicPerformanceObject ) ) )
			...
			// MIDI音源の列挙
			{
				...
				{
					DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x4d\x00\x75\x00\x73\x00\x69\x00\x63\x00\x20\x00\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x6e\x30\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DirectMusic オブジェクトの取得に失敗しました\n" @*/ ) ;
					TerminateDirectSound() ;
					return -1 ;
				}
...
//				if( FAILED( DMusic->QueryInterface( IID_IDirectMusic8, (void **)&DMusic8 ) ) )
				...
				{
					DMusic->Release() ;
					DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x4d\x00\x75\x00\x73\x00\x69\x00\x63\x00\x38\x00\x20\x00\xaa\x30\xd6\x30\xb8\x30\xa7\x30\xaf\x30\xc8\x30\x6e\x30\xd6\x53\x97\x5f\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DirectMusic8 オブジェクトの取得に失敗しました\n" @*/ ) ;
					TerminateDirectSound() ;
					return -1 ;
				}
...
#endif
			DXST_ERRORLOGFMT_ADDUTF16LE(( "\xc1\x30\xe3\x30\xf3\x30\xcd\x30\xeb\x30\x70\x65\x3a\x00\x25\x00\x64\x00\x00"/*@ L"チャンネル数:%d" @*/, Details.OutputFormat.Format.nChannels )) ;
			DXST_ERRORLOGFMT_ADDUTF16LE(( "\xd3\x30\xc3\x30\xc8\x30\xbe\x7c\xa6\x5e\x3a\x00\x25\x00\x64\x00\x62\x00\x69\x00\x74\x00\x00"/*@ L"ビット精度:%dbit" @*/, Details.OutputFormat.Format.wBitsPerSample )) ;
			DXST_ERRORLOGFMT_ADDUTF16LE(( "\xb5\x30\xf3\x30\xd7\x30\xea\x30\xf3\x30\xb0\x30\xec\x30\xfc\x30\xc8\x30\x3a\x00\x25\x00\x64\x00\x48\x00\x7a\x00\x00"/*@ L"サンプリングレート:%dHz" @*/, Details.OutputFormat.Format.nSamplesPerSec )) ;
	...
	else
	{
		// 無音バッファの初期化
		{
			...
			if( hr != D_DS_OK )
			{
				DXST_ERRORLOG_ADDUTF16LE( "\x21\x71\xf3\x97\xd0\x30\xc3\x30\xd5\x30\xa1\x30\x6e\x30\x5c\x4f\x10\x62\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x00"/*@ L"無音バッファの作成に失敗しました" @*/ ) ;
			...
			// 無音で埋める
			{
				...
				if( hr != D_DS_OK )
				{
					DXST_ERRORLOG_ADDUTF16LE( "\x21\x71\xf3\x97\xd0\x30\xc3\x30\xd5\x30\xa1\x30\x6e\x30\xed\x30\xc3\x30\xaf\x30\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x00"/*@ L"無音バッファのロックに失敗しました" @*/ ) ;
...
R1 :
		...
		if( DSOUND.DirectSoundObject )
		{
			...
			DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x53\x00\x6f\x00\x75\x00\x6e\x00\x64\x00\x20\x00\xc7\x30\xd0\x30\xa4\x30\xb9\x30\x92\x30\x17\x52\x19\x63\x57\x30\x7e\x30\x59\x30\x0a\x00\x00"/*@ L"DirectSound デバイスを列挙します\n" @*/ ) ;
			DXST_ERRORLOG_TABADD ;
			
			// DirectSound DLL をロードする
			if( ( DSoundDLL = LoadLibraryA( "DSOUND.DLL" ) ) == NULL )
			{
				DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x53\x00\x4f\x00\x55\x00\x4e\x00\x44\x00\x2e\x00\x44\x00\x4c\x00\x4c\x00\x20\x00\x6e\x30\xed\x30\xfc\x30\xc9\x30\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DSOUND.DLL のロードに失敗しました\n" @*/ ) ;
				DXST_ERRORLOG_TABSUB ;
				goto ENUMEND ;
			}
			...
			DXST_ERRORLOGFMT_ADDUTF16LE(( ""/*@ L"最大サンプリングレート:%.2fKHz 最小サンプリングレート:%.2fKHz " @*/,
						( double )caps.dwMaxSecondarySampleRate / 1000 ,
						( double )caps.dwMinSecondarySampleRate / 1000 )) ;

			DXST_ERRORLOGFMT_ADDUTF16LE(( ""/*@ L"総サウンドメモリ領域:%.2fKB 空きサウンドメモリ領域:%.2fKB \n" @*/,
						( double )caps.dwTotalHwMemBytes / 0x100 ,
						( double )caps.dwFreeHwMemBytes / 0x100 )) ;

			DXST_ERRORLOG_ADDUTF16LE( "\x29\x52\x28\x75\xef\x53\xfd\x80\xb5\x30\xf3\x30\xd7\x30\xea\x30\xf3\x30\xb0\x30\xbe\x7c\xa6\x5e\x0a\x00\x00"/*@ L"利用可能サンプリング精度\n" @*/ ) ;
			...
			DXST_ERRORLOG_ADDUTF16LE( "\x29\x52\x28\x75\xef\x53\xfd\x80\xc1\x30\xe3\x30\xf3\x30\xcd\x30\xeb\x30\x0a\x00\x00"/*@ L"利用可能チャンネル\n" @*/ ) ;
...
ENUMEND :
	...
	{
		DXST_ERRORLOG_TABSUB ;
		DXST_ERRORLOG_ADDUTF16LE( "\x58\x00\x41\x00\x75\x00\x64\x00\x69\x00\x6f\x00\x32\x00\x20\x00\x6e\x30\x1d\x52\x1f\x67\x16\x53\x6f\x30\x63\x6b\x38\x5e\x6b\x30\x42\x7d\x86\x4e\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"XAudio2 の初期化は正常に終了しました\n" @*/ ) ;
	}
	else
	{
		DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x53\x00\x6f\x00\x75\x00\x6e\x00\x64\x00\x20\x00\x6e\x30\x1d\x52\x1f\x67\x16\x53\x6f\x30\x63\x6b\x38\x5e\x6b\x30\x42\x7d\x86\x4e\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DirectSound の初期化は正常に終了しました\n" @*/ ) ;
	}
...
extern int TerminateDirectSound( void )
{
	...
	else
	{
		...
		DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x53\x00\x6f\x00\x75\x00\x6e\x00\x64\x00\x20\x00\x6e\x30\x42\x7d\x86\x4e\xe6\x51\x06\x74\x6f\x30\x63\x6b\x38\x5e\x6b\x30\x42\x7d\x86\x4e\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DirectSound の終了処理は正常に終了しました\n" @*/ ) ;
	}
...
//					hr = DSOUND.DirectSoundObject->CreateSoundBuffer( &dsbdesc , &Sound->Buffer[ i ] , NULL ) ;
					...
					if( hr != D_DS_OK )
					{
						...
						if( SoundBuffer_Initialize( &Sound->Buffer[ i ], &dsbdesc, NULL, Sound->Is3DSound ) != D_DS_OK )
						{
							...
							DXST_ERRORLOG_ADDUTF16LE( "\x44\x00\x69\x00\x72\x00\x65\x00\x63\x00\x74\x00\x53\x00\x6f\x00\x75\x00\x6e\x00\x64\x00\x42\x00\x75\x00\x66\x00\x66\x00\x65\x00\x72\x00\x20\x00\x6e\x30\x5c\x4f\x10\x62\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"DirectSoundBuffer の作成に失敗しました\n" @*/ ) ;
							return -1 ;
						}
					}
...
//			DXST_ERRORLOG_ADDUTF16LE( L"ＭＣＩのオープンに失敗しました\n" ) ;
		...
		if( WinAPIData.Win32Func.mciSendCommandFunc( MIDI.MidiID , MCI_STATUS , MCI_STATUS_ITEM , ( DWORD_PTR )( LPVOID )&mciStatusParms ) )
		{
			...
			DXST_ERRORLOG_ADDUTF16LE( "\x2d\xff\x29\xff\x24\xff\x29\xff\x14\x6f\x4f\x59\x8b\x95\xcb\x59\xe6\x51\x06\x74\x67\x30\xa8\x30\xe9\x30\xfc\x30\x4c\x30\x77\x8d\x4d\x30\x7e\x30\x57\x30\x5f\x30\x11\xff\x0a\x00\x00"/*@ L"ＭＩＤＩ演奏開始処理でエラーが起きました１\n" @*/ ) ;
			goto MCI_ERROR ;
		}
		if( LOWORD( mciStatusParms.dwReturn ) != LOWORD( MIDI_MAPPER ) )
		{
			WinAPIData.Win32Func.mciSendCommandFunc( MIDI.MidiID , MCI_CLOSE , 0 , 0 ) ;
			DXST_ERRORLOG_ADDUTF16LE( "\x2d\xff\x29\xff\x24\xff\x29\xff\x14\x6f\x4f\x59\x8b\x95\xcb\x59\xe6\x51\x06\x74\x67\x30\xa8\x30\xe9\x30\xfc\x30\x4c\x30\x77\x8d\x4d\x30\x7e\x30\x57\x30\x5f\x30\x12\xff\x0a\x00\x00"/*@ L"ＭＩＤＩ演奏開始処理でエラーが起きました２\n" @*/ ) ;
			goto MCI_ERROR ;
		}
		...
		{
			WinAPIData.Win32Func.mciSendCommandFunc( MIDI.MidiID , MCI_CLOSE , 0 , 0 ) ;
			DXST_ERRORLOG_ADDUTF16LE( "\x2d\xff\x29\xff\x24\xff\x29\xff\x14\x6f\x4f\x59\x6b\x30\x31\x59\x57\x65\x57\x30\x7e\x30\x57\x30\x5f\x30\x0a\x00\x00"/*@ L"ＭＩＤＩ演奏に失敗しました\n" @*/ ) ;
			goto MCI_ERROR ;
		}
