...
#include "rutils.h"                  // Required for: TRACELOG macros
...
#include "rlgl.h"                   // raylib OpenGL abstraction layer to OpenGL 1.1, 3.3+ or ES2
    ...
    #define MSF_GIF_IMPL
    #include "raylib_msf_gif.h"   // Support GIF recording
#endif

#if defined(SUPPORT_COMPRESSION_API)
    #define SINFL_IMPLEMENTATION
    #include "raylib_sinfl.h"

    #define SDEFL_IMPLEMENTATION
    #include "raylib_sdefl.h"
#endif
...
#include <sys/stat.h>               // Required for: stat() [Used in GetFileModTime()]
    ...
    #include "raylib_dirent.h"    // Required for: DIR, opendir(), closedir() [Used in GetDirectoryFiles()]
#else
    ...
    #include "EGL/eglext.h"             // EGL library - Extensions
    #include "GLES2/gl2.h"              // OpenGL ES 2.0 library
    #include "ruwp_events.h"             // UWP bootstrapping functions
#endif
