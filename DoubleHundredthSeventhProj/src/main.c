...
int main(void) {
    ...
    #if defined(PLATFORM_WEB)
        char *chunkShaderVs = 
            #include "shaders/chunk_shader_gl100.vs"
        ;
        char *chunkShaderFs = 
            #include "shaders/chunk_shader_gl100.fs"
        ;
    #else
        char *chunkShaderVs = 
            #include "shaders/chunk_shader.vs"
        ;
        char *chunkShaderFs = 
            #include "shaders/chunk_shader.fs"
        ;
    #endif
