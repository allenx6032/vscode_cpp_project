              ...
              char *title, int border, int num_samples )
{
  ...
  wc.lpszClassName = L"PlibAppClass" ;
  if ( !RegisterClass( &wc ) )
  {
  ...
  currWnd = CreateWindow( 
    L"PlibAppClass", ( LPCWSTR)title, style,
...
void pwSetCursor ( int c )
{
  ...
  switch ( c )
  {
    case PW_CURSOR_RIGHT  : cursor = (LPCSTR)IDC_ARROW ; break ;
    case PW_CURSOR_LEFT   : cursor = (LPCSTR)IDC_ARROW ; break ;
    case PW_CURSOR_QUERY  : cursor = (LPCSTR)IDC_HELP  ; break ;
  /*case PW_CURSOR_AIM    : cursor = ???       ; break ;*/
    case PW_CURSOR_CIRCLE : cursor = (LPCSTR)IDC_NO    ; break ;
    case PW_CURSOR_WAIT   : cursor = (LPCSTR)IDC_WAIT  ; break ;
    case PW_CURSOR_CROSS  : cursor = (LPCSTR)IDC_CROSS ; break ;
    case PW_CURSOR_NONE   : cursor = (LPCSTR)0         ; break ;
    default:
      cursor = (LPCSTR)IDC_ARROW;
  }
