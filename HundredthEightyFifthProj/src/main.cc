...
int main(int argc, char** argv)
{
  ...
  nvgCreateFont(vg, "sans-bold", "Roboto-Bold.ttf");
  ...
  std::string bt3gui_js = ReadJSFile("bt3gui.js");
  ...
  std::string bt3_browser_shim = ReadJSFile("bt3-browser-shim.js");
