...
/// Type used for cpShape.layers.
  ...
  struct cpLayers {
    unsigned short is;
    unsigned short collides_with;

    inline bool operator&(cpLayers other)
    {
      return (collides_with & other.is) && (other.collides_with & is);
    }
  };
#endif
...
#define CP_NO_GROUP ((cpGroup)0)
  ...
  static const cpLayers CP_ALL_LAYERS = { 0xFFFF, 0xFFFF };
//#define CP_ALL_LAYERS {0xFFFF,0xFFFF}
#endif
/// @}
