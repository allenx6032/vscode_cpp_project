...
Actor::Impl::Impl(lua::Stack& lua, display::Window& window, event::Queue& queue, dynamics::World& world, collision::Group& collision, std::filesystem::path const& path) : force_(0.f, 0.f), open_(true), angle_(0.), collision_(collision)
{
  {
...
Actor::Actor(lua::Stack& lua, display::Window& window, collision::Group& collision, event::Queue& queue, dynamics::World& world, std::filesystem::path const& path)
{
