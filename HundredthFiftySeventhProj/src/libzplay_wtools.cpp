...
char *UTF16ToANSI(wchar_t *src, int nCharacterNumber)
{
	...
	tmp[0] = 0;	
	size = WideCharToMultiByte(CP_ACP, WC_COMPOSITECHECK, src, nCharacterNumber, tmp, size, NULL, NULL);
	tmp[size] = 0;
...
wchar_t *ANSIToUTF16(char *src, int nCharacterNumber)
{
	...
	tmp[0] = 0;
	size = MultiByteToWideChar(CP_ACP, 0, src, nCharacterNumber, tmp, size);
	tmp[size] = 0;
...
wchar_t *UTF8ToUTF16(char *src, int nCharacterNumber)
{
	...
	tmp[0] = 0;
	size = MultiByteToWideChar(CP_UTF8, 0, src, nCharacterNumber, tmp, size);
	tmp[size] = 0;
