...
#include "libzplay.h"
#include "libzplay_wdecoder.h"
#include "libzplay_wencoder.h"
#include "libzplay_wqueue.h"
#include "libzplay_weqprocessor.h"
#include "libzplay_wechoprocessor.h"
#include "libzplay_wstprocessor.h"
#include "libzplay_wcentercutprocessor.h"
#include "libzplay_woutputprocessor.h"
#include "libzplay_winputprocessor.h"
#include "libzplay_wspectrum.h"
...
class  WMp3x : public ZPlay {
	public:
		...
		int __stdcall DrawBitmapToHDC(void *hdc, int X, int Y, int Width, int Height, void *hBitmap);
		int __stdcall DrawBitmapToHWND(void *hwnd, int X, int Y, int Width, int Height, void *hBitmap);
		...
		int __stdcall DetectBPM(TBMPDetectionMethod nMethod);
		int __stdcall DetectFileBPM(const char *pchFileName, TStreamFormat nFormat, TBMPDetectionMethod nMethod);
		int __stdcall DetectFileBPMW(const wchar_t *pchFileName, TStreamFormat nFormat, TBMPDetectionMethod nMethod);
...
// DISPLAY FFT SPECTRUM
	...
	WSpectrum *c_FFTSpectrum;				// spectrum class
...
//	ERROR CODES AND ERROR MESSAGES
	...
	WAudioEncoder *_GetAudioEncoder(TStreamFormat nFormat);
