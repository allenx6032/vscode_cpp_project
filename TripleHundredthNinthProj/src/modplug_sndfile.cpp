...
//-----------------------------
{
	...
	for (int iz=0; iz<16; iz++) wsprintf((LPSTR)&m_MidiCfg.szMidiZXXExt[iz*32], (LPSTR)"F0F001%02X", iz*8);
}
...
//---------------------------------------------------------
{
	...
	if (lpszName) lstrcpyn((LPSTR)szName, (LPSTR)lpszName, MAX_PATTERNNAME);
