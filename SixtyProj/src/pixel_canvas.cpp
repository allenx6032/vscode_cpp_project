...
const std::string canvasVertPath("shader/image_display.vert");
const std::string canvasFragPath("shader/image_display.frag");

const std::string wirenetVertPath("shader/wirenet.vert");
const std::string wirenetFragPath("shader/wirenet.frag");
...
//font settings
std::string fontPath = "extra_fonts/consola.ttf";
